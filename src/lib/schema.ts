...
export const SCHEMAS = {
  ...
  // equipment tracking tables (common schema)
  EQUIPMENT: 'common.equipment',
  EQUIPMENT_MAINTENANCE: 'common.equipment_maintenance',
  EQUIPMENT_ASSIGNMENTS: 'common.equipment_assignments',
  MAINTENANCE_ALERTS: 'common.maintenance_alerts',
...
export function getTable(tableName: string): string {
  ...
  switch (tableName) {
    ...
    case 'equipment_maintenance': return SCHEMAS.EQUIPMENT_MAINTENANCE;
