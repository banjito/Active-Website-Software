            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
              <div>
                ...
                <div className="mb-4 flex">
                  <label className="inline-block w-24 font-medium text-gray-700 dark:text-white">
                    Customer
                  </label>
              ...
              <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-700 table-fixed">
                ...
                <thead>
                  <tr>
                    ...
                    <th className="border border-gray-300 dark:border-gray-700 px-2 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">
                      Units
                    </th>
                  </tr>
                  <tr>
                    ...
                    {Array(2)
                      ...
                      .map((_, i) =>
                        ["A-G", "B-G", "C-G"].map((phase) => (
                          <th
                            key={`${i}-${phase}`}
                            className="border border-gray-300 dark:border-gray-700 px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider"
                          >
                            {phase}
                          </th>
                        )),
