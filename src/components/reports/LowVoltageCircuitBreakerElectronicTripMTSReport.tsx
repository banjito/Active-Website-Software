    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="p-6 flex justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden">
                ...
                <div>
                  ...
                  <label htmlFor="customer" className="form-label inline-block w-32">Customer:</label>
                        <input id="customer" type="text" value={formData.customer} readOnly={true} className="form-input bg-gray-100 dark:bg-dark-150" />
                    </div>
                    <div className="mb-4 flex items-center">
                  <label htmlFor="address" className="form-label inline-block w-32">Address:</label>
                        <input id="address" type="text" value={formData.address} readOnly={true} className="form-input bg-gray-100 dark:bg-dark-150" />
                    </div>
                    <div className="mb-4 flex items-center">
        ...
        <section className="mb-6 primary-injection-section">
          ...
          <div className="mb-4 p-4 bg-gray-50 dark:bg-dark-200 rounded-lg border border-gray-300 dark:border-gray-600 no-print-tolerance-section">
        ...
        {/* --- Comments Section --- */}
          ...
          <div className="hidden print:block mb-6">
            ...
            <table className="w-full border-collapse border-2 border-black mb-6" style={{tableLayout: 'fixed'}}>
              <tbody>
                <tr>
                  <td className="border-2 border-black px-4 py-8 text-sm align-top" style={{minHeight: '150px', height: '150px', verticalAlign: 'top'}}>
                    {formData.comments || '\u00A0'}
                  </td>
                </tr>
              </tbody>
