    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="text-xs text-gray-500 dark:text-white">All Documents</div>
          ...
          <div className="mt-2 text-xs text-gray-500 dark:text-white">Last 30 days</div>
        </div>
        
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="text-xs text-gray-500 dark:text-white">Contracts</div>
          <div className="flex items-end mt-1">
          ...
          <div className="mt-2 text-xs text-gray-500 dark:text-white">Active contracts</div>
        </div>
              
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="text-xs text-gray-500 dark:text-white">Invoices</div>
          <div className="flex items-end mt-1">
          ...
          <div className="mt-2 text-xs text-gray-500 dark:text-white">Last quarter</div>
        </div>
              
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="text-xs text-gray-500 dark:text-white">Storage Used</div>
          <div className="flex items-end mt-1">
                ...
                <div className="ml-4 flex-1">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">2.4 MB</span>
            </div>
          </div>
                  <div className="flex justify-between mt-1">
                    <p className="text-xs text-gray-500 dark:text-white">Uploaded by: John Smith • Apr 12, 2023</p>
                    <div className="flex space-x-2">
                      ...
                      <button className="text-xs text-gray-600 hover:text-gray-800 dark:text-white dark:hover:text-gray-300">Share</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="ml-4 flex-1">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">1.2 MB</span>
                    </div>
                  </div>
                  <div className="flex justify-between mt-1">
                    <p className="text-xs text-gray-500 dark:text-white">Uploaded by: Jane Doe • Apr 8, 2023</p>
                    <div className="flex space-x-2">
                      <button className="text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Download</button>
                      <button className="text-xs text-gray-600 hover:text-gray-800 dark:text-white dark:hover:text-gray-300">Share</button>
                    </div>
                ...
                <div className="ml-4 flex-1">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">856 KB</span>
                    </div>
                  </div>
                  <div className="flex justify-between mt-1">
                    <p className="text-xs text-gray-500 dark:text-white">Uploaded by: Michael Brown • Apr 5, 2023</p>
                    <div className="flex space-x-2">
                      <button className="text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Download</button>
                      <button className="text-xs text-gray-600 hover:text-gray-800 dark:text-white dark:hover:text-gray-300">Share</button>
                    </div>
                ...
                <div className="ml-4 flex-1">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">15.8 MB</span>
              </div>
            </div>
                  <div className="flex justify-between mt-1">
                    <p className="text-xs text-gray-500 dark:text-white">Uploaded by: Sarah Johnson • Mar 28, 2023</p>
                    <div className="flex space-x-2">
                      <button className="text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Download</button>
                      <button className="text-xs text-gray-600 hover:text-gray-800 dark:text-white dark:hover:text-gray-300">Share</button>
                    </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">6 files</span>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-white mt-1">Last modified: Apr 12, 2023</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">8 files</span>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-white mt-1">Last modified: Apr 8, 2023</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs text-gray-500 dark:text-white">5 files</span>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-white mt-1">Last modified: Apr 5, 2023</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-white mt-1">Last modified: Mar 28, 2023</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-600">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <span className="text-xs text-gray-500 dark:text-white">Apr 12, 2023 at 10:45 AM</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-600">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <span className="text-xs text-gray-500 dark:text-white">Apr 10, 2023 at 3:22 PM</span>
                </div>
            </div>
            </div>
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-600">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <span className="text-xs text-gray-500 dark:text-white">Apr 7, 2023 at 9:15 AM</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <span className="text-xs text-gray-500 dark:text-white">Apr 5, 2023 at 2:30 PM</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Last updated info */}
      <div className="mt-4 text-right text-xs text-gray-500 dark:text-white">
