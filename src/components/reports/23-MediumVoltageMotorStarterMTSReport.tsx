            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden job-info-onscreen">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input type="text" value={formData.customerName} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-[calc(100%-8rem)]" />
                </div>
                <div>
                  <label className="form-label inline-block w-32">Address:</label>
                  <input type="text" value={formData.customerAddress} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-[calc(100%-8rem)]" />
                </div>
                 <div>
            ...
            <div className="space-y-4 print:hidden">
              {([
                ...
                <div key={equip.key} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div><label className="form-label block">{equip.label}:</label><input type="text" value={formData.testEquipmentUsed[equip.key].name} onChange={(e) => handleChange(`testEquipmentUsed.${equip.key}.name`, e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
