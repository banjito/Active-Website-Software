...
export const CustomFormPreview: React.FC = () => {
    ...
    if (
      ...
      return (
        <div className="space-y-4 w-full min-w-0" style={wrapperStyle}>
          <div className="flex flex-wrap items-center gap-4 pb-2 border-b border-gray-200 dark:border-gray-600 print:hidden">
  ...
  return (
    <ReportWrapper>
      ...
      <div className="report-body min-h-screen bg-gray-50 dark:bg-dark-200 p-4 md:p-6 print:min-h-0 print:bg-white print:p-0">
        <div className="max-w-5xl mx-auto print:max-w-none">
          <div className="custom-form-container bg-white dark:bg-dark-150 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 md:p-6 print:shadow-none print:border-0 print:rounded-none print:p-0">
            {/* Screen-only Header */}
            <div className="print:hidden flex items-center justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
