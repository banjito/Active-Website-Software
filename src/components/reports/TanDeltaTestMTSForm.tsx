  ...
  const loadReport = async () => {
    ...
    try {
      ...
      if (reportDataResult) {
        ...
        setData(
          Array.isArray(reportData.points) ? reportData.points : initialData,
        );
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4 print:hidden test-params-onscreen">
              ...
              <input
                ...
                disabled={!isEditing}
                className="mt-1 block w-32 rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white"
              />
            </div>
            ...
            <div className="hidden print:block">
              <table className="w-full border border-gray-300 print:border-black">
                <tbody>
                  <tr>
                    <td className="p-2 border border-gray-300 print:border-black font-semibold w-1/3">
                      System Voltage Line to Ground (kV RMS):
                    </td>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 print:hidden test-eqpt-onscreen">
              <div>
                <label htmlFor="megohmmeterMakeModel" className="form-label">
                  Megohmmeter Make/Model
                </label>
                <EquipmentAutocomplete
                  value={equipment.megohmmeterMakeModel}
                  onChange={(value) =>
                    handleEquipmentChange("megohmmeterMakeModel", value)
                  }
                  onSelect={(equip) => {
                    ...
                    handleEquipmentChange(
                      "megohmmeterCalDate",
                      formatLocalDateShort(equip.calibration_date),
                    );
                  }}
                  readOnly={!isEditing}
              ...
              <div>
                <label htmlFor="megohmeterSerial" className="form-label">
                  Serial Number
                </label>
                <input
                  id="megohmeterSerial"
              ...
              <div>
                <label htmlFor="megohmmeterAmpId" className="form-label">
                  AMP ID
                </label>
                <input
                  id="megohmmeterAmpId"
              ...
              <div>
                <label htmlFor="megohmmeterCalDate" className="form-label">
                  Cal Date
                </label>
                <input
                  ...
                  onChange={(e) =>
                    handleEquipmentChange("megohmmeterCalDate", e.target.value)
                  }
                  disabled={!isEditing}
                  className="form-input mt-1"
                />
              ...
              <div>
                <label htmlFor="vlfHipotMakeModel" className="form-label">
                  VLF Hipot Make/Model
                </label>
                <EquipmentAutocomplete
                  value={equipment.vlfHipotMakeModel}
                  onChange={(value) =>
                    handleEquipmentChange("vlfHipotMakeModel", value)
                  }
                  onSelect={(equip) => {
                    handleEquipmentChange(
                      "vlfHipotMakeModel",
              ...
              <div>
                <label htmlFor="vlfHipotSerial" className="form-label">
                  Serial Number
                </label>
                <input
                  id="vlfHipotSerial"
              ...
              <div>
                <label htmlFor="vlfHipotAmpId" className="form-label">
                  AMP ID
                </label>
                <input
                  id="vlfHipotAmpId"
              ...
              <div>
                <label htmlFor="vlfHipotCalDate" className="form-label">
                  Cal Date
                </label>
                <input
                  id="vlfHipotCalDate"
