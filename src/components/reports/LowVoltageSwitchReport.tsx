        ...
        address: maskCustomerAddress(formData.address),
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div>
                <label htmlFor="aicRating" className="form-label inline-block w-32">SCCR:</label>
                <input
                  type="text"
                  id="aicRating"
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Position / Identifier</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Manufacturer</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Catalog No.</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Serial No.</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Type</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center" colSpan={2}>Rated</th>
                  </tr>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150" colSpan={5}></th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Amperage</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Voltage</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    ...
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Manufacturer</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Catalog No.</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Class</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center" colSpan={3}>Rated</th>
                  </tr>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150" colSpan={4}></th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Amperage</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">AIC</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">Voltage</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center" colSpan={3}>Pole-to-Pole</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center" colSpan={3}>Pole-to-Frame</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center" colSpan={3}>Line-to-Load</th>
                  </tr>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P1-P2</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P2-P3</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P3-P1</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P1</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P2</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P3</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P1</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P2</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">P3</th>
                  </tr>
                  ...
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        readOnly={!isEditing}
                        className={`block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white text-base ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
                      />
                    </td>
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-2 bg-gray-50 dark:bg-dark-150 font-normal text-left">Section</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-2 bg-gray-50 dark:bg-dark-150 font-normal text-left">Description</th>
                    <th className="border border-gray-200 dark:border-gray-700 p-2 bg-gray-50 dark:bg-dark-150 font-normal text-left">Results</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <div className="grid grid-cols-5 gap-4 items-center">
                ...
                <div>
                  <EquipmentAutocomplete
                    ...
                    onChange={(value) => handleChange('testEquipment', {
                      ...formData.testEquipment,
                      megohmmeter: { ...formData.testEquipment.megohmmeter, model: value }
                    })}
                    onSelect={(equipment) => {
                ...
                <div className="flex items-center gap-2">
                  <span className="whitespace-nowrap text-gray-700 dark:text-white">Cal Date:</span>
                  <input
                    type="text"
                    value={formData.testEquipment.megohmmeter.calDate}
                    onChange={(e) => handleChange('testEquipment', {
                      ...formData.testEquipment,
                      megohmmeter: { ...formData.testEquipment.megohmmeter, calDate: e.target.value }
                    })}
                    placeholder="Test"
                    readOnly={!isEditing}
                    className="form-input w-full"
              ...
              <div className="grid grid-cols-5 gap-4 items-center">
                ...
                <div>
                  <EquipmentAutocomplete
                    ...
                    onChange={(value) => handleChange('testEquipment', {
                      ...formData.testEquipment,
                      lowResistance: { ...formData.testEquipment.lowResistance, model: value }
                    })}
                    onSelect={(equipment) => {
                      const formatDate = (dateString: string | null): string => {
                        if (!dateString) return '';
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('testEquipment', {
                      ...formData.testEquipment,
                      lowResistance: { ...formData.testEquipment.lowResistance, calDate: e.target.value }
                    })}
                    placeholder="Test"
                    readOnly={!isEditing}
                    className="form-input w-full"
