...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <>
      ...
      >
        <div 
          className="relative w-full max-w-3xl bg-white dark:bg-dark-150 rounded-xl shadow-2xl overflow-hidden mx-4"
          ...
          <div className="px-6 pb-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-white mt-1">{profileUser?.email}</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center text-gray-700 dark:text-white">
                    <Briefcase className="mr-2 h-4 w-4 text-gray-500 dark:text-white" />
                    <div>
