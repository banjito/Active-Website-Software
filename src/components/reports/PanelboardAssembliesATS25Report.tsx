        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm">Performing Torque Verification using Low-Resistance Ohmmeter?</span>
                <select
          ...
          <div className="mb-6">
            ...
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-300 print:border-black print-comment-table">
                ...
                <thead>
                  <tr>
                    <th className="p-2 border border-gray-300 print:border-black bg-gray-50 print:bg-gray-100 font-semibold text-left">Equipment</th>
                ...
                <tbody>
                  <tr>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.lowResistanceOhmmeter.name}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.lowResistanceOhmmeter.serialNumber}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.lowResistanceOhmmeter.ampId}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{(() => {
                      const calDate = formData.testEquipment.lowResistanceOhmmeter.calDate;
                      if (!calDate) return '';
                      ...
                      if (/^\d{4}-\d{2}-\d{2}$/.test(calDate)) {
                        ...
                        return isNaN(local.getTime()) ? calDate : local.toLocaleDateString();
                      }
                      const dt = new Date(calDate);
                      return isNaN(dt.getTime()) ? calDate : dt.toLocaleDateString();
                    })()}</td>
                  </tr>
                  <tr>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.name}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.serialNumber}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.ampId}</td>
                    <td className="p-2 align-top border border-gray-300 print:border-black">{(() => {
                      const calDate = formData.testEquipment.megohmmeter.calDate;
                      if (!calDate) return '';
                      // Handle YYYY-MM-DD dates (from <input type="date">) in local time to avoid off-by-one
                      if (/^\d{4}-\d{2}-\d{2}$/.test(calDate)) {
                        const [y, m, d] = calDate.split('-').map(Number);
