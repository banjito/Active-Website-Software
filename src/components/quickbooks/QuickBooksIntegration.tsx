...
export default function QuickBooksIntegration({ onConnect, onDisconnect }: QuickBooksIntegrationProps) {
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Connect your QuickBooks account to sync invoices, customers, and more.
          </p>
        </div>
      </div>
            ...
            <div className="bg-gray-50 rounded p-4 space-y-2 text-sm">
              ...
              {integration.realm_id && (
                <div>
                  ...
                  <span className="font-mono text-xs">{integration.realm_id}</span>
                </div>
              )}
              ...
              <div>
                ...
                <span>{new Date(integration.token_expires_at).toLocaleString()}</span>
              </div>
            </div>
          )}
