          ...
          <div className="space-y-6">
                ...
                <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                  <thead className="bg-neutral-50 dark:bg-dark-150">
                    <tr>
                      <th
                        colSpan={6}
                        className="px-6 py-3 text-center text-sm font-medium text-neutral-700 dark:text-white"
                      >
            ...
            <div className="overflow-x-auto mt-6">
              <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                <thead className="bg-neutral-50 dark:bg-dark-150">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider"></th>
                    <th className="px-6 py-3 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider w-32">
                      Primary
                    </th>
                    <th className="px-6 py-3 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider w-32">
                      Secondary
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-neutral-200 dark:divide-neutral-700">
                  <tr>
                    <td className="px-6 py-4 text-sm text-neutral-700 dark:text-white">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={!isEditing}
                  className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 bg-neutral-50 dark:bg-dark-150 shadow-sm dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-white">
