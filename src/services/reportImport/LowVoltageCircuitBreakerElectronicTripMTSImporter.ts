...
export class LowVoltageCircuitBreakerElectronicTripMTSImporter extends BaseImporter implements ReportImporter {
  ...
  canImport(data: ReportData): boolean {
    ...
    return t.includes('lowvoltagecircuitbreakerelectronictripmts')
      || t.includes('low-voltage-circuit-breaker-electronic-trip-mts');
  }
  ...
  protected getReportType(): string {
    return 'low-voltage-circuit-breaker-electronic-trip-mts-report';
  }
}
