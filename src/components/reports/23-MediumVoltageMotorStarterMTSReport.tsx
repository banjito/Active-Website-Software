...
const insulationTestVoltageOptions = [
  ...
  "2500V",
  "5000V",
]; // Add more if needed based on common practice
...
const initialVisualMechanicalItems = [
  {
    netaSection: "7.16.1.2.A.1",
    description: "Inspect physical and mechanical condition.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.2",
    description: "Inspect anchorage, alignment, and grounding.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.4",
    description: "Clean the unit.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.5.1",
    description:
      "Use of a low-resistance ohmmeter in accordance with Section 7.16.1.2.B.1.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.6",
    description:
      "Test electrical and mechanical interlock systems for correct operation and sequencing.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.7",
    description:
      "Verify correct barrier and shutter installation and operation.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.8",
    description:
      "Exercise active components and confirm correct operation of indicating devices.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.9",
    description:
      "Inspect contactors. 1. Verify mechanical operation. 2. Inspect and adjust contact gap, wipe, alignment, and pressure in accordance with manufacturer's published data.",
    result: "Select One",
  },
  {
    netaSection: "7.16.1.2.A.10",
    description:
...
const MediumVoltageMotorStarterMTSReport: React.FC = () => {
  ...
  const loadReport = async () => {
    ...
    try {
      ...
      if (data && data.report_data) {
        ...
        // Data is null but no error, means not found
        setIsEditing(true);
  ...
  useEffect(() => {
    ...
    if (!reportId) {
      ...
      freshInitialData.customerAddress = maskCustomerAddress(
  ...
  const calculateCorrectedMOhm = (valueStr: string): string => {
    ...
    const [int, dec] = (value * formData.temperature.tcf).toFixed(2).split(".");
  ...
  useEffect(() => {
    ...
    newElectricalTests.temperatureCorrected.readings.forEach(
      (reading, index) => {
        const originalReading =
          formData.electricalTests.insulationResistance.readings[index];
    ...
    // Sync test voltage
    newElectricalTests.temperatureCorrected.testVoltage =
      formData.electricalTests.insulationResistance.testVoltage;

    const newElectricalTestContactor = _.cloneDeep(
      formData.electricalTestContactor,
    );
    newElectricalTestContactor.temperatureCorrected.readings.forEach(
      (reading, index) => {
        const originalReading =
          formData.electricalTestContactor.insulationResistance.readings[index];
        reading.p1_mq = calculateCorrectedMOhm(originalReading.p1_mq);
        reading.p2_mq = calculateCorrectedMOhm(originalReading.p2_mq);
        reading.p3_mq = calculateCorrectedMOhm(originalReading.p3_mq);
      },
    );
    newElectricalTestContactor.temperatureCorrected.testVoltage =
      formData.electricalTestContactor.insulationResistance.testVoltage;

    const newElectricalTestReactor = _.cloneDeep(
      formData.electricalTestReactor,
    );
    const originalReactorInsulation =
      formData.electricalTestReactor.insulationResistance.windingToGround;
    newElectricalTestReactor.temperatureCorrected.windingToGround.aPhase =
      calculateCorrectedMOhm(originalReactorInsulation.aPhase);
    newElectricalTestReactor.temperatureCorrected.windingToGround.bPhase =
      calculateCorrectedMOhm(originalReactorInsulation.bPhase);
    newElectricalTestReactor.temperatureCorrected.windingToGround.cPhase =
      calculateCorrectedMOhm(originalReactorInsulation.cPhase);
    newElectricalTestReactor.temperatureCorrected.windingToGround.units =
      originalReactorInsulation.units; // Keep units same
    newElectricalTestReactor.temperatureCorrected.testVoltage =
      formData.electricalTestReactor.insulationResistance.testVoltage;

    if (
      !_.isEqual(newElectricalTests, formData.electricalTests) ||
      !_.isEqual(
        newElectricalTestContactor,
        formData.electricalTestContactor,
      ) ||
  ...
  if (loading)
    return (
      <div className="p-4 text-center text-zinc-700 dark:text-white">
    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
        ...
        <div className="mb-6">
          ...
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-job-info">
            Job Information
          </h2>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="form-input bg-zinc-100 dark:bg-dark-150 w-[calc(100%-8rem)]"
                />
              </div>
              <div>
              ...
              <div>
                <label htmlFor="user" className="form-label inline-block w-32">
                  User:
                </label>
                <input
                  id="user"
              ...
              <div>
                <label htmlFor="date" className="form-label inline-block w-32">
                  Date:
                </label>
                <input
                  id="date"
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                <label
                  ...
                  className="form-label inline-block w-16"
                >
                  Temp:
                </label>
                <input
                ...
                <label
                  htmlFor="temperature.tcf"
                  className="form-label inline-block w-10 ml-2"
                >
                  TCF:
                </label>
                <input
                  id="temperature.tcf"
                  name="temperature.tcf"
                  type="number"
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-nameplate-data">
            Nameplate Data
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden nameplate-onscreen">
            ...
            <div className="space-y-3">
              <div>
                <label
                  htmlFor="nameplateData.manufacturer"
                  className="form-label inline-block w-40"
                >
                  Manufacturer:
                </label>
                <input
                  id="nameplateData.manufacturer"
                  type="text"
                  value={formData.nameplateData.manufacturer}
                  onChange={(e) =>
                    handleChange("nameplateData.manufacturer", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              </div>
              <div>
                <label
                  htmlFor="nameplateData.catalogNumber"
                  className="form-label inline-block w-40"
                >
                  Catalog Number:
                </label>
                <input
                  id="nameplateData.catalogNumber"
                  type="text"
                  value={formData.nameplateData.catalogNumber}
                  onChange={(e) =>
                    handleChange("nameplateData.catalogNumber", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.serialNumber"
                  className="form-label inline-block w-40"
                >
                  Serial Number:
                </label>
                <input
                  id="nameplateData.serialNumber"
                  type="text"
                  value={formData.nameplateData.serialNumber}
                  onChange={(e) =>
                    handleChange("nameplateData.serialNumber", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.type"
                  className="form-label inline-block w-40"
                >
                  Type:
                </label>
                <input
                  id="nameplateData.type"
                  type="text"
                  value={formData.nameplateData.type}
                  onChange={(e) =>
                    handleChange("nameplateData.type", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.manufacturingDate"
                  className="form-label inline-block w-40"
                >
                  Manufacturing Date:
                </label>
                <input
                  id="nameplateData.manufacturingDate"
                  type="text"
                  value={formData.nameplateData.manufacturingDate}
                  onChange={(e) =>
                    handleChange(
                      "nameplateData.manufacturingDate",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
            ...
            <div className="space-y-3">
              <div>
                <label
                  htmlFor="nameplateData.icRating"
                  className="form-label inline-block w-40"
                >
                  I.C. Rating (kA):
                </label>
                <input
                  id="nameplateData.icRating"
                  type="text"
                  value={formData.nameplateData.icRating}
                  onChange={(e) =>
                    handleChange("nameplateData.icRating", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.ratedVoltageKV"
                  className="form-label inline-block w-40"
                >
                  Rated Voltage (kV):
                </label>
                <input
                  id="nameplateData.ratedVoltageKV"
                  type="text"
                  value={formData.nameplateData.ratedVoltageKV}
                  onChange={(e) =>
                    handleChange("nameplateData.ratedVoltageKV", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.operatingVoltageKV"
                  className="form-label inline-block w-40"
                >
                  Operating Voltage (kV):
                </label>
                <input
                  id="nameplateData.operatingVoltageKV"
                  type="text"
                  value={formData.nameplateData.operatingVoltageKV}
                  onChange={(e) =>
                    handleChange(
                      "nameplateData.operatingVoltageKV",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
              ...
              <div>
                <label
                  htmlFor="nameplateData.ampacity"
                  className="form-label inline-block w-40"
                >
                  Ampacity:
                </label>
                <input
                  id="nameplateData.ampacity"
                  type="text"
                  value={formData.nameplateData.ampacity}
                  onChange={(e) =>
                    handleChange("nameplateData.ampacity", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="nameplateData.impulseRatingBIL"
                  className="form-label inline-block w-40"
                >
                  Impulse Rating (BIL):
                </label>
                <input
                  id="nameplateData.impulseRatingBIL"
                  type="text"
                  value={formData.nameplateData.impulseRatingBIL}
                  onChange={(e) =>
                    handleChange(
                      "nameplateData.impulseRatingBIL",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-visual-mechanical">
            Visual and Mechanical Inspection
          </h2>
          <div className="overflow-x-auto">
            <table className="w-full table-fixed border-collapse border border-zinc-200 dark:border-zinc-700">
              ...
              <tbody className="bg-white dark:bg-dark-150">
                {formData.visualMechanicalInspection.items.map(
                  (item, index) => (
                    <tr key={item.netaSection}>
                      ...
                      <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700 align-top">
                        <select
                          ...
                          onChange={(e) =>
                            handleListChange(
                              "visualMechanicalInspection.items",
                              index,
                              "result",
                              e.target.value,
                            )
          ...
          <div className="mt-4">
            <h3 className="text-md font-semibold mb-2 text-zinc-900 dark:text-white">
              E-Gap
            </h3>
            ...
            <table className="w-full border-collapse border border-zinc-200 dark:border-zinc-700">
              <thead>
                <tr>
                  <th className="px-3 py-2 text-center text-xs font-medium text-zinc-500 dark:text-white uppercase tracking-wider border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-dark-150 w-1/6">
                    E-Gap
                  </th>{" "}
                  {/* Adjusted width */}
                  <th className="px-3 py-2 text-center text-xs font-medium text-zinc-500 dark:text-white uppercase tracking-wider border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-dark-150 w-1/6">
              ...
              <tbody>
                <tr>
                  ...
                  {/* Empty cell for alignment below E-Gap header */}
                  <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700">
                    <input
                      type="text"
                      value={
                        formData.visualMechanicalInspection.eGap.unitMeasurement
                      }
                      onChange={(e) =>
                        handleChange(
                          "visualMechanicalInspection.eGap.unitMeasurement",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700">
                    <input
                      type="text"
                      value={formData.visualMechanicalInspection.eGap.tolerance}
                      onChange={(e) =>
                        handleChange(
                          "visualMechanicalInspection.eGap.tolerance",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700">
                    <input
                      type="text"
                      value={formData.visualMechanicalInspection.eGap.aPhase}
                      onChange={(e) =>
                        handleChange(
                          "visualMechanicalInspection.eGap.aPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700">
                    <input
                      type="text"
                      value={formData.visualMechanicalInspection.eGap.bPhase}
                      onChange={(e) =>
                        handleChange(
                          "visualMechanicalInspection.eGap.bPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="px-3 py-2 border border-zinc-200 dark:border-zinc-700">
                    <input
                      type="text"
                      value={formData.visualMechanicalInspection.eGap.cPhase}
                      onChange={(e) =>
                        handleChange(
                          "visualMechanicalInspection.eGap.cPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-fuse-data">
            Fuse Data
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden fuse-onscreen">
            <div>
              <label
                htmlFor="fuseData.manufacturer"
                className="form-label block"
              >
                Manufacturer:
              </label>
              <input
                id="fuseData.manufacturer"
                type="text"
            ...
            <div>
              <label
                htmlFor="fuseData.catalogNumber"
                className="form-label block"
              >
                Catalog Number:
              </label>
              <input
                id="fuseData.catalogNumber"
                type="text"
            ...
            <div>
              <label htmlFor="fuseData.class" className="form-label block">
                Class:
              </label>
              <input
                id="fuseData.class"
            ...
            <div>
              <label
                htmlFor="fuseData.ratedVoltageKV"
                className="form-label block"
              >
                Rated Voltage (kV):
              </label>
              <input
                id="fuseData.ratedVoltageKV"
                type="text"
                value={formData.fuseData.ratedVoltageKV}
                onChange={(e) =>
                  handleChange("fuseData.ratedVoltageKV", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="fuseData.ampacity" className="form-label block">
                Ampacity (A):
              </label>
              <input
                id="fuseData.ampacity"
                type="text"
            ...
            <div>
              <label htmlFor="fuseData.icRatingKA" className="form-label block">
                I.C. Rating (kA):
              </label>
              <input
                id="fuseData.icRatingKA"
                type="text"
                value={formData.fuseData.icRatingKA}
                onChange={(e) =>
                  handleChange("fuseData.icRatingKA", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-electrical-tests">
            Electrical Tests
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-zinc-50 dark:bg-dark-150">
                    <th className="p-2 border dark:border-zinc-600"></th>
                    <th className="p-2 border dark:border-zinc-600">P1</th>
                    <th className="p-2 border dark:border-zinc-600">P2</th>
                    <th className="p-2 border dark:border-zinc-600">P3</th>
                    <th className="p-2 border dark:border-zinc-600">Units</th>
                  </tr>
                </thead>
                <tbody>
                  {formData.electricalTests.contactResistanceAsFound.map(
                    (row, index) => (
                      <tr key={`cr-found-${index}`}>
                        <td className="p-2 border dark:border-zinc-600 font-medium">
                          {row.test}
                        </td>
                        {(["p1", "p2", "p3"] as const).map((phase) => (
                          <td
                            key={phase}
                            className="p-1 border dark:border-zinc-600"
                          >
                            <input
                              type="text"
                              value={row[phase]}
                              onChange={(e) =>
                                handleListChange(
                                  "electricalTests.contactResistanceAsFound",
                                  index,
                                  phase,
                                  e.target.value,
                                )
                        ...
                        <td className="p-1 border dark:border-zinc-600">
                          <select
                            value={row.units}
                            onChange={(e) =>
                              handleListChange(
                          ...
                          >
                            {contactResistanceUnitOptions.map((opt) => (
            ...
            <div>
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {formData.electricalTests.contactResistanceAsLeft.map(
                    (row, index) => (
                        ...
                        {(["p1", "p2", "p3"] as const).map((phase) => (
                          ...
                          >
                            <input
                              ...
                              onChange={(e) =>
                                handleListChange(
                                  "electricalTests.contactResistanceAsLeft",
                                  index,
                                  phase,
                                  e.target.value,
                                )
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange(
                      "electricalTests.insulationResistance.testVoltage",
                      e.target.value,
                    )
                  }
                  disabled={!isEditing}
                  className={`form-select inline-block w-auto ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                >
                  {insulationTestVoltageOptions.map((v) => (
              ...
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-zinc-50 dark:bg-dark-150">
                    <th className="p-2 border dark:border-zinc-600">
                      Test Voltage
                    </th>
                    <th className="p-2 border dark:border-zinc-600"></th>
                    <th className="p-2 border dark:border-zinc-600">
                ...
                <tbody>
                  {formData.electricalTests.insulationResistance.readings.map(
                    (row, index) => (
                      <tr key={`ir-${index}`}>
                        <td className="p-2 border dark:border-zinc-600 font-medium">
                          {row.test}
                        </td>
                        <td className="p-2 border dark:border-zinc-600 text-center">
                          {row.state}
                        </td>
                        {(["p1_mq", "p2_mq", "p3_mq"] as const).map((phase) => (
                          ...
                          >
                            <input
                              ...
                              onChange={(e) =>
                                handleListChange(
                                  "electricalTests.insulationResistance.readings",
                                  index,
                                  phase,
                                  e.target.value,
                                )
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <input
                  type="text"
                  value={
                    formData.electricalTests.temperatureCorrected.testVoltage
                  }
                  readOnly
                  className="form-input inline-block w-auto bg-zinc-100 dark:bg-dark-150"
                />
              </div>
              <table className="min-w-full text-sm">
                <thead>
                ...
                <tbody>
                  {formData.electricalTests.temperatureCorrected.readings.map(
                    (row, index) => (
                      <tr key={`tc-ir-${index}`}>
                        <td className="p-2 border dark:border-zinc-600 font-medium">
                          {row.test}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-contactor-data">
            Contactor Data
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden contactor-onscreen">
            ...
            <div className="space-y-3">
              <div>
                <label
                  htmlFor="contactorData.manufacturer"
                  className="form-label inline-block w-40"
                >
                  Manufacturer:
                </label>
                <input
                  id="contactorData.manufacturer"
                  type="text"
                  value={formData.contactorData.manufacturer}
                  onChange={(e) =>
                    handleChange("contactorData.manufacturer", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.catalogNumber"
                  className="form-label inline-block w-40"
                >
                  Catalog Number:
                </label>
                <input
                  id="contactorData.catalogNumber"
                  type="text"
                  value={formData.contactorData.catalogNumber}
                  onChange={(e) =>
                    handleChange("contactorData.catalogNumber", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.serialNumber"
                  className="form-label inline-block w-40"
                >
                  Serial Number:
                </label>
                <input
                  id="contactorData.serialNumber"
                  type="text"
                  value={formData.contactorData.serialNumber}
                  onChange={(e) =>
                    handleChange("contactorData.serialNumber", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.type"
                  className="form-label inline-block w-40"
                >
                  Type:
                </label>
                <input
                  id="contactorData.type"
                  type="text"
                  value={formData.contactorData.type}
                  onChange={(e) =>
                    handleChange("contactorData.type", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.manufacturingDate"
                  className="form-label inline-block w-40"
                >
                  Manufacturing Date:
                </label>
                <input
                  ...
                  type="text"
                  value={formData.contactorData.manufacturingDate}
                  onChange={(e) =>
                    handleChange(
                      "contactorData.manufacturingDate",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
            ...
            <div className="space-y-3">
              <div>
                <label
                  htmlFor="contactorData.icRatingKA"
                  className="form-label inline-block w-40"
                >
                  I.C. Rating (kA):
                </label>
                <input
                  id="contactorData.icRatingKA"
                  type="text"
                  value={formData.contactorData.icRatingKA}
                  onChange={(e) =>
                    handleChange("contactorData.icRatingKA", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.ratedVoltageKV"
                  className="form-label inline-block w-40"
                >
                  Rated Voltage (kV):
                </label>
                <input
                  id="contactorData.ratedVoltageKV"
                  type="text"
                  value={formData.contactorData.ratedVoltageKV}
                  onChange={(e) =>
                    handleChange("contactorData.ratedVoltageKV", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.operatingVoltageKV"
                  className="form-label inline-block w-40"
                >
                  Operating Voltage (kV):
                </label>
                <input
                  id="contactorData.operatingVoltageKV"
                  type="text"
                  value={formData.contactorData.operatingVoltageKV}
                  onChange={(e) =>
                    handleChange(
                      "contactorData.operatingVoltageKV",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
              ...
              <div>
                <label
                  htmlFor="contactorData.ampacity"
                  className="form-label inline-block w-40"
                >
                  Ampacity (A):
                </label>
                <input
                  ...
                  type="text"
                  value={formData.contactorData.ampacity}
                  onChange={(e) =>
                    handleChange("contactorData.ampacity", e.target.value)
                  }
                  readOnly={!isEditing}
                  className={`form-input w-[calc(100%-10rem)] ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                />
              ...
              <div>
                <label
                  htmlFor="contactorData.controlVoltageV"
                  className="form-label inline-block w-40"
                >
                  Control Voltage (V):
                </label>
                <input
                  id="contactorData.controlVoltageV"
                  type="text"
                  value={formData.contactorData.controlVoltageV}
                  onChange={(e) =>
                    handleChange(
                      "contactorData.controlVoltageV",
                      e.target.value,
                    )
                  }
                  readOnly={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-electrical-test-contactor">
            Electrical Test - Contactor
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange(
                      "electricalTestContactor.insulationResistance.testVoltage",
                      e.target.value,
                    )
                  }
                  disabled={!isEditing}
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {formData.electricalTestContactor.insulationResistance.readings.map(
                    (row, index) => (
                        ...
                        {(["p1_mq", "p2_mq", "p3_mq"] as const).map((phase) => (
                          ...
                          >
                            <input
                              ...
                              onChange={(e) =>
                                handleListChange(
                                  "electricalTestContactor.insulationResistance.readings",
                                  index,
                                  phase,
                                  e.target.value,
                                )
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <input
                  type="text"
                  value={
                    formData.electricalTestContactor.temperatureCorrected
                      .testVoltage
                  }
                  readOnly
                  className="form-input inline-block w-auto bg-zinc-100 dark:bg-dark-150"
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {formData.electricalTestContactor.temperatureCorrected.readings.map(
                    (row, index) => (
                ...
                <tr>
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      type="text"
                      value={
                        formData.electricalTestContactor.vacuumBottleIntegrity
                          .testVoltage
                      }
                      onChange={(e) =>
                        handleChange(
                          "electricalTestContactor.vacuumBottleIntegrity.testVoltage",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestContactor.vacuumBottleIntegrity.p1",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestContactor.vacuumBottleIntegrity.p2",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestContactor.vacuumBottleIntegrity.p3",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <select
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestContactor.vacuumBottleIntegrity.units",
                          e.target.value,
                        )
                      }
                      disabled={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-starting-reactor-data">
            Starting Reactor Data
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden reactor-onscreen">
            <div>
              <label
                htmlFor="startingReactorData.manufacturer"
                className="form-label block"
              >
                Manufacturer:
              </label>
              <input
                id="startingReactorData.manufacturer"
                type="text"
                value={formData.startingReactorData.manufacturer}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.manufacturer",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
            ...
            <div>
              <label
                htmlFor="startingReactorData.catalogNumber"
                className="form-label block"
              >
                Catalog Number:
              </label>
              <input
                ...
                type="text"
                value={formData.startingReactorData.catalogNumber}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.catalogNumber",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
            ...
            <div>
              <label
                htmlFor="startingReactorData.serialNumber"
                className="form-label block"
              >
                Serial Number:
              </label>
              <input
                id="startingReactorData.serialNumber"
                type="text"
                value={formData.startingReactorData.serialNumber}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.serialNumber",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
            ...
            <div>
              <label
                htmlFor="startingReactorData.ratedCurrentA"
                className="form-label block"
              >
                Rated Current (A):
              </label>
              <input
                id="startingReactorData.ratedCurrentA"
                type="text"
                value={formData.startingReactorData.ratedCurrentA}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.ratedCurrentA",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
            ...
            <div>
              <label
                htmlFor="startingReactorData.ratedVoltageKV"
                className="form-label block"
              >
                Rated Voltage (kV):
              </label>
              <input
                id="startingReactorData.ratedVoltageKV"
                type="text"
                value={formData.startingReactorData.ratedVoltageKV}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.ratedVoltageKV",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
            ...
            <div>
              <label
                htmlFor="startingReactorData.operatingVoltageKV"
                className="form-label block"
              >
                Operating Voltage (kV):
              </label>
              <input
                id="startingReactorData.operatingVoltageKV"
                type="text"
                value={formData.startingReactorData.operatingVoltageKV}
                onChange={(e) =>
                  handleChange(
                    "startingReactorData.operatingVoltageKV",
                    e.target.value,
                  )
                }
                readOnly={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-electrical-test-reactor">
            Electrical Test - Reactor
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange(
                      "electricalTestReactor.insulationResistance.testVoltage",
                      e.target.value,
                    )
                  }
                  disabled={!isEditing}
              ...
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-zinc-50 dark:bg-dark-150">
                    ...
                    <th className="p-2 border dark:border-zinc-600">A-Phase</th>
                    <th className="p-2 border dark:border-zinc-600">B-Phase</th>
                    <th className="p-2 border dark:border-zinc-600">C-Phase</th>
                    <th className="p-2 border dark:border-zinc-600">Units</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="p-1 border dark:border-zinc-600">
                      <input
                        ...
                        value={
                          formData.electricalTestReactor.insulationResistance
                            .windingToGround.aPhase
                        }
                        onChange={(e) =>
                          handleChange(
                            "electricalTestReactor.insulationResistance.windingToGround.aPhase",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className="p-1 border dark:border-zinc-600">
                      <input
                        ...
                        value={
                          formData.electricalTestReactor.insulationResistance
                            .windingToGround.bPhase
                        }
                        onChange={(e) =>
                          handleChange(
                            "electricalTestReactor.insulationResistance.windingToGround.bPhase",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className="p-1 border dark:border-zinc-600">
                      <input
                        ...
                        value={
                          formData.electricalTestReactor.insulationResistance
                            .windingToGround.cPhase
                        }
                        onChange={(e) =>
                          handleChange(
                            "electricalTestReactor.insulationResistance.windingToGround.cPhase",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className="p-1 border dark:border-zinc-600">
                      <select
                        value={
                          formData.electricalTestReactor.insulationResistance
                            .windingToGround.units
                        }
                        onChange={(e) =>
                          handleChange(
                            "electricalTestReactor.insulationResistance.windingToGround.units",
                            e.target.value,
                          )
                        }
                        disabled={!isEditing}
                        className={`form-select w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                      >
                        {insulationResistanceUnitOptions.map((opt) => (
                          <option key={opt.symbol} value={opt.symbol}>
                            {opt.symbol}
                          </option>
                        ))}
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <input
                  type="text"
                  value={
                    formData.electricalTestReactor.temperatureCorrected
                      .testVoltage
                  }
                  readOnly
                  className="form-input inline-block w-auto bg-zinc-100 dark:bg-dark-150"
                ...
                <tr>
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      type="text"
                      value={
                        formData.electricalTestReactor.contactResistanceAsFound
                          .aPhase
                      }
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsFound.aPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsFound.bPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsFound.cPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <select
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsFound.units",
                          e.target.value,
                        )
                      }
                      disabled={!isEditing}
                ...
                <tr>
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      type="text"
                      value={
                        formData.electricalTestReactor.contactResistanceAsLeft
                          .aPhase
                      }
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsLeft.aPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsLeft.bPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsLeft.cPhase",
                          e.target.value,
                        )
                      }
                      readOnly={!isEditing}
                  ...
                  <td className="p-1 border dark:border-zinc-600">
                    <select
                      ...
                      onChange={(e) =>
                        handleChange(
                          "electricalTestReactor.contactResistanceAsLeft.units",
                          e.target.value,
                        )
                      }
                      disabled={!isEditing}
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-test-equipment">
            Test Equipment Used
          </h2>
          <div className="space-y-4 print:hidden">
            {(
              [
                ...
                {
                  key: "lowResistanceOhmmeter",
                  label: "Low-Resistance Ohmmeter",
                },
              ...
              const handleEquipmentSelect = (selectedEquipment: any) => {
                ...
                handleChange(
                  `testEquipmentUsed.${equip.key}.name`,
                  selectedEquipment.equipment_name,
                );
                handleChange(
                  `testEquipmentUsed.${equip.key}.serialNumber`,
                  selectedEquipment.serial_number || "",
                );
                handleChange(
                  `testEquipmentUsed.${equip.key}.ampId`,
                  selectedEquipment.amp_id || "",
                );
                handleChange(
                  `testEquipmentUsed.${equip.key}.calDate`,
                  formatLocalDateShort(selectedEquipment.calibration_date),
                );
              };
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <label className="form-label block">Serial Number:</label>
                    <input
                      type="text"
                      value={formData.testEquipmentUsed[equip.key].serialNumber}
                      onChange={(e) =>
                        handleChange(
                          `testEquipmentUsed.${equip.key}.serialNumber`,
                          e.target.value,
                  ...
                  <div>
                    <label className="form-label block">AMP ID:</label>
                    <input
                      type="text"
                      value={formData.testEquipmentUsed[equip.key].ampId}
                      onChange={(e) =>
                        handleChange(
                          `testEquipmentUsed.${equip.key}.ampId`,
                          e.target.value,
                  ...
                  <div>
                    <label className="form-label block">Cal Date:</label>
                    <input
                      type="text"
                      value={formData.testEquipmentUsed[equip.key].calDate}
                      onChange={(e) =>
                        handleChange(
                          `testEquipmentUsed.${equip.key}.calDate`,
                          e.target.value,
          ...
          <div className="hidden print:block">
            <table className="w-full table-fixed border-collapse border border-zinc-200 dark:border-zinc-700">
              ...
              <tbody>
                <tr>
                  <td>
                    {formData.testEquipmentUsed.megohmmeter.name ||
                      "Megohmmeter"}
                  </td>
                ...
                <tr>
                  <td>
                    {formData.testEquipmentUsed.lowResistanceOhmmeter.name ||
                      "Low-Resistance Ohmmeter"}
                  </td>
                  <td>
                    {
                      formData.testEquipmentUsed.lowResistanceOhmmeter
                        .serialNumber
                    }
                  </td>
                  <td>
                    {formData.testEquipmentUsed.lowResistanceOhmmeter.ampId}
                  </td>
                </tr>
                <tr>
        ...
        >
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-comments">
            Comments
          </h2>
          <textarea
            ...
            readOnly={!isEditing}
            rows={6}
            className={`form-textarea w-full print:hidden ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
