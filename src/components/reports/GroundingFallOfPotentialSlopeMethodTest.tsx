    ...
    <ReportWrapper>
      <div className="p-6 flex justify-center bg-gray-50 dark:bg-dark-200">
        <div className="max-w-7xl w-full space-y-6">
          ...
          {/* Comments */}
          <section className={`p-0 mb-6 comments-section print:break-inside-avoid ${!comments?.trim() ? 'print:hidden' : ''}`}>
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">Comments</h2>
            <textarea value={comments} onChange={e=>setComments(e.target.value)} readOnly={!isEditing} className={`form-textarea min-h-[120px] whitespace-pre-wrap break-words print:hidden ${!isEditing ? 'bg-gray-100 dark:bg-dark-200' : ''}`} />
          </section>
