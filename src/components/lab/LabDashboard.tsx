              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="primary">{equipmentStats.total}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="warning">{equipmentStats.calibrationUpcoming}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="primary">{certificateStats.total}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Issued this Month:</span>
                    <Badge variant="success">{certificateStats.issuedThisMonth}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="flex items-center">
                      <Clock className="h-4 w-4 mr-2 text-amber-500" />
                    ...
                    <Badge variant="warning">{certificateStats.expiringSoon}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Expired:</span>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="primary">{qualityMetricsSummary.total}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="flex items-center text-green-600">
                      Within Threshold:
                    </span>
                    <Badge variant="success">{qualityMetricsSummary.withinThreshold}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="flex items-center text-amber-600">
                      Below Threshold:
                    </span>
                    <Badge variant="warning">{qualityMetricsSummary.belowThreshold}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
