...
const AutomaticTransferSwitchATSReport: React.FC = () => {
  ...
  const renderInsulationRow = (
    ...
    return (
      <tr>
        <td className="px-6 py-4 text-sm text-neutral-700 dark:text-white whitespace-nowrap">
          {title}
        </td>
        ...
        {hasNeutral ? (
          ...
          <>
            <td className="px-3 py-4 bg-neutral-50 dark:bg-dark-150"></td>
            <td className="px-3 py-4 bg-neutral-50 dark:bg-dark-150"></td>
          </>
        )}
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center mb-4">
            ...
            <select
              ...
              disabled={!isEditing}
              className={`form-select w-32 ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
            >
            ...
            <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
              <thead className="bg-neutral-50 dark:bg-dark-150">
                <tr>
                  <th
                    rowSpan={2}
                    className="px-6 py-3 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider"
                  >
                    Test Points
                  </th>
                  <th
        ...
        <div className="mb-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
              <thead className="bg-neutral-50 dark:bg-dark-150">
                <tr>
                  <th className="px-6 py-3 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider">
                    State
                  </th>
                  <th className="px-6 py-3 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider">
                    P1
        ...
        <div className="mb-6 print:hidden">
          ...
          <textarea
            ...
            readOnly={!isEditing}
            rows={1}
            className={`form-textarea w-full resize-none ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
