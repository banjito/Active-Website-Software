...
const AutomaticTransferSwitchATSReport: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>(() => ({
    ...
    insulationResistance: {
      ...
      poleToGroundNormalClosed: {
        ...initialInsulationRow,
        neutralReading: "",
        neutralCorrected: "",
      },
      poleToGroundEmergencyClosed: {
        ...initialInsulationRow,
        neutralReading: "",
        neutralCorrected: "",
      },
      lineToLoadNormalOpen: {
        ...initialInsulationRow,
        neutralReading: "",
        neutralCorrected: "",
      },
      lineToLoadEmergencyOpen: {
        ...initialInsulationRow,
        neutralReading: "",
        neutralCorrected: "",
      },
      ...
      if (data) {
        ...
        if (data.data) {
          ...
          setFormData((prev) => ({
            ...
            nameplateManufacturer:
              data.report_info?.nameplateManufacturer ??
              prev.nameplateManufacturer,
            nameplateModelType:
              data.report_info?.nameplateModelType ?? prev.nameplateModelType,
            nameplateCatalogNo:
              data.report_info?.nameplateCatalogNo ?? prev.nameplateCatalogNo,
            nameplateSerialNumber:
              data.report_info?.nameplateSerialNumber ??
              prev.nameplateSerialNumber,
            nameplateSystemVoltage:
              data.report_info?.nameplateSystemVoltage ??
              prev.nameplateSystemVoltage,
            nameplateRatedVoltage:
              data.report_info?.nameplateRatedVoltage ??
              prev.nameplateRatedVoltage,
            nameplateRatedCurrent:
              data.report_info?.nameplateRatedCurrent ??
              prev.nameplateRatedCurrent,
            nameplateSCCR:
              data.report_info?.nameplateSCCR ?? prev.nameplateSCCR,
            testEquipmentUsed:
              data.report_info?.testEquipmentUsed ?? prev.testEquipmentUsed,
          }));
        }
        setIsEditing(false);
      }
  ...
  const handleVisualInspectionChange = (
    index: number,
    field: keyof FormData["visualInspectionItems"][0],
    value: string,
  ) => {
    setJustSaved(false);
    if (!isEditing) return;
  ...
  const handleInsulationResistanceChange = (
    stateKey: keyof FormData["insulationResistance"],
    field: string,
    value: string,
  ) => {
    if (!isEditing) return;
    setFormData((prev) => {
      ...
      if (field.includes("Reading")) {
        ...
        (newIR[stateKey] as any)[correctedField] =
          calculateTempCorrectedReading(value, tcf);
      }
  ...
  const handleContactResistanceChange = (
    state: keyof FormData["contactResistance"],
    field: keyof FormData["contactResistance"]["normal"],
    value: string,
  ) => {
    if (!isEditing) return;
    setFormData((prev) => {
  ...
  const handleTestEquipmentChange = (
    equipmentType: "megohmmeter" | "lowResistanceOhmmeter",
    field: keyof TestEquipmentItem,
    value: string,
  ) => {
    setJustSaved(false);
    if (!isEditing) return;
  ...
  const renderInsulationRow = (
    stateKey: keyof FormData["insulationResistance"],
    title: string,
    hasNeutral: boolean = false,
  ) => {
    const rowData =
      formData.insulationResistance[stateKey] ||
      ({ ...initialInsulationRow } as any);
    return (
      <tr>
        <td className="px-6 py-4 text-sm text-zinc-700 dark:text-white whitespace-nowrap">
          {title}
        </td>
        ...
        {hasNeutral ? (
          <React.Fragment>
            ...
            <td className="px-3 py-4">
              <input
                type="text"
                value={rowData.neutralCorrected || ""}
                readOnly
                className="form-input w-full text-center bg-zinc-100 dark:bg-dark-150"
              />
            </td>
          ...
          <>
            <td className="px-3 py-4 bg-zinc-50 dark:bg-dark-150"></td>
            <td className="px-3 py-4 bg-zinc-50 dark:bg-dark-150"></td>
          </>
        )}
        <td className="px-6 py-4">
          <select
            value={rowData.units || "MΩ"}
            onChange={(e) =>
              handleInsulationResistanceChange(
                stateKey,
                "units",
          ...
          >
            {insulationResistanceUnitsOptions.map((u) => (
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-x-4 gap-y-2 print:hidden nameplate-grid">
            <div>
              <label htmlFor="nameplateManufacturer" className="form-label">
                Manufacturer:
              </label>
              <input
                id="nameplateManufacturer"
                type="text"
                value={formData.nameplateManufacturer}
                onChange={(e) =>
                  handleChange("nameplateManufacturer", e.target.value)
                }
                readOnly={!isEditing}
            ...
            <div>
              <label htmlFor="nameplateModelType" className="form-label">
                Model / Type:
              </label>
              <input
                id="nameplateModelType"
                type="text"
                value={formData.nameplateModelType}
                onChange={(e) =>
                  handleChange("nameplateModelType", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateCatalogNo" className="form-label">
                Catalog No.:
              </label>
              <input
                id="nameplateCatalogNo"
                type="text"
                value={formData.nameplateCatalogNo}
                onChange={(e) =>
                  handleChange("nameplateCatalogNo", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateSerialNumber" className="form-label">
                Serial Number:
              </label>
              <input
                id="nameplateSerialNumber"
                type="text"
                value={formData.nameplateSerialNumber}
                onChange={(e) =>
                  handleChange("nameplateSerialNumber", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateSystemVoltage" className="form-label">
                System Voltage (V):
              </label>
              <input
                id="nameplateSystemVoltage"
                type="text"
                value={formData.nameplateSystemVoltage}
                onChange={(e) =>
                  handleChange("nameplateSystemVoltage", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateRatedVoltage" className="form-label">
                Rated Voltage (V):
              </label>
              <input
                id="nameplateRatedVoltage"
                type="text"
                value={formData.nameplateRatedVoltage}
                onChange={(e) =>
                  handleChange("nameplateRatedVoltage", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateRatedCurrent" className="form-label">
                Rated Current (A):
              </label>
              <input
                id="nameplateRatedCurrent"
                type="text"
                value={formData.nameplateRatedCurrent}
                onChange={(e) =>
                  handleChange("nameplateRatedCurrent", e.target.value)
                }
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            ...
            <div>
              <label htmlFor="nameplateSCCR" className="form-label">
                SCCR (kA):
              </label>
              <input
                id="nameplateSCCR"
                type="text"
                value={formData.nameplateSCCR}
                onChange={(e) => handleChange("nameplateSCCR", e.target.value)}
                readOnly={!isEditing}
                className={`form-input ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
              />
            </div>
              ...
              <tbody>
                <tr>
                  <td className="border border-black px-2 py-1 align-top">
                    ...
                    <div>{formData.nameplateManufacturer}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Model / Type:</div>
                    <div>{formData.nameplateModelType}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Catalog No.:</div>
                    <div>{formData.nameplateCatalogNo}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Serial Number:</div>
                    <div>{formData.nameplateSerialNumber}</div>
                  </td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">System Voltage (V):</div>
                    <div>{formData.nameplateSystemVoltage}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Rated Voltage (V):</div>
                    <div>{formData.nameplateRatedVoltage}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Rated Current (A):</div>
                    <div>{formData.nameplateRatedCurrent}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">SCCR (kA):</div>
                    <div>{formData.nameplateSCCR}</div>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-insulation-resistance">
            Electrical Tests - Insulation Resistance
          </h2>
          ...
          <div className="flex items-center mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handleChange("insulationTestVoltage", e.target.value)
              }
              disabled={!isEditing}
              className={`form-select w-32 ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
            >
              {testVoltageOptions.map((v) => (
            ...
            <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
              <thead className="bg-zinc-50 dark:bg-dark-150">
                <tr>
                  <th
                    rowSpan={2}
                    className="px-6 py-3 text-center text-xs font-medium text-zinc-500 dark:text-white uppercase tracking-wider"
                  >
                    Test Points
                  </th>
                  <th
              ...
              <tbody className="bg-white dark:bg-dark-150 divide-y divide-zinc-200 dark:divide-zinc-700">
                {renderInsulationRow(
                  "poleToPoleNormalClosed",
                  "Pole to Pole (Normal Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "poleToPoleEmergencyClosed",
                  "Pole to Pole (Emergency Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "poleToNeutralNormalClosed",
                  "Pole to Neutral (Normal Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "poleToNeutralEmergencyClosed",
                  "Pole to Neutral (Emergency Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "poleToGroundNormalClosed",
                  "Pole to Ground (Normal Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "poleToGroundEmergencyClosed",
                  "Pole to Ground (Emergency Closed)",
                  true,
                )}
                {renderInsulationRow(
                  "lineToLoadNormalOpen",
                  "Line to Load (Normal Open)",
                  true,
                )}
                {renderInsulationRow(
                  "lineToLoadEmergencyOpen",
                  "Line to Load (Emergency Open)",
                  true,
                )}
              </tbody>
            </table>
        ...
        <div className="mb-6">
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
          <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2 print:text-black print:border-black print:font-bold section-contact-resistance">
            Electrical Tests - Contact/Pole Resistance
          </h2>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
              <thead className="bg-zinc-50 dark:bg-dark-150">
                <tr>
                  <th className="px-6 py-3 text-center text-xs font-medium text-zinc-500 dark:text-white uppercase tracking-wider">
                    State
                  </th>
                  <th className="px-6 py-3 text-center text-xs font-medium text-zinc-500 dark:text-white uppercase tracking-wider">
                    P1
              ...
              <tbody className="bg-white dark:bg-dark-150 divide-y divide-zinc-200 dark:divide-zinc-700">
                {(["normal", "emergency"] as const).map((state) => {
                  const stateObj = formData.contactResistance[state] || {
                    p1: "",
                    p2: "",
                    p3: "",
                    neutral: "",
                    ...
                    <tr key={state}>
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className={`form-select w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                        >
                          {contactResistanceUnitsOptions.map((u) => (
                            <option key={u} value={u}>
                              {u}
                            </option>
                          ))}
            ...
            <tbody>
              <tr>
                <td className="border border-black px-2 py-1 text-sm">
                  {formData.testEquipmentUsed.megohmmeter.name || "Megohmmeter"}
                </td>
                <td className="border border-black px-2 py-1 text-sm">
                  {formData.testEquipmentUsed.megohmmeter.serialNumber}
                </td>
                <td className="border border-black px-2 py-1 text-sm">
                  {formData.testEquipmentUsed.megohmmeter.ampId}
                </td>
              </tr>
              <tr>
                <td className="border border-black px-2 py-1 text-sm">
        ...
        <div className="mb-6 print:hidden">
          ...
          <textarea
            ...
            readOnly={!isEditing}
            rows={1}
            className={`form-textarea w-full resize-none ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
