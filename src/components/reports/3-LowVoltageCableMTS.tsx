          ...
          <h2 className="section-job-info text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2 print:text-black print:border-black print:font-bold">Job Information</h2>
            ...
            <div className="job-info-grid grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-2 print:hidden">
              <div>
                ...
                <input id="customer" name="customer" type="text" value={formData.customer} onChange={handleChange} readOnly className={`form-input text-sm bg-gray-100 dark:bg-dark-150 cursor-not-allowed`} />
              </div>
              <div>
                <label htmlFor="address" className="form-label">Address:</label>
                <input id="address" name="address" type="text" value={formData.address} onChange={handleChange} readOnly className={`form-input text-sm bg-gray-100 dark:bg-dark-150 cursor-not-allowed`} />
              </div>
              <div>
