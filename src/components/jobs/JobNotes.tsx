      ...
      if (selectedFile) {
        ...
        if (!attachmentData && selectedFile) {
          ...
          toast({
            ...
            description:
              "Could not upload file, but note will be saved without attachment.",
            variant: "destructive",
          });
        }
      }
  ...
  const handleDelete = async (noteId: string) => {
    ...
    try {
      ...
      if (!data || data.length === 0) {
        throw new Error(
          "Note could not be updated. You may not have permission to delete this note.",
        );
      }
            ...
            notes.map((note) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Note Content */}
                  <div
                    className={`flex-1 max-w-[80%] ${isCurrentUser ? "text-right" : ""}`}
                  >
                    {/* User name and time */}
                    <div
