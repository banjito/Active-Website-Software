...
export const SCHEMAS = {
  ...
  // technician scheduling tables (moved to neta_ops schema)
  TECH_AVAILABILITY: 'neta_ops.technician_availability',
  TECH_EXCEPTIONS: 'neta_ops.technician_exceptions',
  TECH_SKILLS: 'neta_ops.technician_skills',
  TECH_ASSIGNMENTS: 'neta_ops.technician_assignments',
  TECH_TIME_OFF: 'neta_ops.technician_time_off',
  JOB_SKILL_REQUIREMENTS: 'neta_ops.job_skill_requirements',
  AVAILABLE_TECHNICIANS: 'neta_ops.available_technicians',
