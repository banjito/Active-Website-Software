...
const FeaturesFixesPage: React.FC = () => {
  ...
  const PRIORITY_BG: Record<Issue["priority"], string> = {
    ...
    low: "bg-gray-50 dark:bg-gray-800/40",
  };
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        <th
                          rowSpan={2}
                          className="text-left py-2 px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase align-bottom"
                        >
                          Priority
                        </th>
                        <th
                          rowSpan={2}
                          className="text-center py-2 px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase align-bottom"
                        >
                          Count
                        </th>
                        <th
                      ...
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        <th className="text-center py-1.5 px-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                          Response
                        </th>
                        <th className="text-center py-1.5 px-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                          Fix Time
                    ...
                    <tbody>
                      {stats.priorityBreakdown.map((row) => (
                        <tr
                          key={row.priority}
                          className={`border-b border-gray-100 dark:border-gray-800 ${PRIORITY_BG[row.priority]}`}
                        >
                          <td
                          ...
                          <td className="py-2.5 px-2 text-center font-medium text-gray-700 dark:text-gray-300">
                            {row.issueResponse}
                          </td>
                          <td className="py-2.5 px-2 text-center font-medium text-gray-700 dark:text-gray-300">
                            {row.avgFixTime}
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      ...
                      <th className="text-left py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400 min-w-[7.5rem]">
                        Priority
                      </th>
                      <th className="text-left py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">
                        Date Added
                      ...
                      {hasIssueOpsAccess && (
                        <th
                          className="text-center py-3 px-2 text-sm font-medium text-gray-500 dark:text-gray-400"
                  ...
                  <tbody>
                    {paginatedIssues.map((issue) => {
                      ...
                      return (
                        <tr
                          key={issue.id}
                          className={`border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-dark-100 ${hasIssueOpsAccess && isExcluded ? "opacity-50" : ""}`}
                        >
                          ...
                          <td className="py-3 px-4">
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-500 dark:text-gray-400 truncate max-w-[600px]">
                                {issue.description}
                              </div>
                            </button>
                          </td>
                          <td className="py-3 px-4">
                            <span
                              className={`text-sm ${issue.status === "paused" ? "text-amber-600 dark:text-amber-400 font-medium" : "text-gray-700 dark:text-gray-300"}`}
                            >
                              {issue.status === "paused" && "⏸ "}
                              {issue.status}
                            </span>
                          ...
                          <td className="py-3 px-4 min-w-[7.5rem]">
                            {isAdmin || user?.id === issue.reporter_id ? (
                              ...
                              <span className="text-sm text-gray-700 dark:text-gray-300 inline-block min-w-[5rem]">
                          ...
                          <div className="flex flex-wrap gap-1.5 mt-2">
                            {editedInterestedParties.map((uid) => {
                              ...
                              return (
                                <span
                                  key={uid}
                                  className="inline-flex items-center gap-1 bg-gray-100 dark:bg-dark-100 text-gray-800 dark:text-gray-200 text-sm px-2.5 py-1 rounded-full"
                                >
                                  {u?.name || "User"}
                                  <button
                                    type="button"
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {(
                              ...
                              return (
                                <span
                                  key={uid}
                                  className="inline-flex items-center bg-gray-100 dark:bg-dark-100 text-gray-800 dark:text-gray-200 text-sm px-2.5 py-1 rounded-full"
                                >
                                  {u?.name || "User"}
                                </span>
                              );
