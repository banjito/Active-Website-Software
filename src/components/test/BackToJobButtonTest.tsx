      ...
      <div className="bg-white dark:bg-dark-150 rounded-none shadow-md border border-neutral-200 dark:border-neutral-700 p-6">
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-none">
          ...
          <div className="text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <p>
              <strong>Is Report Page:</strong>{" "}
              {isReportPage ? "✅ Yes" : "❌ No"}
            </p>
            <p>
              <strong>Job ID:</strong> {jobId || "None detected"}
            </p>
            <p>
              <strong>Button Should Show:</strong>{" "}
              {isReportPage && jobId ? "✅ Yes" : "❌ No"}
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-none">
          ...
          <ul className="text-green-700 dark:text-green-300 space-y-1 text-sm">
            ...
            <li>
              • Report pages are detected by the URL pattern:{" "}
              <code>/jobs/[jobId]/[reportType]/[reportId?]</code>
            </li>
            <li>
              • The job ID is extracted from the URL and used for the back
              navigation
            </li>
            <li>
              • Clicking the button navigates to <code>/jobs/[jobId]</code>
            </li>
