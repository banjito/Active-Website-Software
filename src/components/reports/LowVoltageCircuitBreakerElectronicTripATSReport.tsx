    ...
    try {
      ...
      if (jobData) {
        ...
        setFormData(prev => ({
          ...
          address: normalizeAddress(customerAddress), // normalized address
              ...
              const rebuildFromSections = (() => {
                ...
                const fieldListToObj = (sec: any) => {
                  ...
                  for (const f of arr) {
                    ...
                    const v = f?.value;
                    if (label.startsWith('customer')) obj.customer = v;
                    else if (label.startsWith('address')) obj.address = v;
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="p-3 align-top border border-gray-300 print:border-black">
                        ...
                        <div className="mt-1">{normalizeAddress(formData.address)}</div>
                      </td>
                      <td className="p-3 align-top border border-gray-300 print:border-black">
