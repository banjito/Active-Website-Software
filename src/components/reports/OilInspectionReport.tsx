...
const OilInspectionReport: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    testEquipment: {
      ...
      windingResistanceTestSet: { name: '', serialNumber: '', ampId: '', calDate: '' },
      excitationTestSet: { name: '', serialNumber: '', ampId: '', calDate: '' },
      powerFactorTestSet: { name: '', serialNumber: '', ampId: '', calDate: '' }
    },
    comments: '',
    status: 'PASS',
    turnsRatioTests: {
  ...
  const loadReport = async () => {
      ...
      try {
          console.log(`Loading report from ${OIL_INSPECTION_TABLE} with ID: ${currentReportId}`);
          ...
          if (error) {
              if (error.code === 'PGRST116') {
                  console.warn(`Report with ID ${currentReportId} not found in ${OIL_INSPECTION_TABLE}. Starting new report.`);
                  setIsEditing(true);
              } else {
                  throw error;
              }
      ...
      if (!jobId || !user?.id || !isEditing) {
       ...
       try {
           ...
           if (currentReportId) {
               ...
               console.log(`Updating ${OIL_INSPECTION_TABLE} with ID: ${currentReportId}`);
           ...
           // Report saved silently via autosave
  ...
  // useEffect to load data on initial mount or when jobId/currentReportId changes
  useEffect(() => {
      ...
      fetchData();
  }, [jobId, currentReportId]); // Dependencies for loading data
    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="p-6 flex justify-center bg-gray-50 dark:bg-dark-150">
        ...
        <div className="flex gap-2 items-center"> {/* <-- Added items-center */}
          ...
          {currentReportId && !isEditing && !locked ? (
            ...
            >
              {loading ? 'Saving...' : (currentReportId ? 'Update Report' : 'Save New Report')}
            </button>
          )}
          {currentReportId && !isEditing && locked && (
            <button
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2 mb-8 print:hidden">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Eqpt. Location</label>
              <input
                type="text"
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-white">KVA</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-white">Temp. Rise (°C)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-white">Impedance (%)</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-[100px_1fr_1fr_1fr] gap-4 items-center nameplate-connections-grid">
            <div></div>
            <div className="text-center text-sm font-medium text-gray-700 dark:text-white">Volts</div>
            <div className="text-center text-sm font-medium text-gray-700 dark:text-white">Connections</div>
            <div className="text-center text-sm font-medium text-gray-700 dark:text-white">Winding Material</div>
            ...
            <div className="flex justify-center space-x-4">
              {['Delta', 'Wye', 'Single Phase'].map(conn => (
                <label key={`pri-${conn}`} className="inline-flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700 dark:text-white">{conn}</span>
                </label>
              ))}
            </div>
            <div className="flex justify-center space-x-4">
              {['Aluminum', 'Copper'].map(mat => (
                <label key={`pri-${mat}`} className="inline-flex items-center">
                  <input
                    ...
                    className="form-radio h-4 w-4 text-[#f26722] border-gray-300 dark:border-gray-700 focus:ring-[#f26722]"
                  />
                  <span className="ml-2 text-sm text-gray-700 dark:text-white">{mat}</span>
                </label>
              ))}
            </div>
        ...
        <div className="mt-6 border-t dark:border-gray-700 pt-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              <label className="w-32 text-sm font-medium text-gray-700 dark:text-white">Tap Voltages</label>
            ...
            <div className="flex items-center">
              <label className="w-32 text-sm font-medium text-gray-700 dark:text-white">Tap Position</label>
              <div className="grid grid-cols-7 gap-2 flex-1">
            ...
            <div className="flex items-center">
              <label className="w-32 text-sm font-medium text-gray-700 dark:text-white">Tap Position Left</label>
              <div className="flex items-center space-x-8">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-sm font-medium text-gray-700 dark:text-white">Volts</span>
                  <input
                    type="text"
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-sm font-medium text-gray-700 dark:text-white">Percent</span>
                  <input
                    type="text"
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Section</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Description</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-40">Result</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Comments</th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              {Object.keys(formData.visualInspection)
                ...
                <tr key={id}>
                  ...
                  <td className="px-4 py-2 text-sm text-gray-700 dark:text-white">{getVisualInspectionDescription(id)}</td>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <table className="w-full border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th colSpan={6} className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700">Insulation Resistance Values</th>
                  </tr>
                  <tr>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">Test</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-20">kV</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">0.5 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">1 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">10 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 w-16">Unit</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                  {[
            ...
            <div>
              <table className="w-full border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th colSpan={4} className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700">Temperature Corrected Values</th>
                  </tr>
                  <tr>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">0.5 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">1 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">10 Min.</th>
                    <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700">Unit</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                  {[
          ...
          <table className="w-full border border-gray-200 dark:border-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-1/3">Calculated Values</th>
                <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Primary</th>
                <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Secondary</th>
                <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Pri-Sec</th>
                <th className="px-2 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700">Acceptable</th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                <td className="px-2 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                  ...
                  <div className="text-xs text-gray-500 dark:text-white dark:text-white">(Ratio of 1 Min. to 0.5 Minute Result)</div>
                </td>
                <td className="px-1 py-1 border-r dark:border-gray-700">
                  <input 
                    type="text" 
              ...
              <tr>
                <td className="px-2 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                  Polarization Index
                  <div className="text-xs text-gray-500 dark:text-white dark:text-white">(Ratio of 10 Min. to 1 Min. Result)</div>
                </td>
                <td className="px-1 py-1 border-r dark:border-gray-700">
                  <input 
                    type="text" 
      ...
      {!isOmicronMode && (
        <>
          ...
          <div className="flex items-center space-x-2">
            <label className="text-sm font-medium text-gray-700 dark:text-white">Secondary Winding Voltage (L-N for Wye, L-L for Delta):</label>
            <input
              type="text"
            ...
            />
            <span className="text-sm text-gray-700 dark:text-white">V</span>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead>
                <tr>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Tap</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Nameplate Voltage</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Calculated Ratio</th>
                  <th colSpan={2} className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Phase A</th>
                  <th colSpan={2} className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Phase B</th>
                  <th colSpan={2} className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Phase C</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Assessment</th>
                </tr>
                <tr>
                  <th className="px-3 py-2"></th>
                  <th className="px-3 py-2"></th>
                  <th className="px-3 py-2"></th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">TTR</th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">% Dev.</th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">TTR</th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">% Dev.</th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">TTR</th>
                  <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">% Dev.</th>
          ...
          <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-6">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-200 dark:border-gray-700">
                  <thead className="bg-gray-50 dark:bg-dark-150">
                    <tr>
                      <th rowSpan={2} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-16">TAP</th>
                      <th colSpan={3} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Phase A</th>
                      <th colSpan={3} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Phase B</th>
                      <th rowSpan={2} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-32">Units</th>
                      <th rowSpan={2} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-32">Smallest<br/>Value<br/>Deviation</th>
                      <th rowSpan={2} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 w-24">Assess-<br/>ment</th>
                    </tr>
                    <tr>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Meas.</th>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Dev.</th>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Corr.</th>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Meas.</th>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Dev.</th>
                      <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">R Corr.</th>
                    </tr>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-white">Test Voltage (kV)</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-white">*Reference Voltage (kV)</label>
            <input 
              type="text" 
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-200 dark:border-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                ...
                <th colSpan={3} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Phase A</th>
                <th colSpan={3} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Phase B</th>
                <th colSpan={3} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Phase C</th>
                <th rowSpan={2} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">Assessment</th>
              </tr>
              <tr>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">* I out (mA)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">* Watt losses (W)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">Reactance (kΩ)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">* I out (mA)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">* Watt losses (W)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">Reactance (kΩ)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700 w-24">* I out (mA)</th>
            ...
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              {formData.excitation.tests.map((test, index) => (
                <tr key={index}>
                  ...
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input type="text" value={test.phaseA.reactance} readOnly className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white text-center cursor-not-allowed" />
                  </td>
                  {/* Phase B */}
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input 
                  ...
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input type="text" value={test.phaseB.reactance} readOnly className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white text-center cursor-not-allowed" />
                  </td>
                  {/* Phase C */}
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input 
                  ...
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input type="text" value={test.phaseC.reactance} readOnly className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white text-center cursor-not-allowed" />
                  </td>
                  {/* Assessment */}
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input 
        ...
        <div className="grid grid-cols-2 gap-4 mb-2">
         ...
         <p className="text-sm text-gray-600 dark:text-white mb-4">Calculations: PF meas. = Cosine Theta = Watt Losses / (V out x I out)</p>
        ...
        <div className="overflow-x-auto mb-6">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-200 dark:border-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">No.</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Meas.</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Test Mode</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Freq.</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">V out (kV)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">*I out (mA)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">*Watt Losses (mW)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">PF Meas.</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Cap meas. (pF)</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white border-b dark:border-gray-700 border-r dark:border-gray-700">Assessment</th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              {formData.powerFactor.primary.tests.map((test, index) => (
                <tr key={index}>
                  ...
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input type="text" value={test.pfMeas} readOnly className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white text-center cursor-not-allowed" />
                  </td>
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input type="text" value={test.capMeas} readOnly className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white text-center cursor-not-allowed" />
                  </td>
                  <td className="px-3 py-2 text-sm text-gray-900 dark:text-white border-r dark:border-gray-700">
                    <input 
                      type="text" 
      ...
      <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">Test Equipment Used</h2>
         <div className="grid grid-cols-1 gap-6 print:hidden test-eqpt-onscreen">
           ...
           <div className="grid grid-cols-4 gap-4 border-b dark:border-gray-700 pb-4">
             <div>
               <label className="block text-sm font-medium text-gray-700 dark:text-white">TTR Test Set</label>
               <input 
                 type="text" 
             ...
             <div>
               ...
               <input 
                 ...
                 onChange={(e) => handleNestedChange('testEquipment', 'ttrTestSet', { ...formData.testEquipment.ttrTestSet, calDate: e.target.value })} 
                 readOnly={!isEditing}
                 className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
               />
             </div>
           ...
           <div className="grid grid-cols-4 gap-4 border-b dark:border-gray-700 pb-4">
             <div>
               <label className="block text-sm font-medium text-gray-700 dark:text-white">Winding Resistance Test Set</label>
               <input 
                 type="text" 
             ...
             <div>
               ...
               <input 
                 type="text" 
                 value={formData.testEquipment.windingResistanceTestSet.calDate} 
                 onChange={(e) => handleNestedChange('testEquipment', 'windingResistanceTestSet', { ...formData.testEquipment.windingResistanceTestSet, calDate: e.target.value })} 
                 readOnly={!isEditing}
                 className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
               />
             </div>
           ...
           <div className="grid grid-cols-4 gap-4 border-b dark:border-gray-700 pb-4">
             <div>
               <label className="block text-sm font-medium text-gray-700 dark:text-white">Excitation Test Set</label>
               <input 
                 type="text" 
             ...
             <div>
               ...
               <input 
                 type="text" 
                 value={formData.testEquipment.excitationTestSet.calDate} 
                 onChange={(e) => handleNestedChange('testEquipment', 'excitationTestSet', { ...formData.testEquipment.excitationTestSet, calDate: e.target.value })} 
                 readOnly={!isEditing}
                 className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
               />
             </div>
           ...
           <div className="grid grid-cols-4 gap-4 border-b dark:border-gray-700 pb-4">
             <div>
               <label className="block text-sm font-medium text-gray-700 dark:text-white">Power Factor Test Set</label>
               <input 
                 type="text" 
             ...
             <div>
               ...
               <input 
                 type="text" 
                 value={formData.testEquipment.powerFactorTestSet.calDate} 
                 onChange={(e) => handleNestedChange('testEquipment', 'powerFactorTestSet', { ...formData.testEquipment.powerFactorTestSet, calDate: e.target.value })} 
                 readOnly={!isEditing}
                 className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
               />
             </div>
           ...
           <table className="w-full border border-gray-300 print:border-black">
             ...
             <tbody>
               <tr>
                 ...
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.name || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.serialNumber || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.ampId || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.megohmmeter.calDate || ''}</td>
               </tr>
               <tr>
                 <td className="p-2 border border-gray-300 print:border-black font-semibold">TTR Test Set</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.ttrTestSet.name || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.ttrTestSet.serialNumber || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.ttrTestSet.ampId || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.ttrTestSet.calDate || ''}</td>
               </tr>
               <tr>
                 <td className="p-2 border border-gray-300 print:border-black font-semibold">Winding Resistance Test Set</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.windingResistanceTestSet.name || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.windingResistanceTestSet.serialNumber || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.windingResistanceTestSet.ampId || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.windingResistanceTestSet.calDate || ''}</td>
               </tr>
               <tr>
                 <td className="p-2 border border-gray-300 print:border-black font-semibold">Excitation Test Set</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.excitationTestSet.name || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.excitationTestSet.serialNumber || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.excitationTestSet.ampId || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.excitationTestSet.calDate || ''}</td>
               </tr>
               <tr>
                 <td className="p-2 border border-gray-300 print:border-black font-semibold">Power Factor Test Set</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.powerFactorTestSet.name || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.powerFactorTestSet.serialNumber || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.powerFactorTestSet.ampId || ''}</td>
                 <td className="p-2 border border-gray-300 print:border-black">{formData.testEquipment.powerFactorTestSet.calDate || ''}</td>
               </tr>
             </tbody>
           </table>
         </div>
