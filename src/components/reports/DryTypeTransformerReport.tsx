...
const calculateCorrectedValue = (readingStr: string, tcf: number): string => {
  if (readingStr === '' || readingStr === null || readingStr === undefined) return '' as any;
...
const DryTypeTransformerReport: React.FC = () => {
  ...
  const loadReport = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        setFormData({
          ...formData,
          customer: maskCustomerName(data.report_info?.customer || formData.customer),
          address: maskCustomerAddress(data.report_info?.address || formData.address),
  ...
  }, [jobId, currentReportId]); // Rerun if jobId or currentReportId changes
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 visual-mechanical-table table-fixed">
            ...
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr key={index}>
                  ...
                  <td className="px-3 py-2 text-sm text-gray-700 dark:text-white whitespace-normal break-words">{item.description}</td>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-dark-150">
                <tr>
                   ...
                   <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">Primary</th>
                   <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">Secondary</th>
                   <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">Primary to Secondary</th>
                   <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">Acceptable</th>
                </tr>
               </thead>
              <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-white">Dielectric Absorption : (Ratio of 1 Minute to 0.5 Minute Result)</td>
                ...
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-white">Polarization Index : (Ratio of 10 Minute to 1 Minute Result)</td>
                  <td className="px-6 py-4 w-32">
                    <input
                      type="text"
              ...
              <div className="grid grid-cols-4 gap-4">
                <div>
                  ...
                  <EquipmentAutocomplete
                    ...
                    onChange={(value) => handleNestedChange('testEquipment', 'megohmmeter', {
