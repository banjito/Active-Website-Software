...
const AfterActionReports: React.FC<AfterActionReportsProps> = ({
  jobId,
  jobNumber,
  clientName,
}) => {
  ...
  const [selectedReport, setSelectedReport] =
    useState<AfterActionReport | null>(null);
  const [reportType, setReportType] = useState<
    "technician_progress" | "admin_closeout"
  >("technician_progress");
  ...
  const [formData, setFormData] = useState<Partial<AfterActionReport>>({
    ...
    equipment_issues: "",
    coordination_issues: "",
    time_allocation: DEFAULT_TIME_CATEGORIES.map((cat) => ({
      category: cat,
      hours: "",
    })),
    consumables_used: "",
  ...
  const handleViewReport = (report: AfterActionReport) => {
    ...
    setFormData({
      ...
      time_allocation:
        ...
        DEFAULT_TIME_CATEGORIES.map((cat) => ({ category: cat, hours: "" })),
    });
    setIsEditMode(false);
  ...
  const handleSave = async (submitReport: boolean = false) => {
    ...
    try {
      ...
      const reportData = {
        ...
        technician_submission_timestamp:
          submitReport && reportType === "technician_progress"
            ? new Date().toISOString()
            : formData.technician_submission_timestamp,
        // Section B
        ...
        adjustments_to_technician_report:
          formData.adjustments_to_technician_report,
        notes_for_project_manager: formData.notes_for_project_manager,
        admin_name: formData.admin_name,
        admin_submission_timestamp:
          submitReport && reportType === "admin_closeout"
            ? new Date().toISOString()
  ...
  const renderTechnicianProgressForm = () => (
    <div className="space-y-3">
      {/* Header */}
      <div className="pb-2">
        <h2 className="text-base font-bold text-[#1e5091] dark:text-blue-400 border-b-2 border-[#1e5091] dark:border-blue-400 inline-block">
          NETA Technician After-Action Report
        </h2>
        <h3 className="text-sm font-semibold text-[#1e5091] dark:text-blue-400 mt-2">
          Section A – Technician Completed Fields
        </h3>
      </div>
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("project_job_number", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("client_site_name", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("phase_scope_completed", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("crew_size_roles", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-1 cursor-pointer text-sm">
                    <input
                      type="checkbox"
                      checked={formData.safety_incident === true}
                      onChange={() =>
                        handleInputChange("safety_incident", true)
                      }
                      disabled={!isEditMode}
                      className="w-3 h-3"
                    />
                  ...
                  <label className="flex items-center gap-1 cursor-pointer text-sm">
                    <input
                      ...
                      onChange={() =>
                        handleInputChange("safety_incident", false)
                      }
                      disabled={!isEditMode}
                      className="w-3 h-3"
                    />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("incident_description", e.target.value)
                  }
                  disabled={!isEditMode}
                  rows={1}
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("near_misses_hazards", e.target.value)
                  }
                  disabled={!isEditMode}
                  rows={1}
                  className="w-full p-1 text-sm border border-neutral-300 dark:border-neutral-600 rounded dark:bg-dark-100 dark:text-white"
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("delays_encountered", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("scope_changes", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("equipment_issues", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("coordination_issues", e.target.value)
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm dark:bg-dark-100 dark:text-white w-full"
                />
              ...
              <tr key={index}>
                ...
                <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                  <Input
                    ...
                    value={item.hours}
                    onChange={(e) =>
                      handleTimeAllocationChange(index, e.target.value)
                    }
                    disabled={!isEditMode}
                    className="border-0 shadow-none h-6 text-sm dark:bg-dark-100 dark:text-white w-full"
                  />
                </td>
              </tr>
            ))}
  ...
  const renderAdminCloseoutForm = () => (
    <div className="space-y-3">
      ...
      <div className="text-center pb-2">
        <h2 className="text-base font-bold text-[#1e5091] dark:text-blue-400">
          NETA Technician After-Action Report
        </h2>
        <h3 className="text-sm font-semibold text-[#1e5091] dark:text-blue-400">
          Section B – Admin / Finalized Completed Fields
        </h3>
      </div>
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  type="number"
                  step="0.01"
                  value={formData.labor_cost_total ?? ""}
                  onChange={(e) =>
                    handleInputChange(
                      "labor_cost_total",
                      e.target.value ? parseFloat(e.target.value) : null,
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  type="number"
                  step="0.01"
                  value={formData.materials_cost_total ?? ""}
                  onChange={(e) =>
                    handleInputChange(
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  type="number"
                  step="0.01"
                  value={formData.rental_cost_total ?? ""}
                  onChange={(e) =>
                    handleInputChange(
                      "rental_cost_total",
                      e.target.value ? parseFloat(e.target.value) : null,
            ...
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-1">
                <Input
                  type="number"
                  step="0.01"
                  value={formData.finalized_project_cost ?? ""}
                  onChange={(e) =>
                    handleInputChange(
                      "finalized_project_cost",
                      e.target.value ? parseFloat(e.target.value) : null,
                    )
                  }
                  disabled={!isEditMode}
                  className="border-0 shadow-none h-7 text-sm font-semibold dark:bg-dark-100 dark:text-white w-full"
                />
              </td>
            </tr>
          </tbody>
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
          ...
          <CardContent className="py-12">
            <div className="text-center text-neutral-500 dark:text-neutral-400">
              ...
              <p className="text-sm mt-2">
                Create your first report using the buttons above.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-4">
          {reports.map((report) => (
            <Card
              key={report.id}
              className="dark:bg-dark-150 hover:shadow-md transition-shadow"
            >
      ...
      {/* Create/Edit Dialog */}
      <Dialog
        open={isCreateDialogOpen || isViewDialogOpen}
        onOpenChange={(open) => {
          if (!open) {
            setIsCreateDialogOpen(false);
            setIsViewDialogOpen(false);
      ...
      >
        <DialogContent className="max-w-[90vw] w-[700px] max-h-[85vh] overflow-y-auto dark:bg-dark-150 bg-white p-4">
          ...
          <div className="mt-4">
            {reportType === "technician_progress"
              ? renderTechnicianProgressForm()
              : renderAdminCloseoutForm()}
          </div>
