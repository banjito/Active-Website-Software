      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
          ...
          <div className="job-info-grid grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-2 print:hidden">
            ...
            <div className="grid grid-cols-2 gap-x-2">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  readOnly={!isEditMode}
                  className={`form-input text-sm w-full temp-input-f ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="form-input text-sm w-full bg-neutral-100 dark:bg-dark-150 temp-input-c"
                />
              </div>
            </div>
            <div className="flex items-end">
              <div className="flex items-center mt-auto">
                ...
                <span className="tcf-value font-medium text-neutral-900 dark:text-white">
                  {tcf}
                </span>
              </div>
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                readOnly={!isEditMode}
                className={`form-input text-sm w-full ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
              />
            </div>
            <div>
          ...
          <div className="flex justify-end mb-4 gap-4">
            ...
            {isEditMode && (
              <button
                ...
                className="self-end h-9 px-3 py-1 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-none"
              >
                Add Row
              </button>
            )}
            ...
            <table className="w-full border-collapse text-sm electrical-tests-table">
              ...
              <thead>
                <tr className="bg-neutral-50 dark:bg-dark-150">
                  ...
                  <th
                    rowSpan={2}
                    className="px-1.5 py-1.5 text-center text-xs font-medium text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-600 w-12"
                  ></th>
                  <th
                    colSpan={10}
                    className="px-1.5 py-1.5 text-center text-xs font-medium text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-600"
                  ...
                  <th
                    rowSpan={2}
                    className="px-1.5 py-1.5 text-center text-xs font-medium text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-600 w-20"
                  >
                    Cont.
                  </th>
                  <th
              ...
              <tbody>
                {formData.testSets.map((set, index) => (
                  <React.Fragment key={set.id}>
                    ...
                    <tr className="hover:bg-neutral-50 dark:hover:bg-dark-200 align-middle">
                      ...
                      >
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="form-input text-xs py-1 px-1 text-center w-full h-6 leading-6 text-neutral-900 dark:text-white border-none bg-transparent"
                            readOnly={!isEditMode}
                          />
                        </div>
                      </td>
                      ...
                      <td className="px-1 py-0.5 text-center border border-neutral-300 dark:border-neutral-600 bg-neutral-50 dark:bg-dark-150">
                    ...
                    <tr className="bg-neutral-50 dark:bg-dark-150 hover:bg-neutral-100 dark:hover:bg-dark-300 align-middle">
                      ...
                      <td className="px-1 py-0.5 text-center border border-neutral-300 dark:border-neutral-600 bg-blue-50 dark:bg-blue-900 align-middle">
        ...
        >
          ...
          <textarea
            ...
            rows={10}
            className={`w-full form-textarea resize-vertical min-h-[250px] ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""} print:hidden`}
        ...
        >
          <button
            ...
            className="mt-2 px-3 py-1 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-none"
          >
            Add Row
          </button>
        </div>
