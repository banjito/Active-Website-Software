...
DROP TABLE IF EXISTS neta_ops.low_voltage_panelboard_small_breaker_reports;
...
-- Create indexes
CREATE INDEX IF NOT EXISTS lv_pb_sb_reports_job_id_idx
ON neta_ops.low_voltage_panelboard_small_breaker_reports(job_id);

CREATE INDEX IF NOT EXISTS lv_pb_sb_reports_user_id_idx
ON neta_ops.low_voltage_panelboard_small_breaker_reports(user_id);
...
CREATE TRIGGER set_updated_at
    BEFORE UPDATE ON neta_ops.low_voltage_panelboard_small_breaker_reports
    FOR EACH ROW
