...
const calculateCorrectedValue = (readingStr: string, tcf: number): string => {
  if (readingStr === "" || readingStr === null || readingStr === undefined)
    return "" as any;
...
const DryTypeTransformerReport: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    visualInspectionItems: [
      ...
      {
        id: "7.2.2.A.3",
        description: "Inspect impact recorder prior to unloading.",
        result: "",
        comments: "",
      },
      {
        id: "7.2.2.A.4",
        description: "Test dew point of tank gases. *Optional",
        result: "",
        comments: "",
      },
      {
      ...
      {
        id: "7.2.2.A.6",
        description: "Verify the presence of PCB content labeling.",
        result: "",
        comments: "",
      },
      {
        id: "7.2.2.A.7",
        description: "Verify removal of any shipping bracing after placement.",
        result: "",
        comments: "",
      },
      {
        id: "7.2.2.A.8",
        description: "Verify the bushings are clean.",
        result: "",
        comments: "",
      },
      {
      ...
      {
        id: "7.2.2.A.14",
        description: "Verify valves are in the correct operating position.",
        result: "",
        comments: "",
      },
      {
      ...
      {
        id: "7.2.2.A.17",
        description: "Test load tap-changer in accordance with Section 7.12.3.",
        result: "",
        comments: "",
      },
      {
        id: "7.2.2.A.18",
        description: "Verify presence of transformer surge arresters.",
        result: "",
        comments: "",
      },
      {
  ...
  useEffect(() => {
    ...
    if (formData.insulationResistance) {
      setFormData((prev) => {
        ...
        const piAcceptable = piValues.every((v) => !isNaN(v) && v > 1)
          ? "Yes"
          : "No";
        ...
        if (
          ...
          prev.insulationResistance.dielectricAbsorptionAcceptable !==
            daAcceptable || // Check Acceptable change
      ...
      if (data) {
        ...
        setFormData({
          ...
          customer: maskCustomerName(
            data.report_info?.customer || formData.customer,
          ),
          address: maskCustomerAddress(
            data.report_info?.address || formData.address,
          ),
          ...
          nameplateData:
            data.report_info?.nameplateData || formData.nameplateData,
          visualInspectionItems:
            data.visual_inspection?.items || formData.visualInspectionItems,
          insulationResistance:
            data.insulation_resistance?.tests || formData.insulationResistance,
  ...
  return (
    <ReportWrapper isPrintMode={isPrintMode} isEditing={isEditing}>
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead className="bg-gray-50 dark:bg-dark-150">
                    <tr>
                      <th
                        colSpan={6}
                        className="px-6 py-3 text-center text-sm font-medium text-gray-700 dark:text-white"
                      >
                    ...
                    {[
                      ...
                      <tr key={test.id}>
                        ...
                        <td className="px-6 py-4">
                          ...
                          <div className="hidden print:block text-center">
                            {formData.insulationResistance[test.id].testVoltage}
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="print:hidden">
                        ...
                        <td className="px-6 py-4">
                          <div className="print:hidden">
                            <input
                              type="text"
                              value={
                                formData.insulationResistance[test.id].corrected
                                  .halfMinute
                              }
                              readOnly
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">
                      Primary
                    </th>
                    <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider w-32">
                      Secondary
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr>
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-white">
                      Polarization Index : (Ratio of 10 Minute to 1 Minute
                      Result)
                    </td>
                    <td className="px-6 py-4 w-32">
                      <input
        ...
        {/* Comments */}
        <div
          className={`mb-6 print:break-inside-avoid section-comments ${!formData.comments?.trim() ? "print:hidden" : ""}`}
        >
          <div className="w-full h-1 bg-[#f26722] mb-4"></div>
