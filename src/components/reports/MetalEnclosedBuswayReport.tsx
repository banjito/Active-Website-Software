...
const MetalEnclosedBuswayReport: React.FC = () => {
    ...
    try {
      ...
      if (data) {
        ...
        const newFormData = {
          ...
          megCalDate: J('test_equipment')?.megohmmeter?.calDate || R('megCalDate') || '',
          ...
          lowResistanceCalDate: J('test_equipment')?.lowResistanceOhmmeter?.calDate || R('lowResistanceCalDate') || '',
  ...
  // Save report
  const handleSave = async (options?: { skipAlertAndNavigation?: boolean }): Promise<string | null> => {
    if (!jobId || !user?.id) {
    ...
    try {
      ...
      if (!reportId && result.data) {
        ...
        if (!options?.skipAlertAndNavigation) {
  ...
  if (notFound) {
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-white mb-4">We couldn’t load this Metal Enclosed Busway report. It may not exist, or you may not have permission.</p>
            ...
            <ul className="list-disc pl-5 text-sm text-blue-600 dark:text-blue-300">
              {suggestedReports.map(r => (
                <li key={r.id}>
                  ...
                  <span className="ml-2 text-gray-500 dark:text-white">{new Date(r.created_at).toLocaleString()}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-6 jobinfo-screen print:hidden job-info-onscreen">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white mb-1">Customer</label>
              <input
                type="text"
                name="customer"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white mb-1">Identifier</label>
              <input
                type="text"
                name="identifier"
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white mb-1">Substation</label>
              <input
                type="text"
                name="substation"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white mb-1">Equipment Location</label>
              <input
                type="text"
                name="equipment"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white mb-1">User</label>
              <input
                type="text"
                name="user"
                value={formData.user}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-1">
                <label className="text-xs font-medium text-gray-700 dark:text-white">Temp.</label>
                <input
                  type="number"
                  name="temperature"
                ...
                />
                <span className="text-xs text-gray-500 dark:text-white">°F</span>
              </div>
              ...
              <div className="flex items-center space-x-1">
                ...
                />
                <span className="text-xs text-gray-500 dark:text-white">°C</span>
              </div>

              <div className="flex items-center space-x-1">
                <label className="text-xs font-medium text-gray-700 dark:text-white">TCF</label>
                <input
                  type="text"
        ...
        <div className="hidden print:block">
          <JobInfoPrintTable
            data={{
              ...
              temperature: {
                fahrenheit: formData.temperature ? parseFloat(formData.temperature) : undefined,
                celsius: formData.temperature ? parseFloat(convertFtoC(formData.temperature)) : undefined,
                tcf: formData.tcf,
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 nameplate-screen print:hidden nameplate-onscreen">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Fed From</label>
              <input
                type="text"
                name="fedFrom"
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Conductor Material</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Rated Voltage (kV)</label>
              <input
                type="text"
                name="ratedVoltage"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Operating Voltage (kV)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Ampacity (A)</label>
              <input
                type="text"
                name="ampacity"
            ...
            <tbody>
              ...
              <tr>
                <td className="p-2 border border-gray-300 print:border-black">
                  ...
                  <div className="mt-1">{formData.conductorMaterial || ''}</div>
                </td>
                <td className="p-2 border border-gray-300 print:border-black">
                ...
                <td className="p-2 border border-gray-300 print:border-black">
                  ...
                  <div className="mt-1">{formData.operatingVoltage || ''}</div>
                </td>
                <td className="p-2 border border-gray-300 print:border-black">
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 visual-mechanical-table table-fixed">
            ...
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              {Object.entries(formData.netaResults).map(([id, result]) => (
                <tr key={id}>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-white">{id}</td>
                  ...
                  <td className="px-3 py-2 whitespace-nowrap">
                    ...
                    <div className="hidden print:block text-center">{result || ''}</div>
                  </td>
                </tr>
              ))}
            </tbody>
      ...
      <section className="mb-6">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead>
              <tr>
                <th colSpan={5} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Bus Resistance</th>
              </tr>
              <tr>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase">P1</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase">P2</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase">P3</th>
      ...
      <section className="mb-6">
        ...
        <div className="flex justify-end mb-2 space-x-4">
          <div className="w-48 border border-gray-300 dark:border-gray-700 p-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-white">Test Voltage:</label>
            <select
              name="testVoltage1"
          ...
          <div className="w-48 border border-gray-300 dark:border-gray-700 p-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-white">Unit:</label>
            <select
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 ir-table">
            ...
            <thead>
              <tr>
                <th colSpan={10} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Insulation Resistance</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider ir-units">Units</th>
              </tr>
              <tr>
                ...
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase">N-G</th>
      ...
      <section className="mb-6">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 ir-table">
            ...
            <thead>
              <tr>
                <th colSpan={10} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Temperature Corrected Values</th>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider ir-units">Units</th>
              </tr>
              <tr>
                <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase">A-B</th>
            ...
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                {['A-B', 'B-C', 'C-A', 'A-N', 'B-N', 'C-N', 'A-G', 'B-G', 'C-G', 'N-G'].map((key) => {
                  ...
                  const measured = (formData.insulationResistance[dataKey] || '').trim();
                  const rawCorrected = formData.correctedInsulationResistance[dataKey] || '';
          ...
          <div className="grid grid-cols-4 gap-4">
            <div>
              ...
              <EquipmentAutocomplete
                ...
                onChange={(value) => handleInputChange({ target: { name: 'megohmmeter', value } } as any)}
                onSelect={(equipment) => {
                  handleInputChange({ target: { name: 'megohmmeter', value: equipment.equipment_name } } as any);
                  handleInputChange({ target: { name: 'megohmSerial', value: equipment.serial_number || '' } } as any);
                  handleInputChange({ target: { name: 'megAmpId', value: equipment.amp_id || '' } } as any);
                  handleInputChange({ target: { name: 'megCalDate', value: formatLocalDateShort(equipment.calibration_date) } } as any);
                }}
                readOnly={!isEditing}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Serial Number</label>
              <input type="text" name="megohmSerial" value={formData.megohmSerial} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">AMP ID</label>
              <input type="text" name="megAmpId" value={formData.megAmpId} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Cal Date</label>
              <input type="text" name="megCalDate" value={formData.megCalDate} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
          </div>
          <div className="grid grid-cols-4 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Low Resistance Ohmmeter</label>
              <EquipmentAutocomplete
                value={formData.lowResistanceOhmmeter}
                onChange={(value) => handleInputChange({ target: { name: 'lowResistanceOhmmeter', value } } as any)}
                onSelect={(equipment) => {
                  handleInputChange({ target: { name: 'lowResistanceOhmmeter', value: equipment.equipment_name } } as any);
                  handleInputChange({ target: { name: 'lowResistanceSerial', value: equipment.serial_number || '' } } as any);
                  handleInputChange({ target: { name: 'lowResistanceAmpId', value: equipment.amp_id || '' } } as any);
                  handleInputChange({ target: { name: 'lowResistanceCalDate', value: formatLocalDateShort(equipment.calibration_date) } } as any);
                }}
                readOnly={!isEditing}
                className="mt-1 w-full"
              />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Serial Number</label>
              <input type="text" name="lowResistanceSerial" value={formData.lowResistanceSerial} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">AMP ID</label>
              <input type="text" name="lowResistanceAmpId" value={formData.lowResistanceAmpId} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Cal Date</label>
              <input type="text" name="lowResistanceCalDate" value={formData.lowResistanceCalDate} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                <td className="p-2 align-top border border-gray-300 print:border-black">
                  ...
                  <div className="mt-0">{formData.lowResistanceOhmmeter || ''}</div>
                </td>
                <td className="p-2 align-top border border-gray-300 print:border-black">
                  <div className="font-semibold">Serial Number:</div>
                  <div className="mt-0">{formData.lowResistanceSerial || ''}</div>
                </td>
                <td className="p-2 align-top border border-gray-300 print:border-black">
                  <div className="font-semibold">AMP ID:</div>
                  <div className="mt-0">{formData.lowResistanceAmpId || ''}</div>
                </td>
                <td className="p-2 align-top border border-gray-300 print:border-black">
                  <div className="font-semibold">Cal Date:</div>
                  <div className="mt-0">{formData.lowResistanceCalDate || ''}</div>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              <tr>
                <td className="p-2 align-top border border-gray-300 print:border-black">
                  ...
                  <div className="mt-1">{formData.comments || 'No comments provided'}</div>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                const savedReportId = await handleSave({ skipAlertAndNavigation: true });
