        ...
        <div className="grid grid-cols-1 gap-6 print:hidden test-eqpt-onscreen">
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="text" name="megohmmeter" value={formData.megohmmeter} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Serial Number</label>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="text" name="lowResistanceOhmmeter" value={formData.lowResistanceOhmmeter} onChange={handleInputChange} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Serial Number</label>
