...
// .form-input, .form-select, .form-textarea {
//   @apply mt-1 block w-full p-2 border border-neutral-300 dark:border-neutral-600 rounded-md shadow-sm
...
//   @apply bg-neutral-100 dark:bg-dark-150 text-neutral-500 dark:text-white cursor-not-allowed;
// }
// .table-header { @apply px-6 py-3 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider bg-neutral-50 dark:bg-dark-150; }
// .table-cell { @apply px-6 py-4 whitespace-nowrap text-sm text-neutral-900 dark:text-white; }
