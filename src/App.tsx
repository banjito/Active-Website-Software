          ...
          <DemoModeProvider>
            <DivisionProvider>
                ...
                <Routes>
                  ...
                  <Route path="/jobs/:id/12-current-transformer-test-ats-report/:reportId?" element={<RequireAuth><Layout><Suspense fallback={<div className="flex min-h-[60vh] items-center justify-center"><LoadingSpinner size="md" /></div>}><New12CurrentTransformerTestATSReport /></Suspense></Layout></RequireAuth>} />
                  ...
                  <Route path="/jobs/:id/liquid-xfmr-visual-mts-report/:reportId?" element={<RequireAuth><Layout><Suspense fallback={<div className="flex min-h-[60vh] items-center justify-center"><LoadingSpinner size="md" /></div>}><LiquidXfmrVisualMTSReport /></Suspense></Layout></RequireAuth>} />

                  {/* Added route for Two Small Dry Type Transformer ATS Report */}
                  <Route path="/jobs/:id/two-small-dry-typer-xfmr-ats-report/:reportId?" element={<RequireAuth><Layout><Suspense fallback={<div className="flex min-h-[60vh] items-center justify-center"><LoadingSpinner size="md" /></div>}><TwoSmallDryTyperXfmrATSReport /></Suspense></Layout></RequireAuth>} />

                  {/* Added route for Two Small Dry Type Transformer MTS Report */}
                  <Route path="/jobs/:id/two-small-dry-typer-xfmr-mts-report/:reportId?" element={<RequireAuth><Layout><Suspense fallback={<div className="flex min-h-[60vh] items-center justify-center"><LoadingSpinner size="md" /></div>}><TwoSmallDryTyperXfmrMTSReport /></Suspense></Layout></RequireAuth>} />
                  ...
                  <Route path="/jobs/:id/12-current-transformer-test-mts-report/:reportId?" element={<RequireAuth><Layout><Suspense fallback={<div className="flex min-h-[60vh] items-center justify-center"><LoadingSpinner size="md" /></div>}><New12CurrentTransformerTestMTSReport /></Suspense></Layout></RequireAuth>} />
