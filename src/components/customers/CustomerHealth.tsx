        ...
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="h-64 flex items-end justify-between px-2">
            <div className="w-1/12 flex flex-col items-center">
              ...
              <div className="text-xs text-gray-500 dark:text-white mt-2">Jan</div>
            </div>
            <div className="w-1/12 flex flex-col items-center">
              <div className="h-24 w-4 bg-[#f26722] rounded-t-sm"></div>
              <div className="text-xs text-gray-500 dark:text-white mt-2">Feb</div>
            </div>
            <div className="w-1/12 flex flex-col items-center">
              <div className="h-40 w-4 bg-[#f26722] rounded-t-sm"></div>
              <div className="text-xs text-gray-500 dark:text-white mt-2">Mar</div>
            </div>
            <div className="w-1/12 flex flex-col items-center">
              <div className="h-36 w-4 bg-[#f26722] rounded-t-sm"></div>
              <div className="text-xs text-gray-500 dark:text-white mt-2">Apr</div>
            </div>
            <div className="w-1/12 flex flex-col items-center">
              <div className="h-44 w-4 bg-[#f26722] rounded-t-sm"></div>
              <div className="text-xs text-gray-500 dark:text-white mt-2">May</div>
            </div>
            <div className="w-1/12 flex flex-col items-center">
              <div className="h-48 w-4 bg-[#f26722] rounded-t-sm"></div>
              <div className="text-xs text-gray-500 dark:text-white mt-2">Jun</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
          <div className="mb-6">
            <div className="flex justify-between mb-2">
              ...
              <div className="text-sm text-gray-500 dark:text-white">Score: 9/10</div>
            </div>
            <div className="text-sm text-gray-500 dark:text-white mb-2">Completed: Mar 15, 2023</div>
          ...
          <div>
            <div className="flex justify-between mb-2">
              ...
              <div className="text-sm text-gray-500 dark:text-white">Score: 7/10</div>
            </div>
            <div className="text-sm text-gray-500 dark:text-white mb-2">Completed: Feb 10, 2023</div>
            <div className="text-sm mb-1">Satisfaction</div>
            <div className="h-2 w-full bg-gray-200 dark:bg-gray-600 rounded-full">
          ...
          <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
            ...
            <div className="mt-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600 dark:text-white">
        ...
        <div>
          ...
          <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-4">
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="bg-gray-50 dark:bg-dark-150 p-3 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-white">Support Tickets</div>
                ...
                <div className="text-xs text-gray-500 dark:text-white mt-1">Last 30 days</div>
              </div>
              
              <div className="bg-gray-50 dark:bg-dark-150 p-3 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-white">Active Users</div>
                <div className="flex items-center">
              ...
              <div className="bg-gray-50 dark:bg-dark-150 p-3 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-white">Feature Usage</div>
                <div className="flex items-center">
                ...
                <div className="text-xs text-gray-500 dark:text-white mt-1">Key features</div>
              </div>
              
              <div className="bg-gray-50 dark:bg-dark-150 p-3 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-white">Login Frequency</div>
                <div className="flex items-center">
                ...
                <div className="text-xs text-gray-500 dark:text-white mt-1">Per week avg.</div>
              </div>
            </div>
          </div>
        </div>
