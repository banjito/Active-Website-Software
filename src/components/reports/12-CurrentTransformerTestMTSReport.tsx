    ...
    <ReportWrapper isPrintMode={isPrintMode}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 print:hidden job-info-onscreen">
          <div className="space-y-4">
            <div>
              ...
              <input type="text" value={formData.customerName} readOnly className="form-input bg-gray-50 dark:bg-dark-150" />
            </div>
            <div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4 print:hidden te-onscreen">
          <div className="grid grid-cols-3 gap-4">
            <div><label htmlFor="testEquipmentUsed.megohmmeterName" className="block text-sm font-medium text-gray-700 dark:text-white">Megohmmeter</label><input id="testEquipmentUsed.megohmmeterName" type="text" value={formData.testEquipmentUsed.megohmmeterName} onChange={(e) => handleChange('testEquipmentUsed.megohmmeterName', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div><label htmlFor="testEquipmentUsed.ctRatioTestSetName" className="block text-sm font-medium text-gray-700 dark:text-white">CT Ratio Test Set</label><input id="testEquipmentUsed.ctRatioTestSetName" type="text" value={formData.testEquipmentUsed.ctRatioTestSetName} onChange={(e) => handleChange('testEquipmentUsed.ctRatioTestSetName', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
