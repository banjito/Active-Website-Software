...
// Every breaker recorded on this sheet is maintained to the same NETA MTS
// section. Breaker type below is nameplate data, not a section switch.
const NETA_MTS_SECTION = "7.6.1.2";

// Visual and mechanical inspection items, NETA MTS 7.6.1.2.A
const getVisualInspectionItems = (): Array<{
  id: string;
  description: string;
  result: string;
}> => [
...
// The four protective functions verified by secondary injection, in the order
// they appear on the test sheet.
const secondaryInjectionFunctions = [
  "Long Time",
  "Short Time",
  "Instantaneous",
  "Ground Fault",
...
const createSecondaryInjection = () => ({
  testedSettings: {
  ...
  tests: secondaryInjectionFunctions.map((name) => ({
    function: name,
    ratedAmperes: "",
    testAmperes: "",
    tripTime: "",
...
const createPrimaryVerification = () => ({
  testCurrent: { p1: "", p2: "", p3: "" },
  measuredCurrent: { p1: "", p2: "", p3: "" },
});
...
const tripTimeUnitsOptions = ["sec.", "ms", "cycles", "min."];
const secondaryInjectionResultOptions = ["", "PASS", "FAIL", "N/A"];
...
interface FormData {
  ...
  // Electrical Tests - Secondary Injection
  secondaryInjection: {
    testedSettings: {
      longTime: { setting: string; delay: string; i2t: string };
      shortTime: { setting: string; delay: string; i2t: string };
  ...
  // Electrical Tests - Primary Verification
  primaryVerification: {
    testCurrent: { p1: string; p2: string; p3: string };
    measuredCurrent: { p1: string; p2: string; p3: string };
  };
...
const LVCircuitBreakerMTS25Report: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    secondaryInjection: createSecondaryInjection(),
    primaryVerification: createPrimaryVerification(),
    testEquipment: {
      digitalLowResistanceOhmmeter: {
        name: "",
        serialNumber: "",
      ...
      if (data && data.report_data) {
        ...
        setFormData((prev) => {
          ...
          return {
            ...
            secondaryInjection: reportData.secondaryInjection
              ? {
                  ...prev.secondaryInjection,
                  ...reportData.secondaryInjection,
                  testedSettings: {
                    ...prev.secondaryInjection.testedSettings,
                    ...(reportData.secondaryInjection.testedSettings || {}),
                  },
                  tests:
                    reportData.secondaryInjection.tests ||
                    prev.secondaryInjection.tests,
                }
              : prev.secondaryInjection,
            primaryVerification:
              reportData.primaryVerification || prev.primaryVerification,
            testEquipment: reportData.testEquipment
              ? {
                  ...
                  secondaryInjectionTestSet: {
                    ...
                    ...reportData.testEquipment.secondaryInjectionTestSet,
                    calibrationDate:
                      reportData.testEquipment.secondaryInjectionTestSet
                        ?.calibrationDate || "",
                  },
  ...
  // Autofill the secondary injection tested settings from the As Left device
  // settings so the two tables cannot drift apart.
  React.useEffect(() => {
    const asLeft = formData.deviceSettings.asLeft;
    const tested = formData.secondaryInjection.testedSettings;
      ...
      */}
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
        ...
        <div className="space-y-6">
          ...
          {/* --- Electrical Tests - Secondary Injection Section --- */}
          {!formData.irDlroOnly && (
            <div className="mb-6 print:break-inside-avoid">
              ...
              {/* Tested Settings — mirrored from Settings As Left */}
              <div className="mb-6 max-w-2xl mx-auto">
                <h3 className="text-lg font-medium mb-2 text-center dark:text-white print:text-black">
                  Tested Settings
                </h3>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600 print:border-black">
                    <thead className="bg-neutral-50 dark:bg-dark-150">
                      <tr>
                        <th className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-left text-sm font-medium text-neutral-900 dark:text-white">
                          Function
                        </th>
                        <th className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-center text-sm font-medium text-neutral-900 dark:text-white">
                          Setting
                        </th>
                        <th className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-center text-sm font-medium text-neutral-900 dark:text-white">
                          Delay
                    ...
                    <tbody className="bg-white dark:bg-dark-150">
                      {(
                        ...
                        <tr key={key}>
                          <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-sm text-neutral-900 dark:text-white">
                            {label}
                          </td>
                          <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                            <input
                              type="text"
                              value={
                                formData.secondaryInjection.testedSettings[key]
                                  ?.setting || ""
                              }
                              onChange={(e) =>
                                handleChange(
                                  `secondaryInjection.testedSettings.${key}.setting`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                            <input
                              ...
                              onChange={(e) =>
                                handleChange(
                                  `secondaryInjection.testedSettings.${key}.delay`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                            <select
                              ...
                              onChange={(e) =>
                                handleChange(
                                  `secondaryInjection.testedSettings.${key}.i2t`,
                                  e.target.value,
                                )
                              }
                              disabled={!isEditing}
                              className={`w-full p-1 border border-neutral-300 dark:border-neutral-600 rounded text-center dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100" : "bg-white"}`}
                            >
                              {i2tOptions.map((opt) => (
                                <option key={opt} value={opt}>
                                  {opt || "-"}
              ...
              {/* Secondary injection trip results */}
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600 print:border-black">
                  <thead className="bg-neutral-50 dark:bg-dark-150">
                    <tr>
                      <th
                        rowSpan={2}
                        className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-left text-sm font-medium text-neutral-900 dark:text-white align-bottom"
                      >
                        Function
                      </th>
                      <th
                        rowSpan={2}
                        className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-center text-sm font-medium text-neutral-900 dark:text-white align-bottom"
                      >
                        Rated Amperes
                      </th>
                      <th
                      ...
                      <th
                        colSpan={2}
                        className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-center text-sm font-medium text-neutral-900 dark:text-white"
                      >
                        Results
                      </th>
                      <th
                  ...
                  <tbody className="bg-white dark:bg-dark-150">
                    {formData.secondaryInjection.tests.map((test, index) => (
                      <tr key={test.function}>
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-sm text-neutral-900 dark:text-white">
                          {test.function}
                        </td>
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                          <input
                            type="text"
                            value={test.ratedAmperes}
                            onChange={(e) =>
                              handleChange(
                                `secondaryInjection.tests.${index}.ratedAmperes`,
                                e.target.value,
                              )
                            }
                            readOnly={!isEditing}
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                          <input
                            type="text"
                            value={test.testAmperes}
                            onChange={(e) =>
                              handleChange(
                                `secondaryInjection.tests.${index}.testAmperes`,
                                e.target.value,
                              )
                            }
                            readOnly={!isEditing}
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleChange(
                                `secondaryInjection.tests.${index}.tripTime`,
                                e.target.value,
                              )
                            }
                            readOnly={!isEditing}
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                          <select
                            ...
                            onChange={(e) =>
                              handleChange(
                                `secondaryInjection.tests.${index}.units`,
                                e.target.value,
                              )
                            }
                            disabled={!isEditing}
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1">
                          <select
                            ...
                            onChange={(e) =>
                              handleChange(
                                `secondaryInjection.tests.${index}.result`,
                                e.target.value,
                              )
                            }
                            disabled={!isEditing}
                            className={`w-full p-1 border border-neutral-300 dark:border-neutral-600 rounded text-center dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100" : "bg-white"} ${test.result === "PASS" ? "text-green-600 result-pass" : test.result === "FAIL" ? "text-red-600 result-fail" : ""}`}
                          >
                            {secondaryInjectionResultOptions.map((opt) => (
                              <option key={opt} value={opt}>
                                {opt || "-"}
                              </option>
                            ))}
          ...
          {/* --- Electrical Tests - Primary Verification Section --- */}
          {!formData.irDlroOnly && (
            <div className="mb-6 print:break-inside-avoid">
              <div className="w-full h-1 bg-brand mb-4"></div>
              <h2 className="text-xl font-semibold mb-4 text-neutral-900 dark:text-white border-b dark:border-neutral-700 pb-2 print:text-black print:border-black print:font-bold">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600 print:border-black">
                  ...
                  <tbody className="bg-white dark:bg-dark-150">
                    {(
                      [
                        ["testCurrent", "Test Current (A)"],
                        ["measuredCurrent", "Measured Current (A)"],
                      ] as const
                    ).map(([rowKey, label]) => (
                      <tr key={rowKey}>
                        <td className="border border-neutral-300 dark:border-neutral-600 print:border-black px-4 py-2 text-sm text-neutral-900 dark:text-white">
                        ...
                        {(["p1", "p2", "p3"] as const).map((pole) => (
                          <td
                            key={pole}
                            className="border border-neutral-300 dark:border-neutral-600 print:border-black px-2 py-1"
                          >
                            <input
                              type="text"
                              value={
                                formData.primaryVerification[rowKey][pole] || ""
                              }
                              onChange={(e) =>
                                handleChange(
                                  `primaryVerification.${rowKey}.${pole}`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                  ...
                  {(() => {
                    const equipmentRows: Array<{
                    ...
                    }> = [
                      {
                        ...
                        equipmentLabel: "Low-Resistance Ohmmeter",
                      ...
                      {
                        formKey: "secondaryInjectionTestSet",
                        equipmentLabel: "Secondary Injection Test Set",
                        data: formData.testEquipment.secondaryInjectionTestSet,
                      },
                    ];
              ...
              <div className="bg-neutral-50 dark:bg-dark-200 p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                <div className="text-xs text-neutral-600 dark:text-neutral-400 grid grid-cols-2 gap-x-4 gap-y-1">
                  <div className="space-y-1">
                    <p>
                      <strong>Long Time</strong> = Overload protection element
                    </p>
                    <p>
                      <strong>Short Time</strong> = Short circuit protection
                      element
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p>
                      <strong>Instantaneous</strong> = Unintentional-delay
                      element
                    </p>
                    <p>
                      <strong>Ground Fault</strong> = Ground fault protection
                      element
                    </p>
                  </div>
                </div>
...
export default LVCircuitBreakerMTS25Report;
