...
export function TestingProcedures({ division }: TestingProceduresProps) {
        ...
        const mockProcedures: Procedure[] = [
          {
            ...
            status: "approved",
            description:
              "Standard operating procedure for testing power transformers",
            category: "electrical",
            created_by: "123",
            ...
            document_url:
              "https://example.com/procedures/transformer_testing_v2.1.pdf",
          ...
          },
          {
            ...
            status: "under-review",
            description:
              "Procedure for calibrating and testing low voltage circuit breakers",
            category: "calibration",
            created_by: "123",
            creator_name: "John Doe",
            document_url:
              "https://example.com/procedures/breaker_calibration_v1.3.pdf",
          ...
          },
          {
            ...
            status: "draft",
            description:
              "Updated procedure for transformer oil sample collection and analysis",
            category: "chemical",
            created_by: "789",
            creator_name: "Alice Johnson",
            document_url:
              "https://example.com/procedures/oil_analysis_draft_v3.pdf",
  ...
  const filteredProcedures = procedures.filter((procedure) => {
    ...
    const matchesStatus =
      statusFilter === null || procedure.status === statusFilter;
    const matchesCategory =
      categoryFilter === null || procedure.category === categoryFilter;
    ...
    if (editingProcedureId) {
      ...
      const updatedProcedures = procedures.map((proc) =>
        proc.id === editingProcedureId
          ? { ...proc, ...form, updated_at: new Date().toISOString() }
          : proc,
      );
