    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center mb-4">
        <Link 
          ...
          className="mr-4 text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white"
        >
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-4 p-4 border rounded-md bg-gray-50 dark:bg-dark-150">
      ...
      */}
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-4 p-4 border rounded-md bg-gray-50 dark:bg-dark-150">
          <Button variant="outline" className="flex items-center bg-white dark:bg-dark-150" onClick={() => setRefreshTrigger(prev => prev + 1)}>
      ...
      {/* Jobs List */}
      <Card className="bg-white dark:bg-dark-150 border border-gray-200 dark:border-gray-700 rounded-md shadow-sm">
            ...
            {jobs.map(job => (
              <div key={job.id} className="p-4 hover:bg-gray-50 dark:hover:bg-dark-200 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  <div>
                    <p className="text-xs text-gray-500 dark:text-white">Start Date</p>
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-white">Due Date</p>
                    <p className="text-sm flex items-center">
                      <Clock className="h-3 w-3 mr-1 text-gray-400" />
