...
const MediumVoltageMotorStarterMTSReport: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!reportId) {
        ...
        freshInitialData.customerName = maskCustomerName(formData.customerName);
        freshInitialData.customerAddress = maskCustomerAddress(formData.customerAddress);
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden job-info-onscreen">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input type="text" value={maskCustomerName(formData.customerName)} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-[calc(100%-8rem)]" />
                </div>
                <div>
                  <label className="form-label inline-block w-32">Address:</label>
                  <input type="text" value={maskCustomerAddress(formData.customerAddress)} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-[calc(100%-8rem)]" />
                </div>
                 <div>
                  <label htmlFor="user" className="form-label inline-block w-32">User:</label>
                  <input id="user" name="user" type="text" value={formData.userName} onChange={(e) => handleChange('userName', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
                <div>
                  <label htmlFor="date" className="form-label inline-block w-32">Date:</label>
                  <input id="date" name="date" type="date" value={formData.date} onChange={(e) => handleChange('date', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
                <div>
                  <label htmlFor="identifier" className="form-label inline-block w-32">Identifier:</label>
                  <input id="identifier" name="identifier" type="text" value={formData.identifier} onChange={(e) => handleChange('identifier', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
              </div>
              {/* Right Column */}
              <div className="space-y-3">
                <div>
                  ...
                  <input type="text" value={formData.jobNumber} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-[calc(100%-8rem)]" />
                </div>
                <div>
                  <label htmlFor="technicians" className="form-label inline-block w-32">Technicians:</label>
                  <input id="technicians" name="technicians" type="text" value={formData.technicians} onChange={(e) => handleChange('technicians', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
                <div className="flex items-center">
                  <label htmlFor="temperature.fahrenheit" className="form-label inline-block w-16">Temp:</label>
                  <input id="temperature.fahrenheit" name="temperature.fahrenheit" type="number" value={formData.temperature.fahrenheit} onChange={(e) => handleFahrenheitChange(Number(e.target.value))} readOnly={!isEditing} className={`form-input w-20 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                  <span className="mx-1">°F</span>
                  <input id="temperature.celsius" name="temperature.celsius" type="number" value={formData.temperature.celsius} onChange={(e) => handleCelsiusChange(Number(e.target.value))} readOnly={!isEditing} className={`form-input w-20 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                  <span className="mx-1">°C</span>
                  <label htmlFor="temperature.tcf" className="form-label inline-block w-10 ml-2">TCF:</label>
                  <input id="temperature.tcf" name="temperature.tcf" type="number" value={formData.temperature.tcf} readOnly className="form-input w-20 bg-gray-100 dark:bg-dark-150" />
                </div>
                <div>
                  <label htmlFor="temperature.humidity" className="form-label inline-block w-32">Humidity:</label>
                  <input id="temperature.humidity" name="temperature.humidity" type="number" value={formData.temperature.humidity || ''} onChange={(e) => handleChange('temperature.humidity', e.target.value === '' ? null : Number(e.target.value))} readOnly={!isEditing} className={`form-input w-20 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                  <span className="ml-1">%</span>
                </div>
                <div>
                  <label htmlFor="substation" className="form-label inline-block w-32">Substation:</label>
                  <input id="substation" name="substation" type="text" value={formData.substation} onChange={(e) => handleChange('substation', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
                <div>
                  <label htmlFor="eqptLocation" className="form-label inline-block w-32">Eqpt. Location:</label>
                  <input id="eqptLocation" name="eqptLocation" type="text" value={formData.eqptLocation} onChange={(e) => handleChange('eqptLocation', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-8rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                </div>
              </div>
            </div>
            <JobInfoPrintTable
              data={{
                ...
                address: maskCustomerAddress(formData.customerAddress),
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden nameplate-onscreen">
              {/* Left Column */}
              <div className="space-y-3">
                <div><label htmlFor="nameplateData.manufacturer" className="form-label inline-block w-40">Manufacturer:</label><input id="nameplateData.manufacturer" type="text" value={formData.nameplateData.manufacturer} onChange={(e) => handleChange('nameplateData.manufacturer', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.catalogNumber" className="form-label inline-block w-40">Catalog Number:</label><input id="nameplateData.catalogNumber" type="text" value={formData.nameplateData.catalogNumber} onChange={(e) => handleChange('nameplateData.catalogNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.serialNumber" className="form-label inline-block w-40">Serial Number:</label><input id="nameplateData.serialNumber" type="text" value={formData.nameplateData.serialNumber} onChange={(e) => handleChange('nameplateData.serialNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.type" className="form-label inline-block w-40">Type:</label><input id="nameplateData.type" type="text" value={formData.nameplateData.type} onChange={(e) => handleChange('nameplateData.type', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.manufacturingDate" className="form-label inline-block w-40">Manufacturing Date:</label><input id="nameplateData.manufacturingDate" type="text" value={formData.nameplateData.manufacturingDate} onChange={(e) => handleChange('nameplateData.manufacturingDate', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              </div>
              {/* Right Column */}
              <div className="space-y-3">
                <div><label htmlFor="nameplateData.icRating" className="form-label inline-block w-40">I.C. Rating (kA):</label><input id="nameplateData.icRating" type="text" value={formData.nameplateData.icRating} onChange={(e) => handleChange('nameplateData.icRating', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.ratedVoltageKV" className="form-label inline-block w-40">Rated Voltage (kV):</label><input id="nameplateData.ratedVoltageKV" type="text" value={formData.nameplateData.ratedVoltageKV} onChange={(e) => handleChange('nameplateData.ratedVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.operatingVoltageKV" className="form-label inline-block w-40">Operating Voltage (kV):</label><input id="nameplateData.operatingVoltageKV" type="text" value={formData.nameplateData.operatingVoltageKV} onChange={(e) => handleChange('nameplateData.operatingVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.ampacity" className="form-label inline-block w-40">Ampacity:</label><input id="nameplateData.ampacity" type="text" value={formData.nameplateData.ampacity} onChange={(e) => handleChange('nameplateData.ampacity', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="nameplateData.impulseRatingBIL" className="form-label inline-block w-40">Impulse Rating (BIL):</label><input id="nameplateData.impulseRatingBIL" type="text" value={formData.nameplateData.impulseRatingBIL} onChange={(e) => handleChange('nameplateData.impulseRatingBIL', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              </div>
            </div>
            ...
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <tbody>
                  <tr>
                    <td>{formData.nameplateData.manufacturer}</td>
                    <td>{formData.nameplateData.catalogNumber}</td>
                    <td>{formData.nameplateData.serialNumber}</td>
                    <td>{formData.nameplateData.type}</td>
                    <td>{formData.nameplateData.manufacturingDate}</td>
                  </tr>
                </tbody>
                <thead>
                  <tr>
                    ...
                    <th>Operating Voltage (kV)</th>
                    <th>Ampacity</th>
                    <th>Impulse Rating (BIL)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>{formData.nameplateData.icRating}</td>
                    <td>{formData.nameplateData.ratedVoltageKV}</td>
                    <td>{formData.nameplateData.operatingVoltageKV}</td>
                    <td>{formData.nameplateData.ampacity}</td>
                    <td>{formData.nameplateData.impulseRatingBIL}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <thead>
                  <tr>
                    <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700">NETA</th>
                    <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700">Description</th>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700">Result</th>
                  </tr>
                </thead>
                    ...
                    <tr key={item.netaSection}>
                      ...
                      <td className="px-3 py-2 border border-gray-200 dark:border-gray-700 align-top">
                        <select
                          ...
                          disabled={!isEditing}
                          className={`form-select w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
                        >
            ...
            <div className="mt-4">
              ...
              <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">E-Gap</th> {/* Adjusted width */}
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">Unit Measurement</th>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">Tolerance</th>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">A-Phase</th>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">B-Phase</th>
                    <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 w-1/6">C-Phase</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">
                      <input type="text" value={formData.visualMechanicalInspection.eGap.unitMeasurement} onChange={(e) => handleChange('visualMechanicalInspection.eGap.unitMeasurement', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                    </td>
                    <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">
                      <input type="text" value={formData.visualMechanicalInspection.eGap.tolerance} onChange={(e) => handleChange('visualMechanicalInspection.eGap.tolerance', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                    </td>
                    <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">
                      <input type="text" value={formData.visualMechanicalInspection.eGap.aPhase} onChange={(e) => handleChange('visualMechanicalInspection.eGap.aPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                    </td>
                    <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">
                      <input type="text" value={formData.visualMechanicalInspection.eGap.bPhase} onChange={(e) => handleChange('visualMechanicalInspection.eGap.bPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                    </td>
                    <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">
                      <input type="text" value={formData.visualMechanicalInspection.eGap.cPhase} onChange={(e) => handleChange('visualMechanicalInspection.eGap.cPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden fuse-onscreen">
              <div><label htmlFor="fuseData.manufacturer" className="form-label block">Manufacturer:</label><input id="fuseData.manufacturer" type="text" value={formData.fuseData.manufacturer} onChange={(e) => handleChange('fuseData.manufacturer', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              <div><label htmlFor="fuseData.catalogNumber" className="form-label block">Catalog Number:</label><input id="fuseData.catalogNumber" type="text" value={formData.fuseData.catalogNumber} onChange={(e) => handleChange('fuseData.catalogNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              <div><label htmlFor="fuseData.class" className="form-label block">Class:</label><input id="fuseData.class" type="text" value={formData.fuseData.class} onChange={(e) => handleChange('fuseData.class', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              <div><label htmlFor="fuseData.ratedVoltageKV" className="form-label block">Rated Voltage (kV):</label><input id="fuseData.ratedVoltageKV" type="text" value={formData.fuseData.ratedVoltageKV} onChange={(e) => handleChange('fuseData.ratedVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              <div><label htmlFor="fuseData.ampacity" className="form-label block">Ampacity (A):</label><input id="fuseData.ampacity" type="text" value={formData.fuseData.ampacity} onChange={(e) => handleChange('fuseData.ampacity', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              <div><label htmlFor="fuseData.icRatingKA" className="form-label block">I.C. Rating (kA):</label><input id="fuseData.icRatingKA" type="text" value={formData.fuseData.icRatingKA} onChange={(e) => handleChange('fuseData.icRatingKA', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            </div>
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{formData.fuseData.ratedVoltageKV}</td>
                    <td>{formData.fuseData.ampacity}</td>
                    ...
                    {formData.electricalTests.contactResistanceAsFound.map((row, index) => (
                      <tr key={`cr-found-${index}`}>
                        ...
                        {(['p1', 'p2', 'p3'] as const).map(phase => (
                           <td key={phase} className="p-1 border dark:border-gray-600"><input type="text" value={row[phase]} onChange={(e) => handleListChange('electricalTests.contactResistanceAsFound', index, phase, e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                        ))}
                        <td className="p-1 border dark:border-gray-600">
                          <select value={row.units} onChange={(e) => handleListChange('electricalTests.contactResistanceAsFound', index, 'units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                  ...
                  <tbody>
                    {formData.electricalTests.contactResistanceAsLeft.map((row, index) => (
                      <tr key={`cr-left-${index}`}>
                        <td className="p-2 border dark:border-gray-600 font-medium">{row.test}</td>
                         {(['p1', 'p2', 'p3'] as const).map(phase => (
                           <td key={phase} className="p-1 border dark:border-gray-600"><input type="text" value={row[phase]} onChange={(e) => handleListChange('electricalTests.contactResistanceAsLeft', index, phase, e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                        ))}
                        <td className="p-1 border dark:border-gray-600">
                          <select value={row.units} onChange={(e) => handleListChange('electricalTests.contactResistanceAsLeft', index, 'units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                            {contactResistanceUnitOptions.map(opt => <option key={opt.symbol} value={opt.symbol}>{opt.symbol}</option>)}
                          </select>
                        </td>
                      </tr>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div>
                ...
                <div className="mb-2">
                  ...
                  <select value={formData.electricalTests.insulationResistance.testVoltage} onChange={(e) => handleChange('electricalTests.insulationResistance.testVoltage', e.target.value)} disabled={!isEditing} className={`form-select inline-block w-auto ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                    ...
                    {formData.electricalTests.insulationResistance.readings.map((row, index) => (
                      <tr key={`ir-${index}`}>
                        ...
                        {(['p1_mq', 'p2_mq', 'p3_mq'] as const).map(phase => (
                           <td key={phase} className="p-1 border dark:border-gray-600"><input type="text" value={row[phase]} onChange={(e) => handleListChange('electricalTests.insulationResistance.readings', index, phase, e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                        ))}
                      </tr>
                    ))}
                  </tbody>
              ...
              <div>
                <h3 className="text-md font-semibold mb-2">Temperature Corrected</h3>
                 <div className="mb-2">
                  <label className="form-label mr-2">Test Voltage:</label>
                  <input type="text" value={formData.electricalTests.temperatureCorrected.testVoltage} readOnly className="form-input inline-block w-auto bg-gray-100 dark:bg-dark-150" />
                </div>
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-dark-150">
                  ...
                  <tbody>
                     {formData.electricalTests.temperatureCorrected.readings.map((row, index) => (
                      <tr key={`tc-ir-${index}`}>
                        ...
                        <td className="p-2 border dark:border-gray-600 text-center">{row.state}</td>
                         {(['p1_mq', 'p2_mq', 'p3_mq'] as const).map(phase => (
                           <td key={phase} className="p-1 border dark:border-gray-600"><input type="text" value={row[phase]} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                        ))}
                      </tr>
                    ))}
                  </tbody>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden contactor-onscreen">
                {/* Left Column */}
                <div className="space-y-3">
                    <div><label htmlFor="contactorData.manufacturer" className="form-label inline-block w-40">Manufacturer:</label><input id="contactorData.manufacturer" type="text" value={formData.contactorData.manufacturer} onChange={(e) => handleChange('contactorData.manufacturer', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.catalogNumber" className="form-label inline-block w-40">Catalog Number:</label><input id="contactorData.catalogNumber" type="text" value={formData.contactorData.catalogNumber} onChange={(e) => handleChange('contactorData.catalogNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.serialNumber" className="form-label inline-block w-40">Serial Number:</label><input id="contactorData.serialNumber" type="text" value={formData.contactorData.serialNumber} onChange={(e) => handleChange('contactorData.serialNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.type" className="form-label inline-block w-40">Type:</label><input id="contactorData.type" type="text" value={formData.contactorData.type} onChange={(e) => handleChange('contactorData.type', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.manufacturingDate" className="form-label inline-block w-40">Manufacturing Date:</label><input id="contactorData.manufacturingDate" type="text" value={formData.contactorData.manufacturingDate} onChange={(e) => handleChange('contactorData.manufacturingDate', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                </div>
                {/* Right Column */}
                <div className="space-y-3">
                    <div><label htmlFor="contactorData.icRatingKA" className="form-label inline-block w-40">I.C. Rating (kA):</label><input id="contactorData.icRatingKA" type="text" value={formData.contactorData.icRatingKA} onChange={(e) => handleChange('contactorData.icRatingKA', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.ratedVoltageKV" className="form-label inline-block w-40">Rated Voltage (kV):</label><input id="contactorData.ratedVoltageKV" type="text" value={formData.contactorData.ratedVoltageKV} onChange={(e) => handleChange('contactorData.ratedVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label htmlFor="contactorData.operatingVoltageKV" className="form-label inline-block w-40">Operating Voltage (kV):</label><input id="contactorData.operatingVoltageKV" type="text" value={formData.contactorData.operatingVoltageKV} onChange={(e) => handleChange('contactorData.operatingVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    ...
                    <div><label htmlFor="contactorData.controlVoltageV" className="form-label inline-block w-40">Control Voltage (V):</label><input id="contactorData.controlVoltageV" type="text" value={formData.contactorData.controlVoltageV} onChange={(e) => handleChange('contactorData.controlVoltageV', e.target.value)} readOnly={!isEditing} className={`form-input w-[calc(100%-10rem)] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                </div>
            </div>
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <tbody>
                  <tr>
                    <td>{formData.contactorData.manufacturer}</td>
                    <td>{formData.contactorData.catalogNumber}</td>
                    <td>{formData.contactorData.serialNumber}</td>
                    <td>{formData.contactorData.type}</td>
                    <td>{formData.contactorData.manufacturingDate}</td>
                  </tr>
                </tbody>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td>{formData.contactorData.icRatingKA}</td>
                    <td>{formData.contactorData.ratedVoltageKV}</td>
                    <td>{formData.contactorData.operatingVoltageKV}</td>
                    <td>{formData.contactorData.ampacity}</td>
                    <td>{formData.contactorData.controlVoltageV}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="mb-2">
                  <label className="form-label mr-2">Test Voltage:</label>
                  <select value={formData.electricalTestContactor.insulationResistance.testVoltage} onChange={(e) => handleChange('electricalTestContactor.insulationResistance.testVoltage', e.target.value)} disabled={!isEditing} className={`form-select inline-block w-auto ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                    {insulationTestVoltageOptions.map(v => <option key={v} value={v}>{v}</option>)}
                  </select>
                </div>
                <table className="min-w-full text-sm">
                  ...
                  <tbody>
                    {formData.electricalTestContactor.insulationResistance.readings.map((row, index) => (
                      <tr key={`contactor-ir-${index}`}>
                        ...
                        <td className="p-2 border dark:border-gray-600 text-center">{row.state}</td>
                         {(['p1_mq', 'p2_mq', 'p3_mq'] as const).map(phase => (
                           <td key={phase} className="p-1 border dark:border-gray-600"><input type="text" value={row[phase]} onChange={(e) => handleListChange('electricalTestContactor.insulationResistance.readings', index, phase, e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                        ))}
                      </tr>
                    ))}
                  </tbody>
              ...
              <div>
                <h3 className="text-md font-semibold mb-2">Temperature Corrected</h3>
                 <div className="mb-2">
                  <label className="form-label mr-2">Test Voltage:</label>
                  <input type="text" value={formData.electricalTestContactor.temperatureCorrected.testVoltage} readOnly className="form-input inline-block w-auto bg-gray-100 dark:bg-dark-150" />
                </div>
                <table className="min-w-full text-sm">
                   <thead>
                    <tr className="bg-gray-50 dark:bg-dark-150">
            ...
            <div className="mt-6">
                ...
                <table className="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestContactor.vacuumBottleIntegrity.testVoltage} onChange={(e) => handleChange('electricalTestContactor.vacuumBottleIntegrity.testVoltage', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestContactor.vacuumBottleIntegrity.testDuration} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestContactor.vacuumBottleIntegrity.p1} onChange={(e) => handleChange('electricalTestContactor.vacuumBottleIntegrity.p1', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestContactor.vacuumBottleIntegrity.p2} onChange={(e) => handleChange('electricalTestContactor.vacuumBottleIntegrity.p2', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestContactor.vacuumBottleIntegrity.p3} onChange={(e) => handleChange('electricalTestContactor.vacuumBottleIntegrity.p3', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600">
                                <select value={formData.electricalTestContactor.vacuumBottleIntegrity.units} onChange={(e) => handleChange('electricalTestContactor.vacuumBottleIntegrity.units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden reactor-onscreen">
                <div><label htmlFor="startingReactorData.manufacturer" className="form-label block">Manufacturer:</label><input id="startingReactorData.manufacturer" type="text" value={formData.startingReactorData.manufacturer} onChange={(e) => handleChange('startingReactorData.manufacturer', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="startingReactorData.catalogNumber" className="form-label block">Catalog Number:</label><input id="startingReactorData.catalogNumber" type="text" value={formData.startingReactorData.catalogNumber} onChange={(e) => handleChange('startingReactorData.catalogNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="startingReactorData.serialNumber" className="form-label block">Serial Number:</label><input id="startingReactorData.serialNumber" type="text" value={formData.startingReactorData.serialNumber} onChange={(e) => handleChange('startingReactorData.serialNumber', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="startingReactorData.ratedCurrentA" className="form-label block">Rated Current (A):</label><input id="startingReactorData.ratedCurrentA" type="text" value={formData.startingReactorData.ratedCurrentA} onChange={(e) => handleChange('startingReactorData.ratedCurrentA', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="startingReactorData.ratedVoltageKV" className="form-label block">Rated Voltage (kV):</label><input id="startingReactorData.ratedVoltageKV" type="text" value={formData.startingReactorData.ratedVoltageKV} onChange={(e) => handleChange('startingReactorData.ratedVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label htmlFor="startingReactorData.operatingVoltageKV" className="form-label block">Operating Voltage (kV):</label><input id="startingReactorData.operatingVoltageKV" type="text" value={formData.startingReactorData.operatingVoltageKV} onChange={(e) => handleChange('startingReactorData.operatingVoltageKV', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            </div>
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                ...
                <tbody>
                  <tr>
                    <td>{formData.startingReactorData.manufacturer}</td>
                    <td>{formData.startingReactorData.catalogNumber}</td>
                    <td>{formData.startingReactorData.serialNumber}</td>
                    <td>{formData.startingReactorData.ratedCurrentA}</td>
                    <td>{formData.startingReactorData.ratedVoltageKV}</td>
                    <td>{formData.startingReactorData.operatingVoltageKV}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div className="mb-2">
                        <label className="form-label mr-2">Test Voltage:</label>
                        <select value={formData.electricalTestReactor.insulationResistance.testVoltage} onChange={(e) => handleChange('electricalTestReactor.insulationResistance.testVoltage', e.target.value)} disabled={!isEditing} className={`form-select inline-block w-auto ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                            {insulationTestVoltageOptions.map(v => <option key={v} value={v}>{v}</option>)}
                        </select>
                    </div>
                    <table className="min-w-full text-sm">
                        <thead><tr className="bg-gray-50 dark:bg-dark-150"><th className="p-2 border dark:border-gray-600">Winding to Ground</th><th className="p-2 border dark:border-gray-600">A-Phase</th><th className="p-2 border dark:border-gray-600">B-Phase</th><th className="p-2 border dark:border-gray-600">C-Phase</th><th className="p-2 border dark:border-gray-600">Units</th></tr></thead>
                        <tbody>
                            <tr>
                                <td className="p-2 border dark:border-gray-600 font-medium">Reading</td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.insulationResistance.windingToGround.aPhase} onChange={(e) => handleChange('electricalTestReactor.insulationResistance.windingToGround.aPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.insulationResistance.windingToGround.bPhase} onChange={(e) => handleChange('electricalTestReactor.insulationResistance.windingToGround.bPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.insulationResistance.windingToGround.cPhase} onChange={(e) => handleChange('electricalTestReactor.insulationResistance.windingToGround.cPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                                <td className="p-1 border dark:border-gray-600">
                                    <select value={formData.electricalTestReactor.insulationResistance.windingToGround.units} onChange={(e) => handleChange('electricalTestReactor.insulationResistance.windingToGround.units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                ...
                <div>
                    <h3 className="text-md font-semibold mb-2">Temperature Corrected Values</h3>
                     <div className="mb-2">
                        <label className="form-label mr-2">Test Voltage:</label>
                         <input type="text" value={formData.electricalTestReactor.temperatureCorrected.testVoltage} readOnly className="form-input inline-block w-auto bg-gray-100 dark:bg-dark-150" />
                    </div>
                    <table className="min-w-full text-sm">
                        <thead><tr className="bg-gray-50 dark:bg-dark-150"><th className="p-2 border dark:border-gray-600">Winding to Ground</th><th className="p-2 border dark:border-gray-600">A-Phase</th><th className="p-2 border dark:border-gray-600">B-Phase</th><th className="p-2 border dark:border-gray-600">C-Phase</th><th className="p-2 border dark:border-gray-600">Units</th></tr></thead>
                        <tbody>
                            <tr>
                                <td className="p-2 border dark:border-gray-600 font-medium">Reading</td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.temperatureCorrected.windingToGround.aPhase} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.temperatureCorrected.windingToGround.bPhase} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.temperatureCorrected.windingToGround.cPhase} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                                <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.temperatureCorrected.windingToGround.units} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div className="mt-6">
                ...
                <table className="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr>
                            <td className="p-2 border dark:border-gray-600 font-medium">Reading</td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsFound.aPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsFound.aPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsFound.bPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsFound.bPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsFound.cPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsFound.cPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600">
                                <select value={formData.electricalTestReactor.contactResistanceAsFound.units} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsFound.units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                                    {contactResistanceUnitOptions.map(opt => <option key={opt.symbol} value={opt.symbol}>{opt.symbol}</option>)}
                                </select>
                            </td>
                        </tr>
            ...
            <div className="mt-6">
                ...
                <table className="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr>
                            <td className="p-2 border dark:border-gray-600 font-medium">Reading</td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsLeft.aPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsLeft.aPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsLeft.bPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsLeft.bPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600"><input type="text" value={formData.electricalTestReactor.contactResistanceAsLeft.cPhase} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsLeft.cPhase', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></td>
                            <td className="p-1 border dark:border-gray-600">
                                <select value={formData.electricalTestReactor.contactResistanceAsLeft.units} onChange={(e) => handleChange('electricalTestReactor.contactResistanceAsLeft.units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
                                    {contactResistanceUnitOptions.map(opt => <option key={opt.symbol} value={opt.symbol}>{opt.symbol}</option>)}
                                </select>
                            </td>
                        </tr>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 print:hidden">
              {([
                ...
                const handleEquipmentSelect = (selectedEquipment: any) => {
                  ...
                  handleChange(`testEquipmentUsed.${equip.key}.name`, selectedEquipment.equipment_name);
                  handleChange(`testEquipmentUsed.${equip.key}.serialNumber`, selectedEquipment.serial_number || '');
                  handleChange(`testEquipmentUsed.${equip.key}.ampId`, selectedEquipment.amp_id || '');
                  handleChange(`testEquipmentUsed.${equip.key}.calDate`, formatLocalDateShort(selectedEquipment.calibration_date));
                };

                return (
                  <div key={equip.key} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                      <label className="form-label block">{equip.label}:</label>
                      <EquipmentAutocomplete
                        value={formData.testEquipmentUsed[equip.key].name}
                        onChange={(value) => handleChange(`testEquipmentUsed.${equip.key}.name`, value)}
                        onSelect={handleEquipmentSelect}
                        readOnly={!isEditing}
                        className="w-full"
                      />
                    </div>
                    <div><label className="form-label block">Serial Number:</label><input type="text" value={formData.testEquipmentUsed[equip.key].serialNumber} onChange={(e) => handleChange(`testEquipmentUsed.${equip.key}.serialNumber`, e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label className="form-label block">AMP ID:</label><input type="text" value={formData.testEquipmentUsed[equip.key].ampId} onChange={(e) => handleChange(`testEquipmentUsed.${equip.key}.ampId`, e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                    <div><label className="form-label block">Cal Date:</label><input type="text" value={formData.testEquipmentUsed[equip.key].calDate} onChange={(e) => handleChange(`testEquipmentUsed.${equip.key}.calDate`, e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                  </div>
                );
              })}
            </div>
            <div className="hidden print:block">
              <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{formData.testEquipmentUsed.hipot.name || 'Hipot'}</td>
                    <td>{formData.testEquipmentUsed.hipot.serialNumber}</td>
                    <td>{formData.testEquipmentUsed.hipot.ampId}</td>
                  </tr>
                </tbody>
              </table>
            </div>
  ...
  style.textContent = `
    ...
    @media print {
      ...
      * {
      ...
      /* FINAL HIDES: ensure old job info grid never prints */
      .job-info-onscreen, .job-info-onscreen * { display: none !important; }
      .nameplate-onscreen, .nameplate-onscreen * { display: none !important; }
      .fuse-onscreen, .fuse-onscreen * { display: none !important; }
      .contactor-onscreen, .contactor-onscreen * { display: none !important; }
      .reactor-onscreen, .reactor-onscreen * { display: none !important; }
      .job-info-onscreen, .nameplate-onscreen, .fuse-onscreen, .contactor-onscreen, .reactor-onscreen {
