        ...
        try {
          ...
          if (jobs && jobs.length > 0) {
            ...
            if (opportunityIds.length > 0) {
              ...
              let letterProposals: { opportunity_id: any; html: any; created_at: any; data: any; }[] | null = null;
              ...
              >
                <LineChart
                  data={(() => {
                    ...
                    const tempDate = new Date(rangeStart.getFullYear(), rangeStart.getMonth(), 1);
                    while (tempDate <= rangeEnd) {
                      ...
                      if (!monthlyData.has(monthKey)) {
                        monthlyData.set(monthKey, { month: monthLabel, revenue: 0, date: new Date(tempDate) });
                      }
