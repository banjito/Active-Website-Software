                        ...
                        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start'}}>
                          ...
                          <div style={{width: '60%'}}>
                            ...
                            <div>
                              ...
                              <div style={{marginBottom: '5px'}}>Mobilization: $0.00</div>
                            </div>
                          </div>
                      ...
                      <div style={{...styles.summarySection, width: '100%'}}>
                        ...
                        <div style={{fontSize: '14px', lineHeight: '1.5'}}>
                          <div style={{marginBottom: '10px'}}>
                            Mobilization costs of {formatCurrency(Math.ceil(getFinalValue() * 0.10))} shall be paid before the first day of work in addition to:
                          </div>
                          <div style={{marginBottom: '5px'}}>
