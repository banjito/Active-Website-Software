...
export const SelectTrigger: React.FC<SelectTriggerProps> = ({
  ...
  return (
    <div
      className={`flex items-center justify-between w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-dark-150 cursor-pointer text-gray-900 dark:text-gray-100 ${open ? 'ring-2 ring-blue-500 outline-none' : ''} ${className}`}
...
export const SelectContent: React.FC<SelectContentProps> = ({
  ...
  return (
    <div
      className={`absolute z-50 mt-1 w-full overflow-auto rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-150 shadow-lg max-h-60 py-1 ${alignClasses[align]} ${className}`}
    >
      {children}
    </div>
  );
