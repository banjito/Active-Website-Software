      ...
      <div className="p-6 flex justify-center">
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6 section-insulation-resistance">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full table-fixed divide-y divide-neutral-200 dark:divide-neutral-700 print:border-black">
                <colgroup>
                  <col style={{ width: "8%" }} />
                  <col style={{ width: "9.3%" }} />
                  <col style={{ width: "9.3%" }} />
          ...
          >
            ...
            <textarea
              ...
              readOnly={!isEditing}
              rows={4}
              className={`block w-full rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""} print:hidden`}
            />
