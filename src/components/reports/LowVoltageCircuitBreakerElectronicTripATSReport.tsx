...
interface FormData {
  ...
  primaryInjection: {
    testedSettings: {
      // Reuse testedSettings structure for the top table
      longTime: { setting: string; delay: string; i2t: string };
      shortTime: { setting: string; delay: string; i2t: string };
      instantaneous: { setting: string; delay: string; i2t: string };
      groundFault: { setting: string; delay: string; i2t: string };
    ...
    results: {
      // Updated structure for the exact layout provided
      longTime: {
...
const LowVoltageCircuitBreakerElectronicTripATSReport: React.FC = () => {
  ...
  const loadJobInfo = async () => {
    ...
    try {
      ...
      if (jobData) {
        let customerName = "";
        let customerAddress = maskCustomerAddress(
      ...
      if (generic && generic.data) {
        ...
        setFormData((prev) => {
          const updated = {
            ...
            chargeMotorVoltage:
              d.nameplateData?.chargeMotorVoltage ?? prev.chargeMotorVoltage,
            ...
            visualInspectionItems: Array.isArray(prev.visualInspectionItems)
              ? prev.visualInspectionItems.map((item) => ({
                  ...item,
                  result:
                    d.visualInspection && d.visualInspection[item.id]
                      ? d.visualInspection[item.id]
                      : item.result,
                }))
              ...
              if (src) {
                ...
                const findRow = (name: string) =>
                  rows.find(
                    (r: any) =>
                      typeof r.id === "string" &&
                      r.id.toLowerCase().includes(name),
                  );
            ...
            primaryInjection: d.primaryInjection
              ? {
                  ...
                  testedSettings: {
                    longTime: {
                      ...prev.primaryInjection.testedSettings.longTime,
                      ...(d.primaryInjection.testedSettings?.longTime || {}),
                    },
                    shortTime: {
                      ...prev.primaryInjection.testedSettings.shortTime,
                      ...(d.primaryInjection.testedSettings?.shortTime || {}),
                    },
                    instantaneous: {
                      ...prev.primaryInjection.testedSettings.instantaneous,
                      ...(d.primaryInjection.testedSettings?.instantaneous ||
                        {}),
                    },
                    groundFault: {
                      ...prev.primaryInjection.testedSettings.groundFault,
                      ...(d.primaryInjection.testedSettings?.groundFault || {}),
                    },
                  },
                  results: {
                    longTime: {
                      ...prev.primaryInjection.results.longTime,
                      ...(d.primaryInjection.results?.longTime || {}),
                    },
                    shortTime: {
                      ...prev.primaryInjection.results.shortTime,
                      ...(d.primaryInjection.results?.shortTime || {}),
                    },
                    instantaneous: {
                      ...prev.primaryInjection.results.instantaneous,
                      ...(d.primaryInjection.results?.instantaneous || {}),
                    },
                    groundFault: {
                      ...prev.primaryInjection.results.groundFault,
                      ...(d.primaryInjection.results?.groundFault || {}),
                    },
                  },
                }
              : prev.primaryInjection,
            ...
            testEquipment: {
              megohmmeter: {
                ...
                ...(d.testEquipment?.megohmmeter || {}),
              },
              lowResistanceOhmmeter: {
                ...prev.testEquipment.lowResistanceOhmmeter,
                ...(d.testEquipment?.lowResistanceOhmmeter || {}),
              },
              primaryInjectionTestSet: {
                ...prev.testEquipment.primaryInjectionTestSet,
                ...(d.testEquipment?.primaryInjectionTestSet || {}),
              },
            },
        ...
        try {
          ...
          console.log(
            "Running backfill for generic table load, identifier:",
            d.reportInfo?.identifier,
          );
          ...
          if (identifier) {
            ...
            console.log(
              "Found additional generic rows for backfill:",
              genList?.length,
            );
              ...
              if (fields) {
                ...
                setFormData((prev) => {
                  const updated = {
                    ...
                    chargeMotorVoltage:
                      prev.chargeMotorVoltage || fields?.chargeMotorVoltage,
                    ...
                    visualInspectionItems: (() => {
                      const rows = Array.isArray(fields?.["vm-table"]?.rows)
                        ? fields["vm-table"].rows
                        : null;
                  ...
                  console.log(
                    "Updated formData with backfill data from generic table",
                  );
                  return updated;
                });
              }
      ...
      if (data) {
        setFormData((prev) => ({
          ...
          temperature: (() => {
            ...
            const fahrenheit =
              tempData?.fahrenheit ?? prev.temperature.fahrenheit;
          ...
          insulationResistance: {
            testVoltage:
              ...
              prev.insulationResistance.testVoltage,
            unit:
              data.insulation_resistance?.unit ??
              prev.insulationResistance.unit,
            measured: {
              poleToPole: {
                p1p2:
                  data.insulation_resistance?.measured?.poleToPole?.p1p2 ??
                  prev.insulationResistance.measured.poleToPole.p1p2,
                p2p3:
                  data.insulation_resistance?.measured?.poleToPole?.p2p3 ??
                  prev.insulationResistance.measured.poleToPole.p2p3,
                p3p1:
                  data.insulation_resistance?.measured?.poleToPole?.p3p1 ??
                  prev.insulationResistance.measured.poleToPole.p3p1,
              },
              poleToFrame: {
                p1:
                  data.insulation_resistance?.measured?.poleToFrame?.p1 ??
                  prev.insulationResistance.measured.poleToFrame.p1,
                p2:
                  data.insulation_resistance?.measured?.poleToFrame?.p2 ??
                  prev.insulationResistance.measured.poleToFrame.p2,
                p3:
                  data.insulation_resistance?.measured?.poleToFrame?.p3 ??
                  prev.insulationResistance.measured.poleToFrame.p3,
              },
              lineToLoad: {
                p1:
                  data.insulation_resistance?.measured?.lineToLoad?.p1 ??
                  prev.insulationResistance.measured.lineToLoad.p1,
                p2:
                  data.insulation_resistance?.measured?.lineToLoad?.p2 ??
                  prev.insulationResistance.measured.lineToLoad.p2,
                p3:
                  data.insulation_resistance?.measured?.lineToLoad?.p3 ??
                  prev.insulationResistance.measured.lineToLoad.p3,
              },
            },
            corrected: (() => {
              ...
              const measured = {
                poleToPole: {
                  p1p2:
                    (data as any)?.insulation_resistance?.measured?.poleToPole
                      ?.p1p2 ??
                    prev.insulationResistance.measured.poleToPole.p1p2,
                  p2p3:
                    (data as any)?.insulation_resistance?.measured?.poleToPole
                ...
                poleToFrame: {
                  p1:
                    (data as any)?.insulation_resistance?.measured?.poleToFrame
                      ?.p1 ?? prev.insulationResistance.measured.poleToFrame.p1,
                  p2:
                    (data as any)?.insulation_resistance?.measured?.poleToFrame
                      ?.p2 ?? prev.insulationResistance.measured.poleToFrame.p2,
                  p3:
                    (data as any)?.insulation_resistance?.measured?.poleToFrame
                      ?.p3 ?? prev.insulationResistance.measured.poleToFrame.p3,
                },
                lineToLoad: {
                  p1:
                    (data as any)?.insulation_resistance?.measured?.lineToLoad
                      ?.p1 ?? prev.insulationResistance.measured.lineToLoad.p1,
                  p2:
                    (data as any)?.insulation_resistance?.measured?.lineToLoad
                      ?.p2 ?? prev.insulationResistance.measured.lineToLoad.p2,
                  p3:
                    (data as any)?.insulation_resistance?.measured?.lineToLoad
                      ?.p3 ?? prev.insulationResistance.measured.lineToLoad.p3,
                },
              };
                ...
                const tcf = getTCF(
                  Math.round(
                    ((data.report_info?.temperature?.fahrenheit ??
                      prev.temperature.fahrenheit - 32) *
                      5) /
                      9,
                  ),
                );
          ...
          primaryInjection: (data as any)?.primary_injection
            ? {
                testedSettings: {
                  longTime: {
                    ...prev.primaryInjection.testedSettings.longTime,
                    ...((data as any).primary_injection?.testedSettings
                      ?.longTime || {}),
                  },
                  shortTime: {
                    ...prev.primaryInjection.testedSettings.shortTime,
                ...
                results: {
                  longTime: {
                    ...prev.primaryInjection.results.longTime,
                    ...((data as any).primary_injection?.results?.longTime ||
                      {}),
                  },
                  shortTime: {
                    ...prev.primaryInjection.results.shortTime,
                    ...((data as any).primary_injection?.results?.shortTime ||
                      {}),
                  },
                  instantaneous: {
                    ...prev.primaryInjection.results.instantaneous,
                    ...((data as any).primary_injection?.results
                      ?.instantaneous || {}),
                  },
                  groundFault: {
                    ...prev.primaryInjection.results.groundFault,
                    ...((data as any).primary_injection?.results?.groundFault ||
                      {}),
                  },
                },
              }
        ...
        try {
          ...
          console.log(
            "Starting retroactive backfill for identifier:",
          ...
          if (identifier) {
            ...
            if (genList && genList.length > 0) {
              ...
              const rebuildFromSections = (() => {
                ...
                const fieldListToObj = (sec: any) => {
                  ...
                  for (const f of arr) {
                    ...
                    if (label.startsWith("customer"))
                      obj.customer = maskCustomerName(v);
                    else if (label.startsWith("address"))
                      obj.address = maskCustomerAddress(v);
                    ...
                    else if (label.startsWith("technicians"))
                      obj.technicians = v;
                    ...
                    else if (label.startsWith("rating plug"))
                      obj.ratingPlug = v;
                    else if (label.startsWith("curve")) obj.curveNo = v;
                    else if (label.startsWith("charge motor v"))
                      obj.chargeMotorVoltage = v;
                ...
                console.log(
                  "Job and nameplate fields:",
                  Object.keys(fieldsFromSections),
                );
                const vmField = vm?.fields?.find(
                  (f: any) => f?.type === "table",
                );
                if (vmField?.value?.rows)
                  fieldsFromSections["vm-table"] = { rows: vmField.value.rows };
                console.log("VM table found:", !!vmField?.value?.rows);
                const devField = dev?.fields?.find(
                  (f: any) => f?.type === "table",
                );
                if (devField?.value)
                  fieldsFromSections.deviceSettings = devField.value;
                console.log("Device settings found:", !!devField?.value);
                const crField = cr?.fields?.find((f: any) =>
                  (f?.label || "").toLowerCase().includes("contact resistance"),
                );
                if (crField?.value)
                  fieldsFromSections.breakerContactResistance = crField.value;
                console.log("Contact resistance found:", !!crField?.value);
                const irField = ir?.fields?.find((f: any) =>
                  (f?.label || "")
                    .toLowerCase()
                    .includes("insulation resistance"),
                );
                if (irField?.value)
                  fieldsFromSections.contactorInsulation = irField.value;
                console.log("Insulation resistance found:", !!irField?.value);
                const piField = pi?.fields?.find((f: any) =>
                  (f?.label || "").toLowerCase().includes("primary injection"),
                );
                if (piField?.value)
                  fieldsFromSections.primaryInjection = piField.value;
                console.log("Primary injection found:", !!piField?.value);
                const teField = te?.fields?.find(
                  (f: any) => f?.type === "table",
                );
                if (teField?.value)
                  fieldsFromSections.testEquipment3 = teField.value;
                console.log("Test equipment found:", !!teField?.value);
                const cmField = cm?.fields?.find(
                  (f: any) => (f?.label || "").toLowerCase() === "comments",
                );
                if (cmField?.value != null)
                  fieldsFromSections.comments = cmField.value;
                ...
                setFormData((prev) => {
                  const updated = {
                    ...
                    temperature: {
                      ...prev.temperature,
                      fahrenheit:
                        fields?.temperatureF != null
                          ? Number(fields.temperatureF)
                          : prev.temperature.fahrenheit,
                      celsius:
                        fields?.temperatureF != null
                          ? Math.round(
                              ((Number(fields.temperatureF) - 32) * 5) / 9,
                            )
                          : prev.temperature.celsius,
                      tcf:
                        fields?.temperatureF != null
                    ...
                    chargeMotorVoltage:
                      fields?.chargeMotorVoltage ?? prev.chargeMotorVoltage,
                    ...
                    visualInspectionItems: Array.isArray(
                      fields?.["vm-table"]?.rows,
                    )
                      ? fields["vm-table"].rows.map((row: any) => ({
                          id: row.id ?? "",
                      ...
                      : prev.visualInspectionItems,
                    deviceSettings:
                      fields?.deviceSettings &&
                      Object.keys(fields.deviceSettings).length > 0
                        ? fields.deviceSettings
                        : prev.deviceSettings,
                    contactResistance: fields?.breakerContactResistance
                      ? {
                        ...
                        if (rowPTP) {
                          ...
                          ir.corrected.poleToPole = {
                            p1p2: calculateCorrectedValue(
                              rowPTP.p1 ?? ir.measured.poleToPole.p1p2,
                            ),
                            p2p3: calculateCorrectedValue(
                              rowPTP.p2 ?? ir.measured.poleToPole.p2p3,
                            ),
                            p3p1: calculateCorrectedValue(
                              rowPTP.p3 ?? ir.measured.poleToPole.p3p1,
                            ),
                          };
                        }
                        if (rowPTF) {
                          ...
                          ir.corrected.poleToFrame = {
                            p1: calculateCorrectedValue(
                              rowPTF.p1 ?? ir.measured.poleToFrame.p1,
                            ),
                            p2: calculateCorrectedValue(
                              rowPTF.p2 ?? ir.measured.poleToFrame.p2,
                            ),
                            p3: calculateCorrectedValue(
                              rowPTF.p3 ?? ir.measured.poleToFrame.p3,
                            ),
                          };
                        }
                        if (rowLTL) {
                          ...
                          ir.corrected.lineToLoad = {
                            p1: calculateCorrectedValue(
                              rowLTL.p1 ?? ir.measured.lineToLoad.p1,
                            ),
                            p2: calculateCorrectedValue(
                              rowLTL.p2 ?? ir.measured.lineToLoad.p2,
                            ),
                            p3: calculateCorrectedValue(
                              rowLTL.p3 ?? ir.measured.lineToLoad.p3,
                            ),
                          };
                        }
                      }
                    ...
                    primaryInjection:
                      fields?.primaryInjection &&
                      Object.keys(fields.primaryInjection).length > 0
                        ? {
                            ...prev.primaryInjection,
                            testedSettings: {
                              longTime: {
                                ...prev.primaryInjection.testedSettings
                                  .longTime,
                                ...(fields?.primaryInjection?.testedSettings
                                  ?.longTime || {}),
                              },
                              shortTime: {
                                ...prev.primaryInjection.testedSettings
                            ...
                            results: {
                              longTime: {
                                ...prev.primaryInjection.results.longTime,
                                ...(fields?.primaryInjection?.results
                                  ?.longTime || {}),
                              },
                              shortTime: {
                                ...prev.primaryInjection.results.shortTime,
                    ...
                    testEquipment: (() => {
                      const te =
                        fields?.testEquipment3 || fields?.testEquipment;
                      if (!te || Object.keys(te).length === 0)
                        return prev.testEquipment;
                      return {
                        megohmmeter: {
                          ...prev.testEquipment.megohmmeter,
                          ...(te?.megohmmeter || {}),
                        ...
                        lowResistanceOhmmeter: {
                          ...prev.testEquipment.lowResistanceOhmmeter,
                          ...(te?.lowResistanceOhmmeter || {}),
                        },
                        primaryInjectionTestSet: {
                          ...prev.testEquipment.primaryInjectionTestSet,
                          ...(te?.primaryInjectionTestSet || {}),
                        },
                      };
                    })(),
                  ...
                  console.log(
                    "Trip Unit Type from fields:",
                    fields?.tripUnitType,
                  );
                  console.log(
                    "Trip Unit Type in updated formData:",
                    updated.tripUnitType,
                  );
                  return updated;
                });
              }
      ...
      visualInspectionItems: Array.isArray(prev.visualInspectionItems)
        ...
        : [
            ...
            },
            {
              id: "7.6.1.2.A.14",
              description:
                "Verify that all devices are free from the accumulation of dust and other foreign matter.",
              result: "",
            },
            {
              id: "7.6.1.2.A.15",
  ...
  const handleChange = (path: string, value: any) => {
    ...
    setFormData((prev) => {
      ...
      for (let i = 0; i < keys.length - 1; i++) {
        ...
        if (match) {
          ...
          if (!currentLevel[arrayKey][index])
            currentLevel[arrayKey][index] = {}; // Ensure object at index exists
      ...
      if (path.includes("ratedAmperes1")) {
        const section = path.includes("longTime")
          ? "longTime"
          : path.includes("shortTime")
            ? "shortTime"
            : path.includes("instantaneous")
              ? "instantaneous"
              : "groundFault";
      ...
      if (path.includes("primaryInjection.results.")) {
        const section: SectionKey | null = path.includes("longTime")
          ? "longTime"
          : path.includes("shortTime")
            ? "shortTime"
            : path.includes("instantaneous")
              ? "instantaneous"
              : path.includes("groundFault")
                ? "groundFault"
                : null;
        if (
          section &&
  ...
  const calculateTestValues = (
    ratedAmperes: string,
    section: "longTime" | "shortTime" | "instantaneous" | "groundFault",
  ) => {
    if (!ratedAmperes || isNaN(Number(ratedAmperes))) return null;

    const value = Number(ratedAmperes);
    const multipliers = {
      longTime: { test: 3.0, tolerance: 0.1 }, // 300%, ±10%
      shortTime: { test: 1.1, tolerance: 0.1 }, // 110%, ±10%
      instantaneous: { test: 1.0, tolerance: 0.2 }, // 100%, ±20%
    ...
    return {
      testAmperes1:
        section === "instantaneous" ? "" : (value * mult.test).toFixed(1),
  ...
  const recomputeTopFromMultiplier = (state: any, section: SectionKey) => {
    ...
    if (!isFinite(rated) || !isFinite(multPct) || multPct === 0) {
      ...
      res.testAmperes1 =
        section === "instantaneous" ? res.testAmperes1 || "" : "";
      return;
    }
        ...
        <div className="space-y-6">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
              ...
              <div>
                <label htmlFor="temperature.humidity" className="form-label">
                  Humidity:
                </label>
                <input
            ...
            <div className="hidden print:block">
              <table className="w-full border-collapse border border-zinc-300 print:border-black">
                <tbody>
                  <tr>
                    <td className="p-3 align-top border border-zinc-300 print:border-black">
                  ...
                  <tr>
                    <td className="p-3 align-top border border-zinc-300 print:border-black lvcb-ats-address-cell">
                      <div className="font-semibold">Address:</div>
                      <div className="mt-1 lvcb-ats-address-value">
                        {maskCustomerAddress(
          ...
          <div className="mb-6">
            ...
            <div className="print:hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label htmlFor="catalogNumber" className="form-label">
                    Catalog Number:
                  </label>
                  <input
                    id="catalogNumber"
                ...
                <div>
                  <label htmlFor="icRating" className="form-label">
                    I.C. Rating (kA):
                  </label>
                  <input
                    id="icRating"
                ...
                <div>
                  <label htmlFor="tripUnitType" className="form-label">
                    Trip Unit Type:
                  </label>
                  <input
                    id="tripUnitType"
                ...
                <div>
                  <label htmlFor="ratingPlug" className="form-label">
                    Rating Plug (A):
                  </label>
                  <input
                    id="ratingPlug"
                ...
                <div>
                  <label htmlFor="curveNo" className="form-label">
                    Curve No.:
                  </label>
                  <input
                    id="curveNo"
                ...
                <div>
                  <label htmlFor="chargeMotorVoltage" className="form-label">
                    Charge Motor V:
                  </label>
                  <input
                    id="chargeMotorVoltage"
                    type="text"
                    value={formData.chargeMotorVoltage}
                    onChange={(e) =>
                      handleChange("chargeMotorVoltage", e.target.value)
                    }
                    readOnly={!isEditing}
                    className={`form-input w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                  />
                ...
                <div>
                  <label htmlFor="mounting" className="form-label">
                    Mounting:
                  </label>
                  <input
                    id="mounting"
                ...
                <div>
                  <label htmlFor="zoneInterlock" className="form-label">
                    Zone Interlock:
                  </label>
                  <input
                    id="zoneInterlock"
                ...
                <div>
                  <label htmlFor="thermalMemory" className="form-label">
                    Thermal Memory:
                  </label>
                  <input
                    id="thermalMemory"
            ...
            <div className="hidden print:block print:mt-2">
              ...
              <table className="w-full table-fixed border-collapse border border-zinc-300 print:border-black print:border text-[0.85rem] nameplate-print-table">
                <colgroup>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
                      ...
                      <div className="mt-0">{formData.tripUnitType}</div>
                    </td>
                  </tr>
                  <tr>
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
                    ...
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
                      <div className="font-semibold">Charge Motor V:</div>
                      <div className="mt-0">{formData.chargeMotorVoltage}</div>
                    </td>
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
                    ...
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
                      ...
                      <div className="mt-0">{formData.zoneInterlock}</div>
                    </td>
                    <td className="p-2 align-top border border-zinc-300 print:border-black print:border">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed border-collapse border border-zinc-300 dark:border-zinc-600">
                ...
                <thead className="bg-zinc-50 dark:bg-dark-150">
                  <tr>
                    <th className="border border-zinc-300 dark:border-zinc-600 px-3 py-2 text-left text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap">
                      NETA Section
                    </th>
                    ...
                    <th className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap">
                      Results
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-zinc-200 dark:divide-zinc-700">
                  {(Array.isArray(formData.visualInspectionItems)
                        ...
                        <tr key={`found-${settingType}`}>
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            <input
                              type="text"
                              value={
                                formData.deviceSettings?.asFound?.[settingType]
                                  ?.setting || ""
                              }
                              onChange={(e) =>
                                handleChange(
                                  `deviceSettings.asFound.${settingType}.setting`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            <input
                              ...
                              onChange={(e) =>
                                handleChange(
                                  `deviceSettings.asFound.${settingType}.delay`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            {settingType === "shortTime" ||
                            settingType === "groundFault" ? (
                              <select
                                value={
                                  formData.deviceSettings?.asFound?.[
                                    settingType
                                  ]?.i2t || ""
                                }
                                onChange={(e) =>
                                  handleChange(
                                    `deviceSettings.asFound.${settingType}.i2t`,
                                    e.target.value,
                                  )
                                }
                                disabled={!isEditing}
                                className={`w-full p-2 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white text-center ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                              >
                                {tripUnitTypeOptions.map((option) => (
                                  <option key={option} value={option}>
                                    {option}
                                  </option>
                                ))}
                        ...
                        <tr key={`left-${settingType}`}>
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            <input
                              type="text"
                              value={
                                formData.deviceSettings?.asLeft?.[settingType]
                                  ?.setting || ""
                              }
                              onChange={(e) =>
                                handleChange(
                                  `deviceSettings.asLeft.${settingType}.setting`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            <input
                              ...
                              onChange={(e) =>
                                handleChange(
                                  `deviceSettings.asLeft.${settingType}.delay`,
                                  e.target.value,
                                )
                              }
                              readOnly={!isEditing}
                          ...
                          <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                            ...
                            settingType === "groundFault" ? (
                              <select
                                ...
                                onChange={(e) =>
                                  handleChange(
                                    `deviceSettings.asLeft.${settingType}.i2t`,
                                    e.target.value,
                                  )
                                }
                                disabled={!isEditing}
          ...
          <section className="bg-white dark:bg-dark-150 rounded-lg shadow-md border border-zinc-200 dark:border-zinc-700 p-6">
            <h2 className="text-xl font-semibold mb-4 text-zinc-900 dark:text-white border-b dark:border-zinc-700 pb-2">
              Electrical Tests - Insulation Resistance
            </h2>
            <div className="flex justify-end mb-4">
              <label
                ...
                className="form-label mr-2 dark:text-white"
              >
                Test Voltage:
              </label>
              <select
            ...
            <div className={tableStyles.container}>
              <table className={`${tableStyles.table} ins-res-table`}>
                ...
                <thead className="bg-zinc-50 dark:bg-dark-150">
                  <tr>
                    <th
                      className={`${tableStyles.headerCell} text-left whitespace-nowrap`}
                      rowSpan={2}
                    >
                      Pole to...
                    </th>
                    <th
                      className={`${tableStyles.headerCell} text-center whitespace-nowrap`}
                      colSpan={3}
                    >
                      Measured Values
                    </th>
                  ...
                  <tr>
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        readOnly
                        className={`${tableStyles.input} text-center bg-zinc-100 dark:bg-dark-150`}
                      />
                    </td>
                    <td className={tableStyles.cell}>
                      <input
          ...
          <div className="mb-6">
            ...
            <div className="mb-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-zinc-300 dark:border-zinc-600 primary-injection-table">
                  <thead className="bg-zinc-50 dark:bg-dark-150">
                    <tr>
                      <th className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-left text-sm font-medium text-zinc-900 dark:text-white"></th>
                      <th className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white">
                      ...
                      <tr key={`tested-${settingType}`}>
                        ...
                        <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                          <input
                            type="text"
                            value={
                              formData.primaryInjection.testedSettings[
                                settingType
                              ]?.setting || ""
                            }
                            onChange={(e) =>
                              handleChange(
                                `primaryInjection.testedSettings.${settingType}.setting`,
                                e.target.value,
                              )
                            }
                            readOnly={!isEditing}
                        ...
                        <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                          <input
                            ...
                            onChange={(e) =>
                              handleChange(
                                `primaryInjection.testedSettings.${settingType}.delay`,
                                e.target.value,
                              )
                            }
                            readOnly={!isEditing}
                        ...
                        <td className="border border-zinc-300 dark:border-zinc-600 px-4 py-2 text-center">
                          ...
                          settingType === "groundFault" ? (
                            <select
                              ...
                              onChange={(e) =>
                                handleChange(
                                  `primaryInjection.testedSettings.${settingType}.i2t`,
                                  e.target.value,
                                )
                              }
                              disabled={!isEditing}
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed border-collapse border border-zinc-300 dark:border-zinc-600 primary-injection-table primary-injection-main-table">
                <colgroup>
                  {/* widths sum to 100% so cross-browser print layouts stay
                      consistent (otherwise Chrome/Win shrinks the last col) */}
                  <col style={{ width: isPrintMode ? "12%" : "11%" }} />{" "}
                  {/* Function */}
                  <col style={{ width: isPrintMode ? "12%" : "13%" }} />{" "}
                  {/* Rated Amperes */}
                  <col style={{ width: isPrintMode ? "10%" : "10%" }} />{" "}
                  {/* Multiplier % Left */}
                  <col style={{ width: isPrintMode ? "10%" : "10%" }} />{" "}
                  {/* Multiplier % Right */}
                  <col style={{ width: isPrintMode ? "15%" : "15%" }} />{" "}
                  {/* Test Amperes */}
                  <col
                    style={{ width: isPrintMode ? "20.5%" : "20.5%" }}
                  />{" "}
                  {/* Tolerance Min */}
                  <col
                    style={{ width: isPrintMode ? "20.5%" : "20.5%" }}
                ...
                <thead className="bg-zinc-50 dark:bg-dark-150">
                  <tr>
                    <th
                      className="border border-zinc-300 dark:border-zinc-600 px-3 py-2 text-left text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap"
                      rowSpan={2}
                    >
                      Function
                    </th>
                    <th
                      className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap"
                      rowSpan={2}
                    >
                      Rated Amperes
                    </th>
                  ...
                  <tr>
                    <th className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap"></th>
                    <th className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap"></th>
                    <th className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-center text-sm font-medium text-zinc-900 dark:text-white whitespace-nowrap">
                      Min
                    </th>
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-zinc-200 dark:divide-zinc-700">
                  {/* Long Time */}
                  <tr>
                    <td className={tableStyles.cell} rowSpan={2}>
                      Long Time
                    </td>
                    <td className={tableStyles.cell}>
                      <input
                        type="text"
                        value={
                          formData.primaryInjection.results.longTime
                            .ratedAmperes1 || ""
                        }
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.ratedAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td
                      className={`${tableStyles.cell} text-center`}
                      colSpan={2}
                    >
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.longTime.multiplier",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.testAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.toleranceMin1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.toleranceMax1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.longTime.toleranceMin",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.longTime.toleranceMax",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.testAmperes2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.toleranceMin2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.longTime.toleranceMax2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        type="text"
                        value={
                          formData.primaryInjection.results.shortTime
                            .ratedAmperes1 || ""
                        }
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.ratedAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.shortTime.multiplier",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.testAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.toleranceMin1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.toleranceMax1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.shortTime.toleranceMin",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.shortTime.toleranceMax",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.testAmperes2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.toleranceMin2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.shortTime.toleranceMax2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        type="text"
                        value={
                          formData.primaryInjection.results.instantaneous
                            .ratedAmperes1 || ""
                        }
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.instantaneous.ratedAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.instantaneous.multiplier",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                  ...
                  <tr>
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.instantaneous.toleranceMin",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.instantaneous.toleranceMax",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.instantaneous.testAmperes2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.instantaneous.toleranceMin2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.instantaneous.toleranceMax2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        type="text"
                        value={
                          formData.primaryInjection.results.groundFault
                            .ratedAmperes1 || ""
                        }
                        onChange={(e) =>
                          handleChange(
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.groundFault.multiplier",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.testAmperes1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.toleranceMin1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.toleranceMax1",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                  ...
                  <tr>
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.groundFault.toleranceMin",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                      ...
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleChange(
                              "primaryInjection.results.groundFault.toleranceMax",
                              v ? `${v}%` : "",
                            );
                          }}
                          readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.testAmperes2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.toleranceMin2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
                    ...
                    <td className={tableStyles.cell}>
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(
                            "primaryInjection.results.groundFault.toleranceMax2",
                            e.target.value,
                          )
                        }
                        readOnly={!isEditing}
            ...
            <div className="mt-4 overflow-x-auto primary-injection-poles-section">
              <h3 className="text-base font-semibold mb-2 text-zinc-900 dark:text-white print:text-black">
                Primary injection — pole readings (Poles 1–3)
              </h3>
              <table className="w-full table-fixed border-collapse border border-zinc-300 dark:border-zinc-600 primary-injection-table primary-injection-poles-table">
                <colgroup>
                  <col style={{ width: "22%" }} />
                  <col style={{ width: "14%" }} />
                ...
                <thead className="bg-zinc-50 dark:bg-dark-150">
                  <tr>
                    <th className="border border-zinc-300 dark:border-zinc-600 px-2 py-2 text-left text-sm font-medium text-zinc-900 dark:text-white">
                      Function
                    </th>
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-zinc-200 dark:divide-zinc-700">
                  <tr>
                    ...
                    <td className={`${tableStyles.cell} text-center text-sm`}>
                      Delay
                    </td>
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.longTime.pole1
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole1.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.longTime.pole2
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole2.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.longTime.pole3
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole3.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole1.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole2.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.longTime.pole3.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.shortTime.pole1
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole1.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.shortTime.pole2
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole2.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.shortTime.pole3
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole3.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole1.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole2.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.shortTime.pole3.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                  ...
                  <tr>
                    ...
                    <td
                      className={`${tableStyles.cell} text-center text-sm text-zinc-500 dark:text-zinc-400`}
                    >
                      —
                    </td>
                    <td
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.instantaneous.pole1.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.instantaneous.pole2.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.instantaneous.pole3.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.groundFault.pole1
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole1.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.groundFault.pole2
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole2.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          type="text"
                          value={
                            formData.primaryInjection.results.groundFault.pole3
                              .sec || ""
                          }
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole3.sec",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole1.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole2.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
                    ...
                    <td className={`${tableStyles.cell} text-center`}>
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(
                              "primaryInjection.results.groundFault.pole3.a",
                              e.target.value,
                            )
                          }
                          readOnly={!isEditing}
          ...
          <div className="hidden print:block">
            <h2 className="text-xl font-semibold mb-4 text-black border-b border-black pb-2 font-bold">
              Test Equipment Used
            </h2>
            <table className="w-full border-collapse border border-black mb-6">
              <thead>
                <tr>
                  <th className="border border-black px-2 py-1 text-left text-sm font-bold bg-zinc-100">
                    Equipment
                  </th>
                  <th className="border border-black px-2 py-1 text-left text-sm font-bold bg-zinc-100">
                    Serial Number
              ...
              <tbody>
                ...
                <tr>
                  <td className="border border-black px-2 py-1 text-sm">
                    {formData.testEquipment.primaryInjectionTestSet.name ||
                      "Primary Inj Test Set"}
                  </td>
                  <td className="border border-black px-2 py-1 text-sm">
                    {
                      formData.testEquipment.primaryInjectionTestSet
                        .serialNumber
                    }
                  </td>
                  <td className="border border-black px-2 py-1 text-sm">
                    {formData.testEquipment.primaryInjectionTestSet.ampId}
                  </td>
                  <td className="border border-black px-2 py-1 text-sm">
                    {formData.testEquipment.primaryInjectionTestSet.calDate}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="mb-6 print:hidden">
            ...
            <div className="mb-4">
              <textarea
                ...
                readOnly={!isEditing}
                className={`form-textarea w-full ${!isEditing ? "bg-zinc-100 dark:bg-dark-150" : ""}`}
                rows={4}
              />
            </div>
          </div>
            ...
            <div className="hidden print:block">
              ...
              <table className="w-full border-collapse border border-black mb-6">
                <tbody>
                  <tr>
                    <td
                      className="border border-black px-4 py-8 text-sm align-top"
                      style={{
                        minHeight: "150px",
                        height: "150px",
                        whiteSpace: "pre-wrap",
