      ...
      <div className="p-6 flex justify-center">
        <div className="max-w-7xl w-full space-y-6">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-start max-w-[100%]">
                ...
                <div className="w-full">
                  <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
                    ...
                    <thead>
                      <tr>
                        <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-700 dark:text-white">
                          Value Deviation
                        </th>
          ...
          <div className="mb-6">
                        ...
                        <td className="px-3 py-2">
                          <div className="print:hidden">
                            <input
                              ...
                              readOnly={!isEditing}
                              className={`block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white text-sm ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                            />
                          </div>
                          <div className="hidden print:block text-center">
                            {row.busSection}
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <select
                ...
                disabled={!isEditing}
                className={`form-select w-20 ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
              >
                {INSULATION_RESISTANCE_UNITS.map((u) => (
                  <option key={u} value={u}>
                    {u}
              ...
              <select
                ...
                disabled={!isEditing}
                className={`form-select w-36 ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
              >
          ...
          <div className="mb-6">
            <div className="w-full h-1 bg-[#f26722] mb-4"></div>
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2 print:text-black print:border-black print:font-bold flex-grow">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  readOnly={!isEditing}
                  className={`form-input w-28 ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                />
                {isEditing && (
                  <button
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 print:hidden">
