  ...
  return (
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      */}
      ...
      <div
        className="print:flex hidden items-center justify-between border-b-2 border-gray-800 pb-4 mb-6 relative"
        style={{
          overflow: "visible",
          paddingLeft: "0.5rem",
          paddingRight: "0.5rem",
            ...
            <div className="grid grid-cols-5 gap-x-10 gap-y-5 print:hidden">
              <div className="flex flex-col min-w-0">
                ...
                <input
                  ...
                  readOnly
                  className="form-input bg-gray-100 dark:bg-dark-150 w-full min-w-0"
                />
              </div>
              <div className="flex flex-col min-w-0">
                ...
                <input
                  ...
                  readOnly={!isEditing}
                  className={`form-input w-full min-w-0 ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                />
              </div>
              <div className="flex flex-col min-w-0">
              ...
              <div className="col-span-5 grid grid-cols-4 gap-x-10 gap-y-0 pt-1">
                <div className="flex flex-col min-w-0">
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      readOnly={!isEditing}
                      className={`form-input w-10 text-sm py-1 ${!isEditing ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                    />
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <input
                    ...
                    readOnly
                    className="form-input bg-gray-100 dark:bg-dark-150 w-10 text-sm py-1"
                  />
                </div>
              </div>
            </div>
                              ...
                              {tripConfig.showSettingColumn && (
                                <td className="border border-gray-300 dark:border-gray-600 px-2 py-1">
                                  {showSetting ? (
                                    ...
                                    <div className="w-full p-1 text-center text-gray-400">
                                      -
                                    </div>
                                  )}
                                </td>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    <th
                      className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-center text-sm font-medium text-gray-900 dark:text-white"
                      colSpan={4}
                    >
                  ...
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 px-2 py-1">
                      <input
                        ...
                        readOnly={!isEditing}
                        className={`w-full p-1 border border-gray-300 dark:border-gray-600 rounded text-center dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-gray-100" : ""}`}
                      />
                    </td>
                    <td className="border border-gray-300 dark:border-gray-600 px-2 py-1">
                      <input
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-center text-sm text-gray-900 dark:text-white">
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-center">
                      <span
                        className={`font-medium ${contactResResults.result === "PASS" ? "text-green-600 result-pass" : contactResResults.result === "FAIL" ? "text-red-600 result-fail" : "text-gray-900 dark:text-white"}`}
                      >
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 text-xs table-fixed">
                ...
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    <th
                      className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs font-medium text-gray-900 dark:text-white"
                      rowSpan={2}
                    >
                      Test Points
                    </th>
                  ...
                  <tr>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs font-medium text-gray-900 dark:text-white">
                      P1 (P1-P2)
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs font-medium text-gray-900 dark:text-white">
                      P2 (P2-P3)
                ...
                <tbody className="bg-white dark:bg-dark-150">
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-xs text-gray-900 dark:text-white">
                      Pole to Pole
                    </td>
                    <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs text-gray-900 dark:text-white">
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                      <input
                        ...
                        readOnly={!isEditing}
                        className={`w-full p-1 border-0 text-center text-xs dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-gray-50" : "bg-white"}`}
                      />
                    </td>
                    <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                      <input
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 bg-gray-100 dark:bg-gray-700">
            ...
            <div className="mt-2">
              <table className="border-collapse border border-gray-300 dark:border-gray-600 text-xs">
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white">
                      Test Points
                    </th>
                    <th
                      className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white"
                      colSpan={2}
                    >
              ...
              <div className="flex flex-wrap gap-4 mb-4 items-start">
                ...
                <div className="flex-grow">
                  {(() => {
                    ...
                    const disabledSpan = (
                      <span className="block w-16 p-1 text-center text-xs text-gray-400">
                        -
                      </span>
                    );
                    ...
                    const renderRow = (
                      ...
                      return (
                        <tr key={dataKey} className={rowClass}>
                          <td
                            className={`border border-gray-300 dark:border-gray-600 px-2 py-1 text-xs ${rowClass}`}
                          >
                            {row.label}
                          </td>
                          <td
                            className={`border border-gray-300 dark:border-gray-600 px-1 py-1 ${!row.showSetting ? disabledCellClass : ""}`}
                          >
                            {row.showSetting ? (
                              <input
                                type="text"
                          ...
                          <td
                            className={`border border-gray-300 dark:border-gray-600 px-1 py-1 ${!row.showDelay ? disabledCellClass : ""}`}
                          >
                            {row.showDelay ? (
                              <input
                                type="text"
                          ...
                          <td
                            className={`border border-gray-300 dark:border-gray-600 px-1 py-1 ${!row.showI2t ? disabledCellClass : ""}`}
                          >
                            {row.showI2t ? (
                              row.useTextI2t ? (
                                <input
                ...
                <div className="overflow-x-auto">
                  <table className="border-collapse border border-gray-300 dark:border-gray-600 text-xs align-top">
                    <thead className="bg-gray-50 dark:bg-dark-150">
                      ...
                      "Secondary Injection" ? (
                        <tr>
                          <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-24">
                            Function
                          </th>
                          <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-16">
                            Setting
                            <br />
                            Amperes
                          </th>
                        ...
                        <>
                          <tr>
                            <th
                              className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-16"
                              rowSpan={2}
                            >
                              Function
                            </th>
                            ...
                            <th
                              className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-20"
                              rowSpan={2}
                            >
                              %<br />
                              Tolerance
                        ...
                        .map((test) => {
                          ...
                          if (
                            ...
                            return (
                              <tr key={originalIndex} className={secRowBgClass}>
                                <td
                                  className={`border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs text-gray-900 dark:text-white font-medium ${secRowBgClass}`}
                                >
                                  {secDisplayName}
                                </td>
                                <td
                                  className={`border border-gray-300 dark:border-gray-600 px-1 py-1 text-center ${secRowBgClass}`}
                                >
                                  {isRowDisabled ? (
                                    <span
                                      className={`${spanClass} text-gray-400`}
                                    >
                                      -
                                    </span>
                                  ) : (
                          ...
                          return (
                            <tr key={originalIndex} className={rowBgClass}>
                              <td
                                className={`border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs text-gray-900 dark:text-white font-medium ${rowBgClass}`}
                              >
                                {displayName}
                              </td>
                              <td
                                className={`border border-gray-300 dark:border-gray-600 px-1 py-1 text-center ${rowBgClass}`}
                              >
                                {isRowDisabled ? (
                                  <span
                                    className={`${spanClass} text-gray-400`}
                              ...
                              >
                                {isRowDisabled ? (
                                  ...
                                  <div className="flex items-center justify-center h-6">
                                    ...
                                    />
                                    <span className="text-xs font-normal text-gray-500 mx-0.5">
                                      |
                                    </span>
                                    <input
                                      type="text"
                              ...
                              <td
                                className={`border border-gray-300 dark:border-gray-600 px-1 py-1 text-center ${rowBgClass} ${!isRowDisabled ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                              >
                                {isRowDisabled ? (
                                  <span
                                    className={`${spanClass} text-gray-400`}
                              ...
                              <td
                                className={`border border-gray-300 dark:border-gray-600 px-1 py-1 text-center ${rowBgClass} ${["LTPU", "STPU", "INST-PU", "GFPU"].includes(test.function) && !isRowDisabled ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                              >
                                {isRowDisabled ? (
                                  <span
                                    className={`${spanClass} text-gray-400`}
                ...
                <div className="overflow-x-auto">
                  <table className="border-collapse border border-gray-300 dark:border-gray-600 text-xs align-top">
                    <thead className="bg-gray-50 dark:bg-dark-150">
                      ...
                      "Secondary Injection" ? (
                        <tr>
                          <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-20">
                            Pole 1
                          </th>
                          <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-medium text-gray-900 dark:text-white w-20">
                            Pole 2
                      ...
                      {formData.currentSensing.tests
                        ...
                        .map((test) => {
                          ...
                          return (
                            <tr key={originalIndex} className={rowBgClass}>
                              <td
                                className={`border border-gray-300 dark:border-gray-600 px-1 py-1 ${rowBgClass}`}
                              >
                                {isRowDisabled ? (
                                  <span
                                    className={`${spanClass} text-gray-400`}
                                  ...
                                  <div className="flex items-center justify-center h-6">
                                    ...
                                    />
                                    <span className="text-xs text-gray-500 print:hidden ml-0.5">
                                      {poleUnit}
                                    </span>
                      ...
                      <tr key={row.formKey}>
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-2 py-1">
                          <input
                            ...
                            readOnly={!isEditing}
                            className={`w-full p-1 border border-gray-300 dark:border-gray-600 rounded dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-gray-100" : ""}`}
                          />
                        </td>
                        <td className="border border-gray-300 dark:border-gray-600 px-2 py-1">
                          <input
          ...
          {!formData.irDlroOnly && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:break-inside-avoid">
              <div className="bg-gray-50 dark:bg-dark-200 p-4 border border-gray-200 dark:border-gray-700">
                ...
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 mt-3">
                  I²t Options
                </h3>
