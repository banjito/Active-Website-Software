        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {categories.length === 0 ? (
            <li className="px-4 py-4 sm:px-6">
              <p className="text-sm text-gray-500 dark:text-white">No categories found. Create one to get started.</p>
            </li>
          ) : (
              ...
              <li key={category.id} className="px-4 py-4 sm:px-6 flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-white">{category.description}</p>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="pt-3">
                  <div className="flex justify-between items-center">
                    <button
                      ...
                      className="inline-flex items-center text-sm text-gray-600 dark:text-white hover:text-gray-900 dark:hover:text-white"
                    >
                  ...
                  {showRules && (
                    <div className="mt-3 space-y-3">
                      ...
                      {formData.rules && formData.rules.length > 0 ? (
                          ...
                          {formData.rules.map((rule, index) => (
                            <div key={index} className="flex items-center space-x-2">
                              <select
                                ...
                                className="block w-1/3 rounded-md border-gray-300 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] sm:text-sm dark:bg-dark-150 dark:border-gray-600 dark:text-white"
                              >
                        ...
                        <p className="text-sm text-gray-500 dark:text-white">No rules defined.</p>
                      )}
              ...
              <div className="mt-6 flex justify-end space-x-3">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#f26722] dark:bg-dark-150 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600"
                >
                  Cancel
                </button>
                <button
