                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead>
                        <tr className="bg-gray-50 dark:bg-dark-200">
                          <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 w-32">Test</th>
                          <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-16">kV</th>
                          <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-20">0.5 Min.</th>
                          <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-20">1 Min.</th>
                          <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-20">10 Min.</th>
                          <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-16">Unit</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                          <td className="px-2 py-2 text-xs text-gray-900 dark:text-white">
                            <div className="leading-tight">Primary to Ground</div>
                          </td>
                          <td className="px-1 py-2">
                            <select
                              ...
                              disabled={!isEditing}
                              className={`w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-200' : ''}`}
                            >
                        ...
                        <tr>
                          <td className="px-2 py-2 text-xs text-gray-900 dark:text-white">
                            <div className="leading-tight">Secondary to Ground</div>
                          </td>
                          <td className="px-1 py-2">
                            <select
                        ...
                        <tr>
                          <td className="px-2 py-2 text-xs text-gray-900 dark:text-white">
                            <div className="leading-tight">Primary to Secondary</div>
                          </td>
                          <td className="px-1 py-2">
                            <select
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      ...
                      <tr>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToGround.corrected.halfMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToGround.corrected.oneMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToGround.corrected.tenMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToGround.unit} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                      </tr>
                      {/* Secondary to Ground */}
                      <tr>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.secondaryToGround.corrected.halfMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.secondaryToGround.corrected.oneMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.secondaryToGround.corrected.tenMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.secondaryToGround.unit} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                      </tr>
                      {/* Primary to Secondary */}
                      <tr>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToSecondary.corrected.halfMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToSecondary.corrected.oneMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToSecondary.corrected.tenMinute} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                        <td className="px-1 py-2">
                          <input type="text" value={formData.insulationResistance.primaryToSecondary.unit} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr className="bg-gray-50 dark:bg-dark-200">
                    <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 w-48">Calculated Values</th>
                    <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-24">Primary</th>
                    <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-24">Secondary</th>
                    <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-24">Pri-Sec</th>
                    <th className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 w-24">Acceptable</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  <tr>
                    <td className="px-2 py-2 text-xs text-gray-900 dark:text-white">
                      <div className="font-medium">Dielectric Absorption</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 leading-tight">(Ratio of 1 Min. to 0.5 Minute Result)</div>
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.primaryToGround.dielectricAbsorption} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.secondaryToGround.dielectricAbsorption} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.primaryToSecondary.dielectricAbsorption} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input
                        type="text"
                        ...
                        readOnly
                        className={`w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm ${
                  ...
                  <tr>
                    <td className="px-2 py-2 text-xs text-gray-900 dark:text-white">
                      <div className="font-medium">Polarization Index</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 leading-tight">(Ratio of 10 Min. to 1 Min. Result)</div>
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.primaryToGround.polarizationIndex} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.secondaryToGround.polarizationIndex} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input type="text" value={formData.insulationResistance.primaryToSecondary.polarizationIndex} readOnly className="w-full text-xs text-center rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white" />
                    </td>
                    <td className="px-1 py-2">
                      <input
                        type="text"
  ...
  style.textContent = `
    @media print {
      ...
      *[class*="Back to Job"], 
      ...
      /* Form elements - clean appearance without interactive controls */
      ...
      /* Section styling for better page breaks */
      section { 
      ...
      .space-y-2 > * + * { margin-top: 10px !important; }
