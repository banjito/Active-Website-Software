...
interface CorrectedInsulationResistance extends Omit<
  InsulationResistance,
  "tcf" | "correctedGround" | "correctedOther"
> {
...
interface VFIData {
  ...
  aicRating: string; // Added SCCR to match image
...
interface FormData {
  ...
  testEquipment_megohmmeter_calDate: string;
...
const VISUAL_INSPECTION_DEFINITIONS = [
  ...
  {
    netaSection: "7.1.1.5",
    description: "Shipping braces and circuit-switcher removable supports",
  },
  { netaSection: "7.1.1.6", description: "Arc chute assemblies" },
  {
    netaSection: "7.1.1.7",
    description: "Blade alignment and blade penetration",
  },
  ...
  {
    netaSection: "7.1.1.12",
    description: "Lubrication of moving current-carrying parts",
  },
  {
    netaSection: "7.1.1.13",
    description: "Lubrication of moving and sliding surfaces",
  },
...
export default function MediumVoltageSwitchOilReport() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    s1_correctedInsulationResistance: {
      ...initialCorrectedWaySectionInsulation,
    },
    s2_correctedInsulationResistance: {
      ...initialCorrectedWaySectionInsulation,
    },
    t1_correctedInsulationResistance: {
      ...initialCorrectedWaySectionInsulation,
    },
    t2_correctedInsulationResistance: {
      ...initialCorrectedWaySectionInsulation,
    },
    t3_correctedInsulationResistance: {
      ...initialCorrectedWaySectionInsulation,
    },
  ...
  useEffect(() => {
    const loadReport = async () => {
      ...
      try {
        ...
        if (data) {
          console.log("🔍 MediumVoltageSwitchOilReport - Loading report data:");
          console.log("  - Raw data:", data);
          console.log("  - report_info:", data.report_info);
          console.log(
            "  - insulation_resistance_measured:",
            data.insulation_resistance_measured,
          );
          console.log(
            "  - temp_corrected_insulation:",
            data.temp_corrected_insulation,
          );
          ...
          console.log("  - dielectric_s1t2:", data.dielectric_s1t2);
          console.log("  - dielectric_s1t3:", data.dielectric_s1t3);
          console.log("  - vfi_test_rows:", data.vfi_test_rows);
          console.log("  - test_equipment:", data.test_equipment);

          // Merge all columns into the expected formData structure
          const newFormData = {
            ...
            eqptLocation:
              data.report_info?.eqptLocation || formData.eqptLocation,
            ...
            // Visual Inspection
            visualInspectionResults:
              data.visual_mechanical_inspection?.items ||
            ...
            s1_insulationResistance: data.insulation_resistance_measured?.s1
              ...
              : {
                  ...formData.s1_insulationResistance,
                  testVoltage:
                    data.insulation_resistance_measured?.testVoltage ||
                    formData.s1_insulationResistance.testVoltage,
                  ag:
                    data.insulation_resistance_measured?.rows?.find(
                      (r) => r.way === "S1",
                    )?.ag || "",
                  bg:
                    data.insulation_resistance_measured?.rows?.find(
            ...
            s2_insulationResistance: data.insulation_resistance_measured?.s2
              ...
              : {
                  ...
                  testVoltage:
                    data.insulation_resistance_measured?.testVoltage ||
                    formData.s2_insulationResistance.testVoltage,
                  ag:
                    data.insulation_resistance_measured?.rows?.find(
                      (r) => r.way === "S2",
                    )?.ag || "",
            ...
            t1_insulationResistance: data.insulation_resistance_measured?.t1
              ...
              : {
                  ...
                  testVoltage:
                    data.insulation_resistance_measured?.testVoltage ||
                    formData.t1_insulationResistance.testVoltage,
                  ag:
                    data.insulation_resistance_measured?.rows?.find(
                      (r) => r.way === "T1",
                    )?.ag || "",
            ...
            t2_insulationResistance: data.insulation_resistance_measured?.t2
              ...
              : {
                  ...
                  testVoltage:
                    data.insulation_resistance_measured?.testVoltage ||
                    formData.t2_insulationResistance.testVoltage,
                  ag:
                    data.insulation_resistance_measured?.rows?.find(
                      (r) => r.way === "T2",
                    )?.ag || "",
            ...
            t3_insulationResistance: data.insulation_resistance_measured?.t3
              ...
              : {
                  ...
                  testVoltage:
                    data.insulation_resistance_measured?.testVoltage ||
                    formData.t3_insulationResistance.testVoltage,
                  ag:
                    data.insulation_resistance_measured?.rows?.find(
                      (r) => r.way === "T3",
                    )?.ag || "",
            ...
            s1_contactResistance: data.contact_resistance?.s1
              ...
              : {
                  ...formData.s1_contactResistance,
                  aPhase:
                    data.contact_resistance?.rows?.find((r) => r.way === "S1")
                      ?.aPhase || "",
                  aGround:
                    data.contact_resistance?.rows?.find((r) => r.way === "S1")
                      ?.aGround || "",
            ...
            s2_contactResistance: data.contact_resistance?.s2
              ...
              : {
                  ...formData.s2_contactResistance,
                  aPhase:
                    data.contact_resistance?.rows?.find((r) => r.way === "S2")
                      ?.aPhase || "",
                  aGround:
                    data.contact_resistance?.rows?.find((r) => r.way === "S2")
                      ?.aGround || "",
            ...
            t1_contactResistance: data.contact_resistance?.t1
              ...
              : {
                  ...formData.t1_contactResistance,
                  aPhase:
                    data.contact_resistance?.rows?.find((r) => r.way === "T1")
                      ?.aPhase || "",
                  aGround:
                    data.contact_resistance?.rows?.find((r) => r.way === "T1")
                      ?.aGround || "",
            ...
            t2_contactResistance: data.contact_resistance?.t2
              ...
              : {
                  ...formData.t2_contactResistance,
                  aPhase:
                    data.contact_resistance?.rows?.find((r) => r.way === "T2")
                      ?.aPhase || "",
                  aGround:
                    data.contact_resistance?.rows?.find((r) => r.way === "T2")
                      ?.aGround || "",
            ...
            t3_contactResistance: data.contact_resistance?.t3
              ...
              : {
                  ...formData.t3_contactResistance,
                  aPhase:
                    data.contact_resistance?.rows?.find((r) => r.way === "T3")
                      ?.aPhase || "",
                  aGround:
                    data.contact_resistance?.rows?.find((r) => r.way === "T3")
                      ?.aGround || "",
            ...
            dielectricWaySectionTests: [
              {
                waySection: "S1-S2",
                testVoltageApplied: data.dielectric_s1s2?.testVoltage || "",
                ag: data.dielectric_s1s2?.ag || "",
                bg: data.dielectric_s1s2?.bg || "",
                cg: data.dielectric_s1s2?.cg || "",
                units: data.dielectric_s1s2?.units || "mA",
                duration: 60,
                result: "PASS",
              },
              {
                waySection: "S1-T1",
                testVoltageApplied: data.dielectric_s1t1?.testVoltage || "",
                ag: data.dielectric_s1t1?.ag || "",
                bg: data.dielectric_s1t1?.bg || "",
                cg: data.dielectric_s1t1?.cg || "",
                units: data.dielectric_s1t1?.units || "mA",
                duration: 60,
                result: "PASS",
              },
              {
                waySection: "S1-T2",
                testVoltageApplied: data.dielectric_s1t2?.testVoltage || "",
                ag: data.dielectric_s1t2?.ag || "",
                bg: data.dielectric_s1t2?.bg || "",
                cg: data.dielectric_s1t2?.cg || "",
                units: data.dielectric_s1t2?.units || "mA",
                duration: 60,
                result: "PASS",
              },
              {
                waySection: "S1-T3",
                testVoltageApplied: data.dielectric_s1t3?.testVoltage || "",
                ag: data.dielectric_s1t3?.ag || "",
                bg: data.dielectric_s1t3?.bg || "",
                cg: data.dielectric_s1t3?.cg || "",
                units: data.dielectric_s1t3?.units || "mA",
                duration: 60,
                result: "PASS",
              },
            ],
            ...
            testEquipment_megohmmeter_megger:
              data.test_equipment?.megohmmeter?.model ||
              data.test_equipment?.megohmmeter?.name ||
              "",
            testEquipment_megohmmeter_serialNo:
              data.test_equipment?.megohmmeter?.serialNumber || "",
            testEquipment_megohmmeter_ampId:
              data.test_equipment?.megohmmeter?.ampId || "",
            testEquipment_lowResistance_model:
              data.test_equipment?.lowResistance?.model ||
              data.test_equipment?.lowResistanceOhmmeter?.name ||
              "",
            testEquipment_lowResistance_serialNo:
              data.test_equipment?.lowResistance?.serialNumber ||
              data.test_equipment?.lowResistanceOhmmeter?.serialNumber ||
              "",
            testEquipment_lowResistance_ampId:
              data.test_equipment?.lowResistance?.ampId ||
              data.test_equipment?.lowResistanceOhmmeter?.ampId ||
              "",
            testEquipment_hipot_model:
              data.test_equipment?.hipot?.model ||
              data.test_equipment?.primaryInjectionTestSet?.name ||
              "",
            testEquipment_hipot_serialNo:
              data.test_equipment?.hipot?.serialNumber ||
              data.test_equipment?.primaryInjectionTestSet?.serialNumber ||
              "",
            testEquipment_hipot_ampId:
              data.test_equipment?.hipot?.ampId ||
              data.test_equipment?.primaryInjectionTestSet?.ampId ||
              "",
          };
  ...
  const handleNestedObjectFieldChange = <K extends keyof FormData>(
    ...
    setFormData((prev) => {
      ...
      console.warn(
        `Attempted to set field '''${String(field)}''' on a non-object section '''${String(sectionName)}'''.`,
      );
      return prev;
    });
  };
  ...
  const handleSave = async () => {
    ...
    if (!jobId || !user?.id || !isEditMode) {
      console.log("Save prevented due to:", {
        jobId,
        userId: user?.id,
        isEditMode,
      });
    ...
    try {
      ...
      const reportData = {
        ...
        dielectric_s1s2: formData.dielectricWaySectionTests.find(
          (t) => t.waySection === "S1-S2",
        ),
        dielectric_s1t1: formData.dielectricWaySectionTests.find(
          (t) => t.waySection === "S1-T1",
        ),
        dielectric_s1t2: formData.dielectricWaySectionTests.find(
          (t) => t.waySection === "S1-T2",
        ),
        dielectric_s1t3: formData.dielectricWaySectionTests.find(
          (t) => t.waySection === "S1-T3",
        ),
      ...
      <div className="p-6 flex justify-center">
        <div className="max-w-7xl w-full space-y-6">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 print:hidden job-info-onscreen">
              <div>
                ...
                <input
                  ...
                  readOnly={!isEditMode}
                  className={`block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white text-base ${!isEditMode ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-white mb-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      readOnly={!isEditMode}
                      className={`block w-20 rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-150 dark:text-white text-base ${!isEditMode ? "bg-gray-100 dark:bg-dark-150" : ""}`}
                    />
                    <span className="text-gray-600 dark:text-white">°F</span>
                    <input
                      type="number"
                      value={(((formData.temperature - 32) * 5) / 9).toFixed(0)}
                      readOnly
                      className="block w-16 rounded-md border-gray-300 dark:border-gray-700 shadow-sm bg-gray-100 dark:bg-dark-150 text-gray-600 dark:text-white text-base"
                    />
                    <span className="text-gray-600 dark:text-white">°C</span>
                    <span className="text-gray-600 dark:text-white ml-4">
                      TCF
                    </span>
                    <input
                      type="number"
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden nameplate-onscreen">
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_manufacturer}
                  onChange={(e) =>
                    handleChange("nameplate_manufacturer", e.target.value)
                  }
                  readOnly={!isEditMode}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_systemVoltage}
                  onChange={(e) =>
                    handleChange("nameplate_systemVoltage", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_catalogNo}
                  onChange={(e) =>
                    handleChange("nameplate_catalogNo", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_ratedVoltage}
                  onChange={(e) =>
                    handleChange("nameplate_ratedVoltage", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_serialNumber}
                  onChange={(e) =>
                    handleChange("nameplate_serialNumber", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_ratedCurrent}
                  onChange={(e) =>
                    handleChange("nameplate_ratedCurrent", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_dateOfMfg}
                  onChange={(e) =>
                    handleChange("nameplate_dateOfMfg", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_aicRating}
                  onChange={(e) =>
                    handleChange("nameplate_aicRating", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_type}
                  onChange={(e) =>
                    handleChange("nameplate_type", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.nameplate_impulseLevelBIL}
                  onChange={(e) =>
                    handleChange("nameplate_impulseLevelBIL", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 print:hidden vfi-data-onscreen">
              <div>
                ...
                <input
                  type="text"
                  value={formData.vfiData.manufacturer}
                  onChange={(e) =>
                    handleChange("vfiData", {
                      ...formData.vfiData,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.vfiData.ratedVoltage}
                  onChange={(e) =>
                    handleChange("vfiData", {
                      ...formData.vfiData,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.vfiData.catalogNo}
                  onChange={(e) =>
                    handleChange("vfiData", {
                      ...formData.vfiData,
                      catalogNo: e.target.value,
                    })
                  }
                  readOnly={!isEditMode}
                  className="form-input"
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.vfiData.ratedCurrent}
                  onChange={(e) =>
                    handleChange("vfiData", {
                      ...formData.vfiData,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.vfiData.aicRating}
                  onChange={(e) =>
                    handleChange("vfiData", {
                      ...formData.vfiData,
                      aicRating: e.target.value,
                    })
                  }
                  readOnly={!isEditMode}
                  className="form-input"
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              ...
              >
                ...
                <thead>
                  <tr>
                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">
                      WAY SECTION
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">
                      A-G
                ...
                <tbody>
                  {(["s1", "s2", "t1", "t2", "t3"] as const).map((wayKey) => {
                    ...
                    const handleInsulationChange = (
                      field: keyof InsulationResistance,
                      value: string | number,
                    ) => {
                    ...
                    return (
                      <tr key={wayKey}>
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs font-medium">
                          {wayKey.toUpperCase()}
                        </td>
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("ag", e.target.value)
                            }
                            readOnly={!isEditMode}
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("bg", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("cg", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("ab", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("bc", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("ca", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("lineA", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("lineB", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                          <input
                            ...
                            onChange={(e) =>
                              handleInsulationChange("lineC", e.target.value)
                            }
                            readOnly={!isEditMode}
                            className="w-full h-6 text-center border-none bg-transparent focus:outline-none text-sm"
                          />
                        </td>
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs">
                          {currentData.units}
                        </td>
                      </tr>
                    );
            ...
            <div className="overflow-x-auto">
              ...
              >
                ...
                <tbody>
                  {(["s1", "s2", "t1", "t2", "t3"] as const).map((wayKey) => {
                    const dataKey =
                      `${wayKey}_correctedInsulationResistance` as const;
                    const currentData = formData[dataKey];
                    return (
                      <tr key={wayKey}>
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-xs font-medium">
                        ...
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-sm">
                          {currentData.ag}
                        </td>
                        <td className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-center text-sm">
                          {currentData.bg}
              ...
              >
                ...
                <tbody>
                  {(["s1", "s2", "t1", "t2", "t3"] as const).map((wayKey) => {
                    ...
                    const currentData = formData[dataKey];
                    const handleContactResistanceChange = (
                      field: keyof ContactResistance,
                      value: string | number,
                    ) => {
                      handleChange(dataKey, { ...currentData, [field]: value });
                    };
          ...
          <section className="mb-6">
            ...
            <h3 className="text-lg font-semibold my-3 text-gray-800 dark:text-gray-200">
            ...
            <div className="mb-4">
              <div className="flex items-center mb-2">
                ...
                <input
                  type="text"
                  value={
                    formData.dielectricWaySectionTests[0]?.testVoltageApplied ||
                    "30 KVAC"
                  }
                  onChange={(e) => {
                    const newValue = e.target.value;
                    const updatedTests = formData.dielectricWaySectionTests.map(
                      (test) => ({
                        ...test,
                    ...
                    <tr key={index}>
                      ...
                      <td className="border border-gray-300 dark:border-gray-600 px-1 py-1">
                        <input
                          ...
                          onChange={(e) => {
                            const newTests = [
                              ...formData.dielectricWaySectionTests,
                            ];
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              ...
              >
                ...
                <thead>
                  <tr>
                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                    <th
                      colSpan={2}
                      className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"
                    >
                      Counter
                    </th>
                    <th
              ...
              {isEditMode && (
                <button
                  ...
                  onClick={() => {
                    ...
                    handleChange("dielectricVFITests", [
                      ...formData.dielectricVFITests,
                      newVFITestEntry,
                    ]);
                  }}
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 mb-4 print:hidden test-eqpt-onscreen">
              <div>
                ...
                <EquipmentAutocomplete
                  value={formData.testEquipment_megohmmeter_megger}
                  onChange={(value) =>
                    handleChange("testEquipment_megohmmeter_megger", value)
                  }
                  onSelect={(equipment) => {
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_megohmmeter_serialNo}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_megohmmeter_serialNo",
                      e.target.value,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_megohmmeter_ampId}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_megohmmeter_ampId",
                      e.target.value,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_megohmmeter_calDate}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_megohmmeter_calDate",
                      e.target.value,
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 mb-4 print:hidden test-eqpt-onscreen">
              <div>
                ...
                <EquipmentAutocomplete
                  value={formData.testEquipment_lowResistance_model}
                  onChange={(value) =>
                    handleChange("testEquipment_lowResistance_model", value)
                  }
                  onSelect={(equipment) => {
                    const formatDate = (dateString: string | null): string => {
                      if (!dateString) return "";
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_lowResistance_serialNo}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_lowResistance_serialNo",
                      e.target.value,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_lowResistance_ampId}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_lowResistance_ampId",
                      e.target.value,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_lowResistance_calDate}
                  onChange={(e) =>
                    handleChange(
                      "testEquipment_lowResistance_calDate",
                      e.target.value,
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 print:hidden test-eqpt-onscreen">
              <div>
                <label className="form-label">Hipot - Model</label>
                <EquipmentAutocomplete
                  value={formData.testEquipment_hipot_model}
                  onChange={(value) =>
                    handleChange("testEquipment_hipot_model", value)
                  }
                  onSelect={(equipment) => {
                    const formatDate = (dateString: string | null): string => {
                      if (!dateString) return "";
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_hipot_serialNo}
                  onChange={(e) =>
                    handleChange("testEquipment_hipot_serialNo", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_hipot_ampId}
                  onChange={(e) =>
                    handleChange("testEquipment_hipot_ampId", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.testEquipment_hipot_calDate}
                  onChange={(e) =>
                    handleChange("testEquipment_hipot_calDate", e.target.value)
                  }
                  readOnly={!isEditMode}
                  className="form-input"
                />
