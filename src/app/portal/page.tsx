        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              {isNotificationsOpen && (
                <div className="absolute right-0 mt-2 w-96 max-w-[24rem] origin-top-right rounded-md bg-white dark:bg-dark-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {notifLoading ? (
                      ...
                      <div>
                        <div className="px-4 py-2 text-xs text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-dark-200 flex items-center justify-between">
                          <span>
                              ...
                              <div key={jg.jobId} className="px-4 py-3">
                                <div className="flex items-start justify-between gap-3">
                                  <div className="min-w-0">
                                    ...
                                    <div className="text-xs text-gray-600 dark:text-gray-400">{jg.count} reports • Oldest {new Date(jg.oldest).toLocaleString()}</div>
                                  </div>
                                  {detailStatus && (
                                    <button
            ...
            <div className="relative" ref={profileMenuRef}>
              <button
                className="rounded-full w-10 h-10 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 p-0 overflow-hidden flex items-center justify-center border border-gray-300 dark:border-gray-600"
