  ...
  (
    ...
    return (
      <div className={`${fullWidth ? "w-full" : ""} mb-4`}>
        ...
        <div className="relative">
          {leftIcon && (
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <span className="text-dark-primary/60 dark:text-dark-secondary/60">
                {leftIcon}
              </span>
            </div>
          )}
          ...
          <input
            ...
            id={inputId}
            className={`
              w-full px-4 py-2.5 bg-white dark:bg-dark-150 text-dark-primary dark:text-dark-secondary
        ...
        {(error || hint) && (
          <p
            className={`mt-1.5 text-sm ${error ? "text-red-500" : "text-dark-primary/60 dark:text-dark-secondary/60"}`}
          >
            {error || hint}
          </p>
        )}
