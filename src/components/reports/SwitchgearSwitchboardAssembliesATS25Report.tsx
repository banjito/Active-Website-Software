...
const SwitchgearSwitchboardAssembliesATS25Report: React.FC = () => {
  ...
  const loadJobInfo = async () => {
    ...
    try {
      ...
      setFormData(prev => ({ ...prev, jobNumber: jobData?.job_number || '', customerName, customerLocation: customerAddress }));
    } catch (e) { /* noop */ }
  };
    ...
    setFormData(prev => ({
      ...
      tempCorrected: prev.insulationMeasured.map(row => {
        ...
        (['ag','bg','cg','ab','bc','ca','an','bn','cn'] as (keyof InsulationRow)[]).forEach(k => {
          ...
          if (!v || v.toLowerCase() === 'n/a' || v.startsWith('>') || v.startsWith('<')) {
            (out as any)[k] = v || 'N/A';
          } else {
            const n = parseFloat(v);
            (out as any)[k] = isFinite(n) ? (n * tcf).toFixed(2) : 'N/A';
          }
        });
        return out;
      })
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-4 print:hidden">
              ...
              <div><label className="form-label">AIC Rating (kA)</label><input className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} value={formData.nameplate.aicRating} onChange={e => setFormData(p => ({ ...p, nameplate: { ...p.nameplate, aicRating: e.target.value } }))} readOnly={!isEditing} /></div>
          ...
          <div className="mb-6">
            <div className="w-full h-1 bg-[#f26722] mb-4"></div>
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2 print:text-black print:border-black print:font-bold">Electrical - Contact Resistance Tests</h2>
            <div className="overflow-x-auto">
              {/* Measured table */}
              <table className="min-w-[720px] divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">A-Phase</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">B-Phase</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">C-Phase</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">Neutral</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">Ground</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                  {formData.contactResistance.map((row, i) => (
                    <tr key={i}>
                      <td className="px-3 py-2"><div className="print:hidden"><input value={row.busSection} readOnly className="block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm text-sm dark:text-white" /></div><div className="hidden print:block text-center">{row.busSection}</div></td>
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                <colgroup>
                  <col style={{ width: '12%' }} />
                  {Array.from({ length: 9 }).map((_, i) => (<col key={i} style={{ width: '9.2%' }} />))}
                  <col style={{ width: '8%' }} />
                </colgroup>
                <thead>
                  <tr>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Bus Section</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase" colSpan={9}>Insulation Resistance</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Units</th>
                  </tr>
                  <tr>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                    {['A-G','B-G','C-G','A-B','B-C','C-A','A-N','B-N','C-N'].map(h => (<th key={h} className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">{h}</th>))}
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                ...
                <thead>
                  <tr>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Bus Section</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider" colSpan={3}>Dielectric Withstand</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Units</th>
                  ...
                  <tr>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">A-G</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">B-G</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150 text-center text-xs font-medium">C-G</th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                    <th className="px-3 py-2 bg-gray-50 dark:bg-dark-150"></th>
                  </tr>
                </thead>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-4 print:hidden">
              <div><label className="form-label">Low Resistance Ohmmeter:</label><input className="form-input" value={formData.testEquipment.lowResistanceOhmmeter.name} onChange={e => setFormData(p => ({ ...p, testEquipment: { ...p.testEquipment, lowResistanceOhmmeter: { ...p.testEquipment.lowResistanceOhmmeter, name: e.target.value } } }))} readOnly={!isEditing} /></div>
              ...
              <div><label className="form-label">Megohmmeter:</label><input className="form-input" value={formData.testEquipment.megohmmeter.name} onChange={e => setFormData(p => ({ ...p, testEquipment: { ...p.testEquipment, megohmmeter: { ...p.testEquipment.megohmmeter, name: e.target.value } } }))} readOnly={!isEditing} /></div>
              ...
              <div><label className="form-label">Hipot:</label><input className="form-input" value={formData.testEquipment.hipot.name} onChange={e => setFormData(p => ({ ...p, testEquipment: { ...p.testEquipment, hipot: { ...p.testEquipment.hipot, name: e.target.value } } }))} readOnly={!isEditing} /></div>
