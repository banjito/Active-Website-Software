...
import { Zap, Shield, Truck, Wrench, Users, FileCheck, TrendingUp } from 'lucide-react';
...
export function ArmadilloMetrics({ division }: ArmadilloMetricsProps) {
  ...
  const [armadilloMetrics, setArmadilloMetrics] = useState({
    energyEfficiency: '94.2%',
    safetyScore: '98.7%',
    operationalUptime: '99.1%'
  });
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        console.error('Error loading Armadillo metrics:', error);
      } finally {
        setLoading(false);
      }
    }
  ...
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle className="text-xl">Armadillo Performance Metrics</CardTitle>
        <CardDescription>
          Key metrics for Armadillo Division
        </CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500 dark:text-white">No reports found for this division</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    <div className="grid grid-cols-4 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-white">Total Reports</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold text-green-600">{reportApprovalMetrics.approved}</p>
                        <p className="text-sm text-gray-500 dark:text-white">Approved</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-white">Rejected</p>
                      </div>
                    </div>
                ...
                {loading ? (
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center p-4 bg-gray-50 dark:bg-dark-150 rounded-lg">
