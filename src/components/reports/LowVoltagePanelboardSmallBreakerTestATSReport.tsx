    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div
        className={
          isPrintMode
            ? "hidden"
            : "p-6 flex justify-center bg-gray-50 dark:bg-dark-150 print:hidden"
        }
      >
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6">
            <div className="w-full h-1 bg-[#f26722] mb-4"></div>
            <h2 className="text-xl mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 font-semibold pb-2">
              Nameplate Data
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 nameplate-onscreen">
              {/* Panelboard Column */}
              <div>
                <h3 className="text-lg font-medium mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">
                  Panelboard
                </h3>
          ...
          <div className="mb-6 electrical-tests-section">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 text-xs">
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white w-16">
                      Result
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white w-12">
                      Circuit
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white w-14">
                      Poles
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white w-20">
                      Manuf.
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white w-20">
                      Type
                    ...
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white text-center w-12">
                      Min
                    </th>
                    <th className="border border-gray-300 dark:border-gray-600 px-1 py-1 text-xs font-medium text-gray-900 dark:text-white text-center w-12">
                      Max
