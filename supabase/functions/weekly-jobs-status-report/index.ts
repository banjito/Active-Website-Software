...
// Sends a report of all jobs that are In-Progress, Ready for Billing, and Billed
...
serve(async (req) => {
  ...
  try {
    ...
    const emailSubject = `Weekly Jobs Status Report - ${enrichedJobs.length} Active Jobs`
          ...
          <div class="content">
            <div class="summary">
              <div class="summary-stat">
                ...
                <div class="summary-value">${enrichedJobs.length}</div>
              </div>
              <div class="summary-stat">
            ...
            <div class="status-section">
              <div class="status-section-title">✅ Billed (${billedJobs.length})</div>
...
Summary:
- Total Active Jobs: ${enrichedJobs.length}
