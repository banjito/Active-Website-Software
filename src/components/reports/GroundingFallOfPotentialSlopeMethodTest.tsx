...
const GroundingFallOfPotentialSlopeMethodTest: React.FC = () => {
  ...
  const [groundTestEquipment, setGroundTestEquipment] = useState({
    model: "",
    serialNumber: "",
    ampId: "",
    calDate: "",
  ...
  const reportName =
    getReportName(REPORT_SLUG) ||
    "Grounding Fall of Potential Slope Method Test";

  // Derived distances
  const d40 = useMemo(
    () => (Number.isFinite(dcFeet) ? Number((dcFeet * 0.4).toFixed(2)) : 0),
    [dcFeet],
  );
  const d60 = useMemo(
    () => (Number.isFinite(dcFeet) ? Number((dcFeet * 0.6).toFixed(2)) : 0),
    [dcFeet],
  );
  const d80 = useMemo(
    () => (Number.isFinite(dcFeet) ? Number((dcFeet * 0.8).toFixed(2)) : 0),
    [dcFeet],
  );
  ...
  const groundResistanceAtDp = useMemo(() => {
    ...
    const seg =
      x <= points[1].x ? [points[0], points[1]] : [points[1], points[2]];
      ...
      if (reportId) {
        ...
        if (result.data) {
          ...
          const assetData = {
            name: getAssetName(
              REPORT_SLUG,
              jobInfo.identifier || jobInfo.eqptLocation || "",
            ),
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <section className="p-0 print:hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    readOnly={!isEditing}
                    className={`form-input ${!isEditing ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                  />
                </div>
                <div className="flex items-center">
                  <label className="form-label inline-block w-40">
                ...
                <div className="flex items-center">
                  ...
                  <select
                    value={soil.multipleRods}
                    onChange={(e) =>
                      setSoil((p) => ({ ...p, multipleRods: e.target.value }))
                    }
                    disabled={!isEditing}
                    className={`form-select ${!isEditing ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                  >
                ...
                <div className="flex items-center">
                  ...
                  <input
                    type="text"
                    value={soil.longestDimension}
                    onChange={(e) =>
                      setSoil((p) => ({
                        ...p,
                        longestDimension: e.target.value,
                      }))
                    }
                    readOnly={!isEditing}
                    className={`form-input ${!isEditing ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <label className="form-label inline-block w-56">
                  ...
                  <input
                    ...
                    readOnly={!isEditing}
                    className={`form-input w-40 ${!isEditing ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                  />
                ...
                <div className="mt-4">
                  <div className="text-sm font-semibold mb-2">
                    Calculate Potential Probe Location (Dp)
                  </div>
                  <div className="grid grid-cols-3 gap-3 items-center text-sm">
                    ...
                    <div className="text-neutral-500">40%</div>
                    <div>{d60}</div>
                    <div>
                      <input
                        type="number"
                    ...
                    <div className="text-neutral-500">60%</div>
                    <div>{d80}</div>
                    <div>
                      <input
                        type="number"
                  ...
                  <div className="grid grid-cols-3 gap-3 items-center mt-4">
                    ...
                    <div className="col-span-2">
                      <input
                        ...
                        readOnly
                        value={u.toFixed(2)}
                        className="form-input bg-neutral-100 dark:bg-dark-200"
                      />
                    </div>
                    ...
                    <div className="col-span-2 flex items-center">
                      <input
                        ...
                        className="form-input bg-neutral-100 dark:bg-dark-200 w-40"
                      />
                      <span className="ml-2">Feet</span>
                    </div>
                  </div>
            ...
            <div className="mt-6">
              <div className="font-semibold text-lg mb-2">
                Ground Resistance Measurement at Dp:
              </div>
          ...
          <section className="hidden print:block p-0 mb-6">
            <h2 className="text-xl font-semibold mb-4 text-neutral-900 border-b border-neutral-700 pb-2">
              Grounding Test Data
            </h2>
            <table className="w-full border-collapse mb-4">
              <tbody>
                <tr>
                  <td className="border border-neutral-400 px-3 py-2 font-medium bg-neutral-100 w-1/4">
                    Soil Type
                  </td>
                  <td className="border border-neutral-400 px-3 py-2 w-1/4">
                    {soil.type || "-"}
                  </td>
                  <td className="border border-neutral-400 px-3 py-2 font-medium bg-neutral-100 w-1/4">
                    Soil Conditions
                ...
                <tr>
                  <td className="border border-neutral-400 px-3 py-2 font-medium bg-neutral-100">
                    Rod Depth
                  </td>
            ...
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                  <td className="border border-neutral-400 px-3 py-2 font-medium bg-neutral-100 w-1/3">
                    Distance Of Current Probe (Dc)
                  </td>
                  <td className="border border-neutral-400 px-3 py-2">
                    {dcFeet} Feet
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 print:hidden">
              <div>
                ...
                <EquipmentAutocomplete
                  ...
                  onChange={(v) =>
                    setGroundTestEquipment((p) => ({ ...p, model: v }))
                  }
                  onSelect={(equipment) => {
                    ...
                    setGroundTestEquipment((p) => ({
                      ...
                      calDate: equipment.calibration_date
                        ? (equipment.calibration_date as string).slice(0, 10)
                        : "",
                      calDue: equipment.calibration_due_date
                        ? fmt(equipment.calibration_due_date)
                        : "",
                    }));
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={!isEditing}
                  className={`form-input w-full ${!isEditing ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                />
              </div>
              <div>
