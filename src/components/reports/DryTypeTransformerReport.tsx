...
const DryTypeTransformerReport: React.FC = () => {
  ...
  return (
    <ReportWrapper isPrintMode={isPrintMode}>
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className={`${isPrintMode ? 'hidden' : ''} print:hidden`}>
            {renderHeader()}
                ...
                {/* Job Information */}
      <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-6 print:break-inside-avoid">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    readOnly={true}
                    className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white"
                  />
                </div>
                <div>
      ...
      <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-6 print:break-before-page">
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">Visual and Mechanical Inspection</h2>
          ...
          <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
            <thead>
              <tr>
                <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-left text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600">NETA Section</th>
                <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-left text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600">Description</th>
                <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-left text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600">Result</th>
                <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-left text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600">Comments</th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-dark-150">
                                {formData.visualInspectionItems.map((item, index) => (
                <tr key={index} className="border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600">{item.id}</td>
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600">{item.description}</td>
                  ...
                  <td className="px-4 py-3 border border-gray-300 dark:border-gray-600">
                    <input
                      ...
                      readOnly={!isEditing}
                      className={`block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm focus:ring-gray-500 focus:border-gray-500 text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-200' : ''}`}
                    />
                  </td>
                </tr>
                  ))}
      ...
      <div className="bg-white dark:bg-dark-150 rounded-lg shadow p-6 print:break-before-page">
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">Electrical Tests - Insulation Resistance</h2>
            <div className="space-y-6">
              ...
              <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead className="bg-gray-50 dark:bg-dark-200">
                  <tr>
                    <th colSpan={7} className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">Insulation Resistance Values</th>
                  </tr>
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">Winding Under Test</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">Test Voltage</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">0.5 Min.</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">1 Min.</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">10 Min.</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">Units</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-dark-150">
                      {[
                    ...
                    <tr key={test.id}>
                      <td className="px-4 py-3 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600">{test.label}</td>
                      <td className="px-4 py-3 border border-gray-300 dark:border-gray-600">
                            <select
                              ...
                              disabled={!isEditing}
                              className={`block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm focus:ring-gray-500 focus:border-gray-500 text-gray-900 dark:text-white text-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-200' : ''}`}
                            >
              ...
              <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                <thead className="bg-gray-50 dark:bg-dark-200">
                  <tr>
                    <th colSpan={4} className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">Temperature Corrected Values</th>
                  </tr>
                  <tr>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">0.5 Min.</th>
                    <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">1 Min.</th>
                    ...
                    <tr key={test.id}>
                      <td className="px-4 py-3 border border-gray-300 dark:border-gray-600">
                        <input
                          ...
                          readOnly
                          className="block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-100 shadow-sm text-gray-900 dark:text-white text-sm"
                        />
                      </td>
                      <td className="px-4 py-3 border border-gray-300 dark:border-gray-600">
                        <input
            ...
            <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
              <thead className="bg-gray-50 dark:bg-dark-200">
                <tr>
                   <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-left text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600"></th>
                   <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 w-32">Primary</th>
                   <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 w-32">Secondary</th>
                   <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 w-32">Primary to Secondary</th>
                   <th className="px-4 py-3 bg-gray-50 dark:bg-dark-200 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 w-32">Acceptable</th>
                </tr>
               </thead>
              <tbody>
                                    <tr>
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600">Dielectric Absorption : (Ratio of 1 Minute to 0.5 Minute Result)</td>
                  <td className="px-4 py-3 border border-gray-300 dark:border-gray-600 w-32">
                    <input
                      type="text"
                ...
                <tr>
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600">Polarization Index : (Ratio of 10 Minute to 1 Minute Result)</td>
                  <td className="px-4 py-3 border border-gray-300 dark:border-gray-600 w-32">
                    <input
                      type="text"
