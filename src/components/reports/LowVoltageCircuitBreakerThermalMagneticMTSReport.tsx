...
const LowVoltageCircuitBreakerThermalMagneticMTSReport: React.FC = () => {
    ...
    try {
      ...
      if (data) {
          ...
          ? {
              ...
              results: {
                ...
                thermal: {
                  ...
                  multiplierTolerance:
                    loadedPi.results?.thermal?.multiplierTolerance || "300%",
                  toleranceMinPct:
                    loadedPi.results?.thermal?.toleranceMinPct ?? "",
                  toleranceMaxPct:
                    loadedPi.results?.thermal?.toleranceMaxPct ?? "",
                },
                magnetic: {
                  ...loadedPi.results?.magnetic,
                  multiplierTolerance:
                    loadedPi.results?.magnetic?.multiplierTolerance ||
                    "-10% 10%",
                  toleranceMinPct:
                    loadedPi.results?.magnetic?.toleranceMinPct || "-10%",
                  toleranceMaxPct:
                    loadedPi.results?.magnetic?.toleranceMaxPct || "10%",
                },
              },
            }
          : null;
        ...
        setFormData((prev) => ({
          ...
          visualInspectionItems:
            data.report_info?.visualInspectionItems ||
            prev.visualInspectionItems,
          // Ensure insulationResistance shape if present
          insulationResistance:
            data.report_info?.insulationResistance || prev.insulationResistance,
  ...
  return (
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      />
      <div className="p-6 print:p-0 flex justify-center bg-neutral-50 dark:bg-dark-150 print:bg-white">
        <div className="max-w-7xl w-full space-y-6 print:space-y-2">
          ...
          <div className="mb-6 print:mb-2">
            <div className="w-full h-1 bg-brand mb-4"></div>
            <h2 className="text-xl font-semibold mb-4 print:mb-2 text-neutral-900 dark:text-white border-b dark:border-neutral-700 pb-2 print:pb-1 print:text-black print:border-black print:font-bold">
              Nameplate Data
            </h2>
              ...
              <div>
                <div className="mb-4 flex items-center">
                  ...
                  <input
                    ...
                    readOnly={!isEditing}
                    className="form-input flex-1 print:hidden"
                  />
                </div>
                <div className="mb-4 flex items-center">
                  <label
          ...
          <div className="mb-6 print:mb-2">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600 table-fixed vm-inspection-table">
                <colgroup>
                  <col style={{ width: "8%" }} />
                  <col style={{ width: "77%" }} />
                  <col style={{ width: "15%" }} />
                    ...
                    <tr key={item.id}>
                      ...
                      <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">
                        <select
                          ...
                          disabled={!isEditing}
                          className={`w-full p-2 border border-neutral-300 dark:border-neutral-600 rounded-none shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white text-center print:hidden ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("counterReading.asFound", e.target.value)
                    }
                    readOnly={!isEditing}
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("counterReading.asLeft", e.target.value)
                    }
                    readOnly={!isEditing}
                    className="form-input flex-1 text-center"
                  />
          ...
          <div className="mb-6 print:mb-2">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600 ir-table table-fixed">
                <colgroup>
                  <col style={{ width: "25%" }} />
                  <col style={{ width: "25%" }} />
                  <col style={{ width: "25%" }} />
                  ...
                  <tr>
                    ...
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-center">
                      <input
                        type="text"
                        value={
                          formData.insulationResistance?.measured?.lineToLoad
                            ?.p1 || ""
                        }
                        onChange={(e) =>
                          handleChange(
          ...
          {!formData.irDlroOnly && (
            <div className="mb-6 print:mb-2 print:break-before-page">
              ...
              {/* Tested Settings */}
              <div className="mb-6">
                <h3 className="text-lg font-medium text-center dark:text-white mb-4">
                  Tested Settings
                </h3>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-600">
              ...
              <div className="overflow-x-auto">
                <table className="w-full table-fixed border-collapse border border-neutral-300 dark:border-neutral-600 primary-injection-table primary-injection-settings">
                  <colgroup>
                    ...
                    <tr>
                      ...
                      <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">
                        <input
                          ...
                          readOnly={!isEditing}
                          className={`w-full p-2 border border-neutral-300 dark:border-neutral-600 rounded-none shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                        />
                      </td>
                      <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">
                        <input
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          <div className="flex items-center">
                            <input
                              ...
                              readOnly={!isEditing}
                              className={`tol-pct-input w-full p-2 text-center border border-neutral-300 dark:border-neutral-600 rounded-none shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                            />
              ...
              <div className="overflow-x-auto mt-4">
                <table className="w-full table-fixed border-collapse border border-neutral-300 dark:border-neutral-600 primary-injection-table primary-injection-poles">
                  <colgroup>
                    <col style={{ width: "18%" }} /> {/* Function */}
                      ...
                      <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-2 text-center">
                        <div className="flex items-center justify-center space-x-2">
                          <input
                            type="text"
                            value={
                              formData.primaryInjection.results.thermal.pole1
                                .sec
                            }
                            onChange={(e) =>
                              handleChange(
                            ...
                            readOnly={!isEditing}
                            className={`w-16 h-7 text-sm text-center border border-neutral-300 dark:border-neutral-600 rounded ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"} ${!isEditing ? "" : "focus:border-brand focus:ring-brand"}`}
                          />
                      ...
                      <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-2 text-center">
                        <div className="flex items-center justify-center space-x-2">
                          <input
                            type="text"
                            value={
                              formData.primaryInjection.results.thermal.pole2
                                .sec
                            }
                            onChange={(e) =>
                              handleChange(
                      ...
                      <td className="border border-neutral-300 dark:border-neutral-600 px-2 py-2 text-center">
                        <div className="flex items-center justify-center space-x-2">
                          <input
                            type="text"
                            value={
                              formData.primaryInjection.results.thermal.pole3
                                .sec
                            }
                            onChange={(e) =>
                              handleChange(
          ...
          <div className="mb-6 print:mb-2">
            ...
            <div
              className={`grid grid-cols-1 gap-4 print:hidden te-section-screen ${formData.irDlroOnly ? "md:grid-cols-2" : "md:grid-cols-3"}`}
            >
            ...
            <div
              className={`mt-6 comments-section print:break-inside-avoid ${!formData.comments?.trim() ? "print:hidden" : ""}`}
            >
              <h3 className="text-lg font-semibold mb-3 text-neutral-900 dark:text-white print:text-black print:font-bold">
                Comments
              </h3>
              <textarea
                ...
                readOnly={!isEditing}
                rows={4}
                className={`form-textarea resize-none w-full whitespace-pre-wrap break-words ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""} print:hidden`}
              />
              {formData.comments?.trim() && (
                <div
                  className="hidden print:block comments-print-wrapper"
                  style={{ width: "100%" }}
                >
                  <div
                    className="comments-cell border border-neutral-300 print:border-black print:border"
                    style={{
                      width: "100%",
                      boxSizing: "border-box",
                      padding: "8px",
