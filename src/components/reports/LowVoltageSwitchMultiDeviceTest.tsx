      ...
      if (jobData?.customer_id) {
        ...
        if (!customerError && customerData) {
          setFormData(prev => ({
            ...
            address: (jobData as any).site_address || customerData.address || ''
          }));
        }
      }
    } catch (error) {
        ...
        <div className="max-w-7xl w-full space-y-8">
          ...
          <section className="mb-6 job-info-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
              <div><label className="form-label">Customer:</label><input className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} value={formData.customer} onChange={e=>setField('customer', e.target.value)} readOnly={!isEditing} /></div>
              ...
              <div className="flex">
                <div className="flex-grow">
                  <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-700 visual-inspection-table">
                    ...
                    <thead>
                      <tr>
                        <th colSpan={13} className="border border-gray-300 dark:border-gray-700 p-2 text-center bg-gray-50 dark:bg-dark-150">
          ...
          <section className="mb-6 enclosure-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3 print:hidden enclosure-onscreen">
              ...
              <div><label className="form-label">AIC Rating (kA)</label><input className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} value={formData.enclosure.aicRating} onChange={e=>setField('enclosure.aicRating', e.target.value)} readOnly={!isEditing} /></div>
              ...
              <table className="min-w-full border border-gray-300 dark:border-gray-700">
                ...
                <tbody>
                  {formData.switches.map((row, idx) => (
                    <tr key={idx}>
                      <td className="px-2 py-1 border"><input type="text" value={row.position} onChange={e=>{ const next=[...formData.switches]; next[idx].position=e.target.value; setField('switches', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
              ...
              <table className="min-w-full border border-gray-300 dark:border-gray-700">
                ...
                <tbody>
                  {formData.fuses.map((row, idx) => (
                    <tr key={idx}>
                      <td className="px-2 py-1 border"><input type="text" value={row.position} onChange={e=>{ const next=[...formData.fuses]; next[idx].position=e.target.value; setField('fuses', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
          ...
          <section className="mb-6 insulation-measured-section">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="mb-2 flex items-center">
                ...
                <select value={formData.irTestVoltage} onChange={e=>setField('irTestVoltage', e.target.value)} disabled={!isEditing} className={`w-32 rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`}>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-300 dark:border-gray-700">
                ...
                <thead>
                  <tr>
                    <th className="border px-2 py-2 bg-gray-50 dark:bg-dark-150"></th>
                    <th colSpan={9} className="border px-2 py-2 text-center bg-gray-50 dark:bg-dark-150">Insulation Resistance</th>
                    <th className="border px-2 py-2 bg-gray-50 dark:bg-dark-150">Units</th>
                  </tr>
                  <tr>
                ...
                <tbody>
                  {formData.irMeasured.map((row, idx) => (
                    <tr key={idx}>
                      <td className="border px-2 py-1"><input type="text" value={row.position} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].position=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1p2} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p1p2=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2p3} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p2p3=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3p1} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p3p1=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1_frame} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p1_frame=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2_frame} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p2_frame=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3_frame} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p3_frame=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1_line} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p1_line=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2_line} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p2_line=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3_line} onChange={e=>{ const next=[...formData.irMeasured]; next[idx].p3_line=e.target.value; setField('irMeasured', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
              ...
              <table className="min-w-full border border-gray-300 dark:border-gray-700">
                ...
                <tbody>
                  {formData.irCorrected.map((row, idx) => (
                    <tr key={idx}>
                      <td className="border px-2 py-1"><input type="text" value={row.position} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].position=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1p2} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p1p2=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2p3} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p2p3=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3p1} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p3p1=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1_frame} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p1_frame=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2_frame} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p2_frame=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3_frame} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p3_frame=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p1_line} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p1_line=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p2_line} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p2_line=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1"><input type="text" value={row.p3_line} onChange={e=>{ const next=[...formData.irCorrected]; next[idx].p3_line=e.target.value; setField('irCorrected', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      <td className="border px-2 py-1 text-sm">{formData.irUnits}</td>
                    </tr>
                  ))}
                </tbody>
              ...
              <table className="min-w-full border border-gray-300 dark:border-gray-700">
                ...
                <tbody>
                  {formData.contact.map((row, idx) => (
                    <tr key={idx}>
                      <td className="border px-2 py-1"><input type="text" value={row.position} onChange={e=>{ const next=[...formData.contact]; next[idx].position=e.target.value; setField('contact', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                      ...
                      <td className="border px-2 py-1"><input type="text" value={row.units} onChange={e=>{ const next=[...formData.contact]; next[idx].units=e.target.value; setField('contact', next); }} readOnly={!isEditing} className={`w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section className="mb-6 test-equipment-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 print:hidden test-eqpt-onscreen">
              <div><label className="form-label">Megohmmeter</label><input value={formData.equipment.megger} onChange={e=>setField('equipment.megger', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></div>
              ...
              <div><label className="form-label">Low Resistance</label><input value={formData.equipment.lowRes} onChange={e=>setField('equipment.lowRes', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''}`} /></div>
          ...
          <section className="mb-6 comments-section">
            ...
            <textarea 
              ...
              readOnly={!isEditing} 
              rows={4} 
              className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] ${!isEditing ? 'bg-gray-100 dark:bg-dark-150':''} print:hidden comments-onscreen`} 
            />
