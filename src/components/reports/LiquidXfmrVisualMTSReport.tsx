  ...
  return (
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="hidden print:block mt-2">
        ...
        />
        <div className="w-full h-1 bg-brand my-4" />
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 job-info-onscreen">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="form-input bg-neutral-200 dark:bg-dark-150 w-full text-neutral-900 dark:text-white"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  readOnly={!isEditing}
                  className={`form-input w-full ${!isEditing ? "bg-neutral-200 dark:bg-dark-150 text-neutral-900 dark:text-white" : ""}`}
                />
              </div>
              <div>
        ...
        <section className="mb-6 nameplate-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 print:hidden nameplate-onscreen">
            ...
            <div>
              ...
              <input
                ...
                readOnly={!isEditing}
                className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-white">
          ...
          <div className="mt-6 print:hidden nameplate-onscreen">
            <div className="grid grid-cols-[100px_1fr_1fr_1fr] gap-4 items-center">
              ...
              <div className="text-center text-sm font-medium text-neutral-700 dark:text-white border-b dark:border-neutral-700 border-r dark:border-neutral-700">
                Volts
              </div>
              <div className="text-center text-sm font-medium text-neutral-700 dark:text-white border-b dark:border-neutral-700 border-r dark:border-neutral-700">
                Connections
              ...
              {/* Primary Row */}
              <div className="text-sm font-medium text-neutral-700 dark:text-white border-b dark:border-neutral-700">
                Primary
              </div>
              <div className="flex justify-center items-center space-x-2">
                <input
                  ...
                  readOnly={!isEditing}
                  className={`w-24 text-center rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
                />
              ...
              <div className="flex justify-center space-x-4">
                <label className="inline-flex items-center">
                  <input
                    ...
                    disabled={!isEditing}
                    className="h-4 w-4 text-brand border-neutral-300 dark:border-neutral-600 focus:ring-brand"
                  />{" "}
          ...
          {/* Tap Configuration */}
          <div className="mt-6 border-t dark:border-neutral-700 pt-4 tap-configuration-section print:hidden nameplate-onscreen">
            <h3 className="text-md font-semibold mb-4 text-neutral-800 dark:text-white">
              Tap Configuration
            </h3>
            <div className="space-y-3">
              <div className="flex items-center">
                <label className="w-32 text-sm font-medium text-neutral-700 dark:text-white">
                  Tap Voltages
                </label>
                <div className="grid grid-cols-7 gap-2 flex-1">
                  {formData.nameplate.tapVoltages.map((voltage, index) => (
                    <input
                      ...
                      readOnly={!isEditing}
                      className={`w-full text-center rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
                      placeholder={index > 4 ? "-" : ""}
                    />
                  ))}
                </div>
                ...
                <div className="grid grid-cols-7 gap-2 flex-1">
                  {formData.nameplate.tapPositions.map((_, index) => (
                    <div
                      ...
                      className="text-center text-sm text-neutral-700 dark:text-white font-medium bg-neutral-100 dark:bg-dark-150 py-1 rounded-none"
                    >
                      {index + 1}
                    </div>
                  ))}
              ...
              <div className="flex items-center pt-2">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    readOnly={!isEditing}
                    className={`w-16 text-center rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
                  />
                  <span className="text-neutral-500 dark:text-white">/</span>
                  <input
                    type="text"
            ...
            <table className="min-w-full border-collapse border border-neutral-300 dark:border-neutral-600">
              <thead>
                <tr>
                  ...
                  <th className="px-3 py-2 bg-neutral-300 dark:bg-dark-150 text-center text-sm font-medium text-neutral-700 dark:text-white border border-neutral-300 dark:border-neutral-600">
                    7
                  </th>
                </tr>
              </thead>
              ...
              <tbody className="bg-white dark:bg-dark-150 divide-y divide-neutral-200 dark:divide-neutral-700">
                {formData.visualMechanicalInspection.map((item, index) => (
                  <tr key={item.netaSection}>
                    <td className="px-3 py-2 text-sm font-medium text-neutral-900 dark:text-white">
                      {item.netaSection}
                    </td>
                    ...
                    <td className="px-3 py-2">
                      <div className="print:hidden">
                        <select
                          ...
                          disabled={!isEditing}
                          className={`w-full text-sm rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${
                            !isEditing
                              ? "bg-neutral-200 dark:bg-dark-150 text-neutral-900 dark:text-white cursor-not-allowed"
        ...
        <section className="mb-6 visual-mechanical-comments">
          ...
          <div className="space-y-4">
            <textarea
              ...
              readOnly={!isEditing}
              rows={4}
              className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"} print:hidden`}
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <style>{`
                          ...
                          `}</style>
                <table className="w-full border border-neutral-300 dark:border-neutral-700 ir-wrap">
                  <thead className="bg-neutral-50 dark:bg-dark-150">
                    <tr>
                      <th
                        colSpan={6}
                        className="px-2 py-2 text-center text-sm font-medium text-neutral-700 dark:text-white border-b dark:border-neutral-700"
                      >
                  ...
                  <tbody className="bg-white dark:bg-dark-150 divide-y divide-neutral-300 dark:divide-neutral-700">
                    {[
                      "primaryToGround",
                      "secondaryToGround",
                      "primaryToSecondary",
                        ...
                        <tr key={testKey}>
                          ...
                          <td className="td-cell-small">
                            <select
                              ...
                              disabled={!isEditing}
                              className={`w-full text-sm text-center rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
                            >
                          ...
                          <td className="td-cell-small">
                            <input
                              ...
                              readOnly={!isEditing}
                              className={`w-full text-sm text-center rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-200 dark:bg-dark-150" : "bg-white dark:bg-dark-150"}`}
                            />
                          </td>
                          <td className="td-cell-small">
                            <input
              ...
              <div>
                <table className="w-full border border-neutral-300 dark:border-neutral-700">
                  <thead className="bg-neutral-50 dark:bg-dark-150">
                    <tr>
                      <th
                        colSpan={4}
                        ...
                        <tr key={`${testKey}-corr`}>
                          <td className="td-cell-small">
                            <input
                              ...
                              readOnly
                              className="w-full text-sm text-center rounded-none border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-dark-150 shadow-sm text-neutral-900 dark:text-white cursor-not-allowed"
                            />
                          </td>
                          <td className="td-cell-small">
                            <input
...
const tableStyles = `
  .th-cell-small {
    @apply px-2 py-2 bg-neutral-50 dark:bg-dark-150 text-left text-xs font-medium text-neutral-700 dark:text-white border-b dark:border-neutral-700 border-r dark:border-neutral-700;
  }
  .td-cell-small {
    @apply px-2 py-1 text-sm text-neutral-900 dark:text-white border-r dark:border-neutral-700;
  }
`;
