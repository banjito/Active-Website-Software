...
export const CandidateCommunication: React.FC = () => {
  ...
  const [editingTemplate, setEditingTemplate] =
    useState<CandidateCommunicationTemplate | null>(null);
  ...
  const copyToClipboard = (
    ...
    navigator.clipboard.writeText(text).then(
      () =>
        toast({
          title: "Copied",
          description: `Email for ${candidate.first_name} ${candidate.last_name} copied to clipboard`,
          variant: "success",
        }),
      () =>
        toast({
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Reusable email templates. Use placeholders like{" "}
              {placeholders.slice(0, 3).join(", ")} to fill in candidate
              details.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select candidates and a template, then preview the filled email
              and copy or open in your mail client.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
      ...
      <Dialog open={templateModalOpen} onOpenChange={setTemplateModalOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Use placeholders in subject and body: {placeholders.join(", ")}.
              They will be replaced with each candidate&apos;s info.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={composeModalOpen} onOpenChange={setComposeModalOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Select one or more candidates and a template. Preview the filled
              email, then copy or open in your email client.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
