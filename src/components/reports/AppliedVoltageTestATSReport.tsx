...
const initialAppliedVoltageTests: AppliedVoltageTestRow[] = [
  {
    windingUnderTest: "Primary",
    testVoltage: "Select",
    testFrequency: "Select",
    duration: "",
    results: "Select",
  },
  {
    windingUnderTest: "Secondary",
    testVoltage: "Select",
    testFrequency: "Select",
    duration: "",
    results: "Select",
...
const AppliedVoltageTestATSReport: React.FC = () => {
      ...
      if (data) {
        if (data.data) {
          ...
          setFormData((prev) => ({
            ...
            ...data.report_info,
            appliedVoltageTests:
              data.applied_voltage_tests || prev.appliedVoltageTests,
  ...
  const handleAppliedVoltageTestChange = (
    index: number,
    field: keyof AppliedVoltageTestRow,
    value: string,
  ) => {
    if (!isEditing) return;
    setFormData((prev) => {
        ...
        try {
          ...
          if (result.data) {
            ...
            const assetData = {
              name: getAssetName(
                reportSlug,
                formData.identifier || formData.serialNumber || "Unnamed",
              ),
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
        ...
        <section className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden">
            ...
            <div>
              <label htmlFor="kva" className="form-label">
                KVA:
              </label>
              <input
                id="kva"
            ...
            <div>
              <label htmlFor="tempRise" className="form-label">
                Temp. Rise:
              </label>
              <input
                id="tempRise"
            ...
            <div>
              <label htmlFor="impedance" className="form-label">
                Impedance:
              </label>
              <input
                id="impedance"
            ...
            <table className="w-full table-fixed border-collapse border border-black mb-4">
              <tbody>
                <tr>
                  ...
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Catalog Number:</div>
                ...
                <tr>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">KVA:</div>
                    <div>{formData.kva}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Temp. Rise:</div>
                    <div>{formData.tempRise}</div>
                  </td>
                  <td className="border border-black px-2 py-1 align-top">
                    <div className="font-bold">Impedance:</div>
                    <div>{formData.impedance}</div>
                  </td>
                </tr>
              </tbody>
            </table>
                  ...
                  <tr key={index}>
                    ...
                    <td className="border border-gray-300 dark:border-gray-600 px-2 py-2">
                      <select
                        ...
                        onChange={(e) =>
                          handleAppliedVoltageTestChange(
                            index,
                            "testVoltage",
                            e.target.value,
                          )
        ...
        <section className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2 print:hidden">
            <div>
              <label htmlFor="testEquipment.name" className="form-label">
                Hipot:
              </label>
            ...
            <div>
              <label
                htmlFor="testEquipment.serialNumber"
                className="form-label"
              >
                Serial Number:
              </label>
              <input
                id="testEquipment.serialNumber"
                type="text"
            ...
            <div>
              <label htmlFor="testEquipment.ampId" className="form-label">
                AMP ID:
              </label>
              <input
                id="testEquipment.ampId"
                type="text"
            ...
            <div>
              <label htmlFor="testEquipment.calDate" className="form-label">
                Cal Date:
              </label>
              <input
                id="testEquipment.calDate"
                type="date"
