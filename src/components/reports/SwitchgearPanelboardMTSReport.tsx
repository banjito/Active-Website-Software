          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
            ...
            <div className="flex items-center space-x-1">
              <div>
                ...
                <input id="temperature.fahrenheit" type="number" value={formData.temperature.fahrenheit} onChange={e => handleFahrenheitChange(parseFloat(e.target.value))} readOnly={!isEditing} className={`form-input w-20 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            ...
            <div className="md:col-span-2"><label htmlFor="customerLocation" className="form-label">Address:</label><input id="customerLocation" type="text" value={formData.customerLocation} readOnly className="form-input bg-gray-100 dark:bg-dark-150" style={{ width: `${Math.max(200, Math.min(500, formData.customerLocation.length * 10))}px`, minWidth: '200px', maxWidth: '500px' }} /></div>
      ...
      {/* Nameplate Data */}
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4 print:hidden nameplate-onscreen">
            ...
            <div><label className="form-label">AIC Rating:</label><input type="text" value={formData.nameplate.aicRating} onChange={e => handleInputChange('nameplate.aicRating', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
          </div>
          <div className="grid grid-cols-3 gap-4 mt-4 print:hidden nameplate-onscreen">
