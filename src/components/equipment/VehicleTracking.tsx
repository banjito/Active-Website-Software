...
export function VehicleTracking({
  ...
  const [selectedVehicle, setSelectedVehicle] =
    useState<ExtendedVehicle | null>(null);
  ...
  const handleSaveVehicle = async () => {
    ...
    try {
      ...
      let status: "available" | "assigned" | "maintenance" | "retired" =
        "available";
      ...
      if (editVehicleId) {
        ...
        console.log(
          "Creating vehicle directly in neta_ops.vehicles with data:",
          vehicleData,
        );
        const { data: createdVehicle, error: vehicleError } =
          await equipmentService.createVehicle(vehicleData);
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setForm({
                              ...form,
                              status: e.target.value as VehicleStatusType,
                            })
                          }
                        />
                      </div>
