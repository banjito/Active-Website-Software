...
export function EquipmentCalibration({ division }: EquipmentCalibrationProps) {
  ...
  const [equipmentForm, setEquipmentForm] =
    useState<Partial<LabEquipment>>(defaultEquipmentForm);
  const [calibrationForm, setCalibrationForm] = useState<Partial<Calibration>>(
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm">
                        {item.last_calibration_date || "Never"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm font-medium">
                      ...
                      <span
                        className={`text-sm ${
                          isDue(item.next_calibration_date)
                            ...
                            : isUpcoming(item.next_calibration_date)
  ...
  const getStatusBadgeVariant = (
    ...
    switch (status) {
      ...
      case "in-use":
        return "default"; // instead of 'primary'
      case "maintenance":
        return "outline"; // instead of 'warning'
      case "calibration":
        return "secondary"; // instead of 'info'
      case "out-of-service":
        return "destructive"; // instead of 'danger'
      default:
        return "default";
    }
  };
