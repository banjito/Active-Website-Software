...
const MediumVoltageCableVLFTest = () => {
  ...
  const reportSlug = isMTSRoute
    ? "medium-voltage-cable-vlf-test-mts"
    : "medium-voltage-cable-vlf-test";
  ...
  const loadReport = async () => {
    ...
    try {
      console.log(
        `Attempting to load report from 'neta_ops.medium_voltage_cable_vlf_test' table`,
      );
      const { data, error } = await supabase
        .schema("neta_ops")
        .from("medium_voltage_cable_vlf_test")
      ...
      if (error) {
        console.error(
          `Error loading from medium_voltage_cable_vlf_test:`,
          error,
        );
            ...
            <div className="grid grid-cols-1 gap-4 print:hidden">
              <div className="flex items-center">
                ...
                <select
                  ...
                  disabled={!isEditMode}
                  className={`w-1/4 rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white ${!isEditMode ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                >
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-2 text-center">
                      <select
                        ...
                        disabled={!isEditMode}
                        className={`w-full rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white ${!isEditMode ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                      >
                        {Object.values(InspectionResult).map((result) => (
                          <option key={result} value={result}>
                            {result}
          ...
          <section className="mb-6 insulation-resistance-section">
            ...
            <div className="mb-4 flex items-center">
              ...
              <select
                ...
                disabled={!isEditMode}
                className={`w-32 rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white ${!isEditMode ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
              >
                  ...
                  <tr>
                    ...
                    <td className="border border-neutral-300 dark:border-neutral-700 px-3 py-2 whitespace-nowrap">
                      <input
                        ...
                        readOnly={true}
                        className="w-full rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm dark:bg-dark-100 dark:text-white bg-neutral-100 dark:bg-dark-200"
                      />
                    </td>
                    <td className="border border-neutral-300 dark:border-neutral-700 px-3 py-2 whitespace-nowrap">
                      <input
                  ...
                  <tr>
                    ...
                    <th className="border border-neutral-300 dark:border-neutral-700 px-3 py-2 text-left text-xs font-medium text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">
                      <select
                        ...
                        disabled={!isEditMode}
                        className={`w-16 rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-xs dark:bg-dark-100 dark:text-white ${!isEditMode ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                      >
                        ...
                        {isMTSRoute ? (
                          <div className="flex items-center gap-1">
                            <input
                              ...
                              readOnly={!isEditMode}
                              className={`w-full rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white text-center ${!isEditMode ? "bg-neutral-100 dark:bg-dark-200" : ""}`}
                            />
                            {isEditMode && (
          ...
          <section className="mb-6 tan-delta-section">
            ...
            <div className="flex items-center mb-6">
              ...
              <input
                ...
                readOnly={!isEditMode}
                className={`w-32 rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] dark:bg-dark-100 dark:text-white ${
                ...
                <div className="grid grid-cols-4 gap-4 print:hidden test-eqpt-onscreen">
                  <div>
                    ...
                    <EquipmentAutocomplete
                      ...
                      readOnly={!isEditMode}
                      className="w-full rounded-md border-neutral-300 dark:border-neutral-700 shadow-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">
