...
export const SearchResults: React.FC = () => {
  ...
  if (!loading && hasSearched && searchResults.length === 0) {
    return (
      <div className="mt-4 p-6 text-center bg-white dark:bg-dark-150 rounded-md shadow-sm border border-gray-200 dark:border-dark-300">
  ...
  return (
    <div className="mt-4">
      <div className="bg-white dark:bg-dark-150 rounded-md shadow-sm border border-gray-200 dark:border-dark-300 overflow-hidden">
