...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      "bg-[#f26722] hover:bg-[#f26722]/90 text-white focus:ring-[#f26722] ",
    secondary:
      "bg-dark-secondary/20 hover:bg-dark-secondary/30 text-dark-primary focus:ring-dark-secondary  dark:bg-dark-700 dark:hover:bg-dark-700/90 dark:text-white",
    outline:
      "border border-dark-accent/30 hover:bg-dark-accent/10 text-dark-primary focus:ring-dark-accent dark:border-dark-700 dark:hover:bg-dark-700/20 dark:text-white",
    ghost:
    ...
    destructive:
      "bg-red-600 hover:bg-red-700 text-white focus:ring-red-500  dark:bg-red-800 dark:hover:bg-red-700",
  };

  const sizeStyles = {
    sm: "text-sm px-3 py-1.5 rounded-none",
