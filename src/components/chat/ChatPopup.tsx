    ...
    >
      ...
      {showRoomList ? (
        ...
        <div className="flex-1 overflow-y-auto p-2 bg-white dark:bg-gray-950">
          {loading ? (
            <div className="p-4 text-center text-gray-500 dark:text-white">Loading chat rooms...</div>
          ) : error ? (
        ...
        <>
          ...
          >
            {loading ? (
              <div className="text-center text-gray-500 dark:text-white">Loading messages...</div>
            ) : messages.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-shrink-0 mt-1">
                      ...
                      {(() => {
                        ...
                        return userInfo.profileImage ? (
                          ...
                          <div className="w-8 h-8 bg-gray-200 dark:bg-dark-150 rounded-full flex items-center justify-center">
                    ...
                    <div className={`flex flex-col max-w-[75%] ${isCurrentUser ? "items-end" : "items-start"}`}>
                      ...
                      {!isCurrentUser && (
                        <span className="text-xs font-medium text-gray-500 dark:text-white px-1 mb-1">
                      ...
                      <div className="flex flex-col">
                        <div
                          className={`
                            ...
                            ${isCurrentUser 
                              ...
                              : 'bg-gray-100 dark:bg-dark-150 text-gray-900 dark:text-gray-100 rounded-bl-none'}
                          `}
                        >
                          {message.content}
                        </div>
                        ...
                        {(index === messages.length - 1 || messages[index + 1]?.user_id !== message.user_id || 
                          ...
                          <div
                            className={`
                              flex items-center gap-1 text-xs text-gray-500 dark:text-white mt-1
          ...
          <form onSubmit={handleSendMessage} className="p-3 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
            <div className="flex items-center gap-2">
              <Input
                ...
                className="flex-1 bg-gray-100 dark:bg-dark-150 border-0"
              />
              <Button
                type="submit"
