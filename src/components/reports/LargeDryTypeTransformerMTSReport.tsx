  ...
  style.textContent = `
    @media print {
      ...
      *[class*="Back to Job"], 
      ...
      /* Section styling with better page break control */
      ...
      /* Large tables that might need to break */
      ...
      /* Specific fixes for nameplate data section */
      .grid-cols-3 { 
      ...
      /* Insulation resistance tables - allow breaking but keep rows together */
      .min-w-full {
        page-break-inside: auto !important;
      }
