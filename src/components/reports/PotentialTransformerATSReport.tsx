          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:hidden job-info-onscreen">
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <input className={`form-input flex-1 ${!isEditMode ? 'bg-gray-100 dark:bg-dark-150' : ''}`} value={formData.address} onChange={(e) => handleChange('address', e.target.value)} readOnly={!isEditMode} />
              </div>
              <div className="flex items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <input type="number" className={`form-input w-20 ${!isEditMode ? 'bg-gray-100 dark:bg-dark-150' : ''}`} value={formData.temperature} onChange={(e) => handleChange('temperature', Number(e.target.value))} readOnly={!isEditMode} />
