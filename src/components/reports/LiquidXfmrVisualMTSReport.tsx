          ...
          <>
            ...
            <button
              onClick={() => {
                ...
                const date = formData.date ? new Date(formData.date).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' }).replace(/\//g, '-') : '';
            ...
            <section className="mb-6 job-info-section">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
                  <div><label className="form-label">Customer:</label><input type="text" value={formData.customer} readOnly className="form-input bg-gray-200 dark:bg-dark-150 w-full text-gray-900 dark:text-white" /></div>
                  ...
                  <div className="md:col-span-2"><label className="form-label">Address:</label><input type="text" value={formData.address} readOnly className="form-input bg-gray-200 dark:bg-dark-150 w-full text-gray-900 dark:text-white" /></div>
