          ...
          <div className="flex flex-col gap-3">
            ...
            {error.includes("database") && (
              <button
                ...
                className="px-4 py-2 mt-2 text-sm text-white bg-green-600 hover:bg-green-700 rounded-none"
              >
                Retry Connection
              </button>
            )}
      ...
      <div className="p-6 print:p-0 print:m-0 flex justify-center bg-neutral-50 dark:bg-dark-150 print:bg-white">
        <div className="max-w-7xl w-full space-y-6 print:space-y-0 print:m-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2 job-info-onscreen">
              ...
              <div className="md:col-span-2 space-y-2">
                <div className="mb-4 flex">
                  <label className="inline-block w-20 font-medium text-neutral-700 dark:text-white">
                    Customer
                  </label>
          ...
          <section className="mb-6 print:mb-0 cable-termination-section print:mt-0">
            <div className="w-full h-1 bg-brand mb-4 print:mb-1"></div>
            <h2 className="text-xl font-semibold mb-4 print:mb-1 text-neutral-900 dark:text-white border-b dark:border-neutral-700 pb-2 print:pb-1 print:text-black print:border-black print:font-bold">
            ...
            <div className="grid grid-cols-1 gap-6 print:hidden cable-termination-onscreen">
              <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div className="flex items-center">
                  <label className="w-1/2 text-sm font-medium text-neutral-700 dark:text-white"></label>
                </div>
                <div className="flex items-center">
                  <label className="w-1/2 text-sm font-medium text-neutral-700 dark:text-white">
                    Manufacturer
            ...
            <div className="hidden print:block">
              <table className="w-full border border-neutral-300 print:border-black table-fixed">
                <colgroup>
                  <col style={{ width: "25%" }} />
                  <col style={{ width: "25%" }} />
                  <col style={{ width: "25%" }} />
          ...
          <section className="mb-6 print:mb-2">
            ...
            <div className="overflow-x-auto section-insulation-resistance">
              <table className="min-w-full border-collapse border border-neutral-300 dark:border-neutral-700 table-fixed">
                ...
                <thead>
                  <tr>
                    <th className="border border-neutral-300 dark:border-neutral-700 px-2 py-2 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase w-20">
                      {" "}
                    </th>
                    <th
                    ...
                    <th className="border border-neutral-300 dark:border-neutral-700 px-2 py-2 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider w-16">
                      Units
                    </th>
                  </tr>
                  <tr>
                    ...
                    <th className="border border-neutral-300 dark:border-neutral-700 px-2 py-2 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider"></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
          ...
          >
            ...
            <div className="print:hidden comments-onscreen">
              <textarea
                ...
                readOnly={!isEditMode}
                rows={6}
                className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white resize-vertical ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
              />
            </div>
...
if (typeof document !== "undefined") {
  ...
  style.textContent = `
      ...
      * {
      ...
      div[class*="h-1"][class*="bg-[var(--brand)"]],
      div[class*="h-1"][class*="bg-[var(--brand)"][class*="mb-4"],
      div[class*="h-1"][class*="bg-[var(--brand)"]][class*="print:mb-1"] {
