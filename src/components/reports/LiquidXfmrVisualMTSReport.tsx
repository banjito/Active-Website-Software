...
const LiquidXfmrVisualMTSReport: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    testEquipmentUsed: { megohmmeter: '', serialNumber: '', ampId: '', calDate: '' },
  ...
  const calculateCorrectedValue = useCallback((valueStr: string, tcf: number): string => {
    if (valueStr === '' || valueStr === null || valueStr === undefined) return '' as any;
            ...
            const updatedData = {
              ...
              temperature: {
                ...
                humidity: (() => {
                  ...
                  if (h === null || h === undefined) return prev.temperature.humidity;
              ...
              testEquipmentUsed: {
                ...
                calDate: importedData.testEquipment?.megohmmeter?.calDate ?? prev.testEquipmentUsed.calDate
              },
              
              // Comments
              visualMechanicalInspectionComments: importedData.reportInfo?.visualComments ?? importedData.reportInfo?.comments ?? prev.visualMechanicalInspectionComments,
              electricalTestComments: importedData.reportInfo?.electricalComments ?? prev.electricalTestComments,
          ...
          <>
            ...
            <button
              onClick={() => {
                ...
                const date = formData.date ? new Date(formData.date + 'T00:00:00').toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' }).replace(/\//g, '-') : '';
        ...
        <JobInfoPrintTable
          data={{
            ...
            temperature: {
              ...
              humidity: formData.temperature.humidity ? Number(formData.temperature.humidity) : undefined,
            },
          }}
        />
      ...
      <div className="space-y-8">
            ...
            <section className="mb-6 job-info-section print:hidden">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 job-info-onscreen">
                  <div><label className="form-label">Customer:</label><input type="text" value={maskCustomerName(formData.customer)} readOnly className="form-input bg-gray-200 dark:bg-dark-150 w-full text-gray-900 dark:text-white" /></div>
                  <div><label className="form-label">Job #:</label><input type="text" value={formData.jobNumber} readOnly className="form-input bg-gray-200 dark:bg-dark-150 w-full text-gray-900 dark:text-white" /></div>
                  <div className="md:col-span-2"><label className="form-label">Address:</label><input type="text" value={formData.address} onChange={(e) => handleChange('address', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-200 dark:bg-dark-150 text-gray-900 dark:text-white' : ''}`} /></div>
                  <div><label htmlFor="technicians" className="form-label">Technicians:</label><input id="technicians" type="text" value={formData.technicians} onChange={(e) => handleChange('technicians', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-200 dark:bg-dark-150 text-gray-900 dark:text-white' : ''}`} /></div>
                  <div><label className="form-label">Date:</label><input type="date" value={formData.date} onChange={(e) => handleChange('date', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-200 dark:bg-dark-150 text-gray-900 dark:text-white' : ''}`} /></div>
                  <div><label className="form-label">Identifier:</label><input type="text" value={formData.identifier} onChange={(e) => handleChange('identifier', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-200 dark:bg-dark-150 text-gray-900 dark:text-white' : ''}`} /></div>
                  <div className="flex items-center space-x-1">
                    <div>
                      <label className="form-label">Temp:</label>
                      <input type="number" value={formData.temperature.fahrenheit} onChange={(e) => handleFahrenheitChange(Number(e.target.value))} readOnly={!isEditing} className={`form-input w-16 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                  ...
                  <div><label className="form-label">TCF:</label><input type="number" value={formData.temperature.tcf} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-16" /></div>
                  <div><label className="form-label">Humidity:</label><input type="text" value={formData.temperature.humidity} onChange={(e) => handleChange('temperature.humidity', e.target.value)} readOnly={!isEditing} className={`form-input w-16 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /><span className="ml-1 text-xs">%</span></div>
                  <div><label className="form-label">Substation:</label><input type="text" value={formData.substation} onChange={(e) => handleChange('substation', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                  ...
                  <div className="md:col-span-2"><label className="form-label">User:</label><input type="text" value={formData.user} onChange={(e) => handleChange('user', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-6 nameplate-section">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 print:hidden nameplate-onscreen">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-white">Fluid Type:</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-white">Fluid Volume (gal):</label>
                  ...
                  <div className="flex items-center">
                   ...
                   <div className="flex items-center">
                      ...
                      <div className="grid grid-cols-7 gap-2 flex-1">
                          ...
                          <div key={`tap-pos-label-${index}`} className="text-center text-sm text-gray-700 dark:text-white font-medium bg-gray-100 dark:bg-dark-150 py-1 rounded-md">
                              {index + 1}
                          </div>
                          ))}
                      </div>
                ...
                <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                        <span className="font-medium">KVA:</span> {formData.nameplate.kVA || ''}
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                        <span className="font-medium">Fluid Type:</span> {formData.nameplate.fluidType || ''}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                      ...
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                        <span className="font-medium">Fluid Volume (gal):</span> {formData.nameplate.fluidVolume || ''}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                ...
                <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">{formData.nameplate.primaryVolts1 || ''} / {formData.nameplate.primaryVolts2 || ''}</td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.primaryConnectionDelta ? '☒' : '☐'} Delta
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.primaryConnectionWye ? '☒' : '☐'} Wye
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.primaryConnectionSinglePhase ? '☒' : '☐'} Single Phase
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.primaryWindingMaterialAluminum ? '☒' : '☐'} Aluminum
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.primaryWindingMaterialCopper ? '☒' : '☐'} Copper
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">{formData.nameplate.secondaryVolts1 || ''} / {formData.nameplate.secondaryVolts2 || ''}</td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.secondaryConnectionDelta ? '☒' : '☐'} Delta
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.secondaryConnectionWye ? '☒' : '☐'} Wye
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.secondaryConnectionSinglePhase ? '☒' : '☐'} Single Phase
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.secondaryWindingMaterialAluminum ? '☒' : '☐'} Aluminum
                      </td>
                      <td className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white text-center">
                        {formData.nameplate.secondaryWindingMaterialCopper ? '☒' : '☐'} Copper
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600">
                  <thead>
                    <tr>
                      ...
                      <th className="px-3 py-2 bg-gray-300 dark:bg-dark-150 text-center text-sm font-medium text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600">7</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td colSpan={7} className="px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-white">
                        Position: {formData.nameplate.tapPositionLeft1 || ''} / {formData.nameplate.tapPositionLeft2 || ''} |
                        Volts: {formData.nameplate.tapVoltsSpecific || ''} |
                        Percent: {formData.nameplate.tapPercentSpecific || ''}
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <section className="mb-6 indicator-gauges-section">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden indicator-gauges-onscreen">
                  <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-white">Oil Level:</label>
                  ...
                  <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-white">Oil Temperature (°C):</label>
                   ...
                   <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-white">Oil Temp. Range:</label>
                  ...
                  <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-white">Tank Pressure:</label>
                  ...
                  <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-white">Winding Temp. Range:</label>
                    ...
                    <tbody>
                      <tr>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          ...
                          <div className="mt-0">{formData.indicatorGaugeValues.oilLevel || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Oil Temperature (°C):</div>
                          <div className="mt-0">{formData.indicatorGaugeValues.oilTemperature || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Oil Temp. Range:</div>
                          <div className="mt-0">{formData.indicatorGaugeValues.oilTempRange || ''}</div>
                        </td>
                      </tr>
                      <tr>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Tank Pressure:</div>
                          <div className="mt-0">{formData.indicatorGaugeValues.tankPressure || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Winding Temperature (°C):</div>
                          <div className="mt-0">{formData.indicatorGaugeValues.windingTemperature || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Winding Temp. Range:</div>
                          <div className="mt-0">{formData.indicatorGaugeValues.windingTempRange || ''}</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                    {formData.visualMechanicalInspection.map((item, index) => (
                      <tr key={item.netaSection}>
                        <td className="px-3 py-2 text-sm font-medium text-gray-900 dark:text-white">{item.netaSection}</td>
                        <td className="px-3 py-2 text-sm text-gray-700 dark:text-white">{item.description}</td>
                        <td className="px-3 py-2">
                          <div className="print:hidden">
                            ...
                            >
                              {visualInspectionOptions.map(opt => <option key={opt} value={opt} className="dark:bg-dark-150 dark:text-white">{opt}</option>)}
                            </select>
                          </div>
                    ...
                    <tbody>
                      <tr>
                        <td className="p-2 align-top border border-gray-300 print:border-black">
                          <div className="font-semibold">Visual & Mechanical Inspection Comments</div>
                          <div className="mt-0 whitespace-pre-wrap break-words">{formData.visualMechanicalInspectionComments || ''}</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                          ...
                          <table className="w-full border border-gray-300 dark:border-gray-700 ir-wrap">
                              ...
                              <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-300 dark:divide-gray-700">
                                  {['primaryToGround', 'secondaryToGround', 'primaryToSecondary'].map(testKey => {
                                      ...
                                      return (
                                          <tr key={testKey}>
                                              <td className="td-cell-small font-medium whitespace-normal break-words">{title}</td>
                          ...
                          <table className="w-full border border-gray-300 dark:border-gray-700">
                              ...
                              <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-300 dark:divide-gray-700">
                                  {['primaryToGround', 'secondaryToGround', 'primaryToSecondary'].map(testKey => {
                                      ...
                                      return (
                                          <tr key={`${testKey}-corr`}>
                                              <td className="td-cell-small"><input type="text" value={testData.correctedValues.halfMin} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed" /></td>
                                              <td className="td-cell-small"><input type="text" value={testData.correctedValues.oneMin} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed" /></td>
                                              <td className="td-cell-small"><input type="text" value={testData.correctedValues.tenMin} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed" /></td>
                                              <td className="td-cell-small border-r-0"><input type="text" value={testData.units} readOnly className={`w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed`} /></td>
                                          </tr>
                                      );
                                  })}
                              </tbody>
                      ...
                      <table className="w-full border border-gray-300 dark:border-gray-700">
                          ...
                          <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-300 dark:divide-gray-700">
                              <tr>
                                  ...
                                  <td className="td-cell-small"><input type="text" value={formData.electricalTestsInsulationResistance.dielectricAbsorption.primary} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed"/></td>
                                  <td className="td-cell-small"><input type="text" value={formData.electricalTestsInsulationResistance.dielectricAbsorption.secondary} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed"/></td>
                                  <td className="td-cell-small"><input type="text" value={formData.electricalTestsInsulationResistance.dielectricAbsorption.primaryToSecondary} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed"/></td>
                                   <td className="td-cell-small border-r-0">
                                      {/* Acceptable field is shared, already rendered above or could be repeated if needed */}
                                      <input type="text" value={formData.electricalTestsInsulationResistance.acceptableDAPI} onChange={e => handleChange('electricalTestsInsulationResistance.acceptableDAPI', e.target.value)} readOnly={!isEditing} className={`w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed`}/>
                                  </td>
                              </tr>
                              <tr>
                                  ...
                                  <td className="td-cell-small"><input type="text" value={formData.electricalTestsInsulationResistance.polarizationIndex.secondary} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed"/></td>
                                  <td className="td-cell-small"><input type="text" value={formData.electricalTestsInsulationResistance.polarizationIndex.primaryToSecondary} readOnly className="w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed"/></td>
                                   <td className="td-cell-small border-r-0">
                                      {/* Acceptable field is shared, already rendered above or could be repeated if needed */}
                                      <input type="text" value={formData.electricalTestsInsulationResistance.acceptableDAPI} readOnly className={`w-full text-sm text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-dark-150 shadow-sm text-gray-900 dark:text-white cursor-not-allowed`} />
                                  </td>
                              </tr>
                          </tbody>
                      </table>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 print:hidden test-eqpt-onscreen">
                  <div>
                    ...
                    <EquipmentAutocomplete
                      ...
                      onChange={value => handleChange('testEquipmentUsed.megohmmeter', value)}
                      onSelect={(equipment) => {
                        ...
                        handleChange('testEquipmentUsed.megohmmeter', equipment.equipment_name);
                        handleChange('testEquipmentUsed.serialNumber', equipment.serial_number || '');
                        handleChange('testEquipmentUsed.ampId', equipment.amp_id || '');
                        handleChange('testEquipmentUsed.calDate', formatLocalDateShort(equipment.calibration_date));
                      }}
                      readOnly={!isEditing}
                  ...
                  <div><label className="block text-sm font-medium text-gray-700 dark:text-white">Cal Date:</label><input type="text" value={formData.testEquipmentUsed.calDate} onChange={e => handleChange('testEquipmentUsed.calDate', e.target.value)} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} /></div>
                </div>
                    ...
                    <tbody>
                      <tr>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          ...
                          <div className="mt-0">{formData.testEquipmentUsed.megohmmeter || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Serial Number:</div>
                          <div className="mt-0">{formData.testEquipmentUsed.serialNumber || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">AMP ID:</div>
                          <div className="mt-0">{formData.testEquipmentUsed.ampId || ''}</div>
                        </td>
                        <td className="p-2 align-top border border-gray-300 print:border-black print:border">
                          <div className="font-semibold">Cal Date:</div>
                          <div className="mt-0">{formData.testEquipmentUsed.calDate || ''}</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div className="hidden print:block">
                  <table className="w-full table-fixed border-collapse border border-gray-300 print:border-black">
                    <tbody>
                      <tr>
                        <td className="p-2 align-top border border-gray-300 print:border-black">
                          <div className="font-semibold">Electrical Test Comments</div>
                          <div className="mt-0 whitespace-pre-wrap break-words">{formData.electricalTestComments || ''}</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
