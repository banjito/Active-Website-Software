...
export function AuthProvider({ children }: { children: React.ReactNode }) {
    ...
    try {
      ...
      if (current !== derived) {
        ...
        if (updErr) {
          ...
          // Refresh to pull updated claims
          await refreshUser();
        }
      }
    } catch (e) {
  ...
  useEffect(() => {
    ...
    // Auto-refresh disabled to prevent interference with editing workflows
    // const handleFocus = () => {
    //   try {
    ...
    return () => {
      ...
      // Event listeners removed since auto-refresh is disabled
