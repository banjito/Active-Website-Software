    ...
    <Card className="overflow-hidden">
      ...
      <CardContent>
        ...
        <Tabs defaultValue="all">
          ...
          <TabsContent value="all">{renderLogs()}</TabsContent>

          <TabsContent value="create">{renderLogs()}</TabsContent>

          <TabsContent value="update">{renderLogs()}</TabsContent>

          <TabsContent value="delete">{renderLogs()}</TabsContent>
        </Tabs>
      </CardContent>
