        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-neutral-900 dark:text-dark-900 truncate">
              ...
              <p className="mt-1 text-xs text-neutral-500 dark:text-dark-500">
                Created:{" "}
                {new Date(
  ...
  if (!loading && hasSearched && searchResults.length === 0) {
    return (
      <div className="mt-4 p-6 text-center bg-white dark:bg-dark-150 rounded-md shadow-sm border border-neutral-200 dark:border-dark-300">
        ...
        <h3 className="text-lg font-medium text-neutral-900 dark:text-dark-900">
          No results found
        </h3>
        <p className="mt-1 text-sm text-neutral-500 dark:text-dark-400">
  ...
  if (loading) {
    return (
      <div className="mt-4 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-neutral-500 dark:text-dark-400">
          Searching...
        </p>
      </div>
    );
        ...
        <div className="divide-y divide-neutral-200 dark:divide-dark-300">
          ...
          {Object.entries(groupedResults).map(([type, results]) => (
            <div key={type} className="py-2">
              <h3 className="px-4 py-2 text-sm font-medium text-neutral-500 dark:text-dark-400 uppercase tracking-wider">
