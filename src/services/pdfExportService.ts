  ...
  async batchPrintApprovedReports(
    ...
    try {
      ...
      for (let i = 0; i < approvedReports.length; i++) {
        ...
        // Try to extract identifier from the report page meta if available, else derive from asset name suffix
        let identifier = '';
        try {
