...
export default function CalendarNotifications({
  ...
  onAddReminder: (
    eventId: string,
    reminder: Omit<EventReminder, "id" | "sent">,
  ) => void;
  ...
  const [activeNotifications, setActiveNotifications] = useState<
    (CalendarEvent & { reminderId?: string })[]
  >([]);
  ...
  useEffect(() => {
    ...
    if (
      ...
      upcomingEvents.length !== notificationCount
    ) {
      toast({
  ...
  const handleDismissReminder = (eventId: string, reminderId?: string) => {
    ...
    setActiveNotifications((prev) =>
      prev.filter((n) => !(n.id === eventId && n.reminderId === reminderId)),
    );
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPreferences({
                    ...preferences,
                    defaultReminderType: value as "popup" | "email" | "both",
                  })
                }
                disabled={!preferences.enableNotifications}
              >
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setEmailFormData({ ...emailFormData, to: e.target.value })
                }
