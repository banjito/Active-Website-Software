  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <Card>
        ...
        <CardContent>
          {/* No scheduling here on purpose. A test's start and finish dates belong to a
              project, so scheduling lives on the job's Assets tab and the schedule itself
              on the job's Project Tracker. This page stays the facility's equipment
              registry, which is the part that outlives any one job. */}
