...
export const EquipmentTracking = forwardRef<
  EquipmentTrackingRefHandle,
  ...
  const handleSaveEquipment = async () => {
    try {
      ...
      const equipmentData = {
        ...
        purchase_date:
          form.purchase_date || new Date().toISOString().split("T")[0], // Default to today if not provided
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            {(isDue(item.next_maintenance_date) ||
                              isUpcoming(item.next_maintenance_date)) && (
                              <div
