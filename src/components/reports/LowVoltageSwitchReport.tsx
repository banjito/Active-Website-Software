...
const applyTemperatureCorrection = (
...
const normalizeInsulationResistance = (raw: any): InsulationResistanceData => {
  ...
  return {
    ...
    units,
    poleToPole: {
      "P1-P2": normalizeMeasurement(
        raw?.poleToPole?.["P1-P2"] ?? raw?.["P1-P2"] ?? "",
      ),
      "P2-P3": normalizeMeasurement(
        raw?.poleToPole?.["P2-P3"] ?? raw?.["P2-P3"] ?? "",
      ),
      "P3-P1": normalizeMeasurement(
        raw?.poleToPole?.["P3-P1"] ?? raw?.["P3-P1"] ?? "",
      ),
    },
    poleToFrame: {
    ...
    lineToLoad: {
      P1: normalizeMeasurement(
        raw?.lineToLoad?.["P1"] ?? raw?.["P1_line_to_load"] ?? "",
      ),
      P2: normalizeMeasurement(
        raw?.lineToLoad?.["P2"] ?? raw?.["P2_line_to_load"] ?? "",
      ),
      P3: normalizeMeasurement(
        raw?.lineToLoad?.["P3"] ?? raw?.["P3_line_to_load"] ?? "",
      ),
    },
  };
};
...
const fahrenheitToCelsius = (fahrenheit: number): number => {
  ...
  const lowerBound = sortedData
    .filter((data) => data.fahrenheit <= fahrenheit)
    .pop();
  ...
  const ratio =
    (fahrenheit - lowerBound.fahrenheit) /
    (upperBound.fahrenheit - lowerBound.fahrenheit);
...
const calculateTCF = (tempF: number): number => {
  ...
  const exactMatch = sortedData.find(
    (data) => data.celsius === Math.round(tempC),
  );
  if (exactMatch) {
  ...
  // Interpolate between the two values
  const ratio =
    (tempC - lowerBound.celsius) / (upperBound.celsius - lowerBound.celsius);
  return (
    lowerBound.multiplier +
    ratio * (upperBound.multiplier - lowerBound.multiplier)
  );
};
...
const getMeasurementValue = (measurement: Measurement): string => {
  return measurement.isEmpty || measurement.value === null
    ? ""
...
const getTemperatureCorrectedValue = (
  measurement: Measurement,
  tcf: number,
): string => {
...
export default function LowVoltageSwitchReport() {
      ...
      try {
        ...
        if (data) {
          setFormData((current) => ({
            ...
            temperature:
              typeof data.report_info?.temperature === "number"
                ? {
                ...
                : {
                    ...
                    tcf:
                      data.report_info?.temperature?.tcf ??
                      current.temperature.tcf,
                  },
            switchData: data.switch_data || current.switchData,
            fuseData: data.fuse_data || current.fuseData,
            visualMechanicalInspection:
              data.visual_inspection || current.visualMechanicalInspection,
            insulationResistance: data.insulation_resistance
              ? normalizeInsulationResistance(data.insulation_resistance)
              : current.insulationResistance,
            contactResistance:
              data.contact_resistance || current.contactResistance,
          ...
          setStatus(
            (data.status as "PASS" | "FAIL" | "LIMITED SERVICE") || "PASS",
          );
          setIsEditing(false);
        }
      } catch (error) {
  ...
  const handleSave = async () => {
    console.log("Save attempt with params:", {
      jobId,
      reportId,
      user: user?.id,
      isEditing,
    ...
    try {
      ...
      try {
        ...
        if (!reportId) {
          // New report: quietly update URL with new ID
          setIsEditing(false);
          ...
          // Existing report: save silently, stay in edit mode
          setJustSaved(true);
        }
      } catch (error: any) {
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div>
                <label htmlFor="type" className="form-label inline-block w-32">
                  Type:
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("systemVoltage", e.target.value)
                  }
                  readOnly={!isEditing}
                  className="form-input"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("phaseConfiguration", e.target.value)
                  }
                  readOnly={!isEditing}
                  className="form-input"
                />
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">
                      Position / Identifier
                    </th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">
                      Manufacturer
                    ...
                    <th
                      className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal text-center"
                      colSpan={2}
                    >
                      Rated
                    </th>
                  ...
                  <tr>
                    <th
                      className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150"
                      colSpan={5}
                    ></th>
                    <th className="border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-dark-150 font-normal">
                      Amperage
          ...
          <section className="mb-6">
            ...
            <div className="mb-4 flex items-center gap-4">
              ...
              <div>
                <label
                  htmlFor="irUnits"
                  className="form-label inline-block w-24"
                >
                  Units:
                </label>
                <select
                  ...
                  onChange={(e) =>
                    handleChange("insulationResistance.units", e.target.value)
                  }
                  disabled={!isEditing}
                  ...
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("insulationResistance.poleToPole", {
                    ...
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("insulationResistance.poleToFrame", {
                    ...
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("insulationResistance.lineToLoad", {
          ...
          <section className="mb-6">
            ...
            <div className="mb-4">
              <label htmlFor="crUnits" className="form-label inline-block w-24">
                Units:
              </label>
              <select
                id="crUnits"
                ...
                onChange={(e) =>
                  handleChange("contactResistance.units", e.target.value)
                }
                disabled={!isEditing}
                className="form-select w-24"
              >
                  ...
                  <tr>
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("contactResistance.poleToPole", {
                            ...formData.contactResistance.poleToPole,
                            "P1-P2": Number(e.target.value),
                          })
                        }
                        readOnly={!isEditing}
                        className="form-input w-full"
                    ...
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("contactResistance.poleToFrame", {
                            ...formData.contactResistance.poleToFrame,
                            P1: Number(e.target.value),
                          })
                        }
                        readOnly={!isEditing}
                        className="form-input w-full"
                    ...
                    <td className="border border-gray-200 dark:border-gray-700 p-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("contactResistance.lineToLoad", {
                            ...formData.contactResistance.lineToLoad,
                            P1: Number(e.target.value),
                          })
                        }
                        readOnly={!isEditing}
          ...
          <section className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                <thead>
                  <tr>
                    <th className="border border-gray-200 dark:border-gray-700 p-2 bg-gray-50 dark:bg-dark-150 font-normal text-left">
                      Section
                    </th>
                    <th className="border border-gray-200 dark:border-gray-700 p-2 bg-gray-50 dark:bg-dark-150 font-normal text-left">
                      Description
                      ...
                      <tr key={index}>
                        ...
                        <td className="border border-gray-200 dark:border-gray-700 p-2">
                          <select
                            value={value}
                            onChange={(e) =>
                              handleChange("visualMechanicalInspection", {
                  ...
                  <EquipmentAutocomplete
                    ...
                    onChange={(value) =>
                      handleChange("testEquipment", {
                        ...formData.testEquipment,
                        lowResistance: {
                          ...formData.testEquipment.lowResistance,
                          model: value,
                        },
                      })
                    }
