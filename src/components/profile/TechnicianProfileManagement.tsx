                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="md:col-span-2">
                            ...
                            <textarea
                              ...
                              className="w-full p-2 border rounded-md dark:bg-dark-150 dark:border-gray-700 min-h-[100px]"
                            />
                          </div>
                        </div>
                              ...
                              <CardContent className="p-4">
                                <div className="flex justify-between">
                                  <div>
                                    ...
                                    {/* Notes (if any) */}
                                    {skill.notes && (
                                      <p className="mt-2 text-sm text-gray-600 dark:text-white truncate max-w-md">
                                        {skill.notes}
                                      </p>
                                    )}
                                  </div>
