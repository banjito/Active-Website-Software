  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 dark:text-white">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 print:hidden te-onscreen">
          <div>
            <label htmlFor="megohmmeter" className="form-label block">Megohmmeter:</label>
            <input id="megohmmeter" type="text" value={formData.testEquipment.megohmmeter} onChange={(e) => handleChange('testEquipment', 'megohmmeter', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
          </div>
          <div>
