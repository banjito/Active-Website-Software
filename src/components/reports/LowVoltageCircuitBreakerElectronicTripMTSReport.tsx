...
// Rename component
const LowVoltageCircuitBreakerElectronicTripMTSReport: React.FC<{ printMode?: boolean }> = (props) => {
  ...
  const reportSlug = 'low-voltage-circuit-breaker-electronic-trip-mts-report'; // This component handles the low-voltage-circuit-breaker-electronic-trip-mts-report route
    ...
    <div className={printMode ? 'print-report' : 'screen-report'}>
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
          8-Low Voltage Circuit Breaker Electronic Trip Unit MTS {/* Updated Title */}
        </h1>
