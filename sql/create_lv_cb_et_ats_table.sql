...
DROP TABLE IF EXISTS neta_ops.low_voltage_circuit_breaker_electronic_trip_ats;
...
CREATE TABLE neta_ops.low_voltage_circuit_breaker_electronic_trip_ats (
    ...
    primary_injection JSONB DEFAULT '{}',  -- Changed from trip_testing to primary_injection
...
CREATE INDEX IF NOT EXISTS lv_cb_et_ats_job_id_idx
ON neta_ops.low_voltage_circuit_breaker_electronic_trip_ats(job_id);

CREATE INDEX IF NOT EXISTS lv_cb_et_ats_user_id_idx
ON neta_ops.low_voltage_circuit_breaker_electronic_trip_ats(user_id);
