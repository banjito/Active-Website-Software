    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 print:hidden test-eqpt-onscreen mt-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({
                  ...
                  testEquipment: {
                    ...prev.testEquipment,
                    lowResistanceOhmmeter: { ...((prev.testEquipment as any).lowResistanceOhmmeter || { serialNumber: '', ampId: '' }), name: e.target.value } as any
                  }
                }))}
                readOnly={!isEditing}
                placeholder="Enter Equipment Name"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({
                  ...
                  testEquipment: {
                    ...prev.testEquipment,
                    lowResistanceOhmmeter: { ...((prev.testEquipment as any).lowResistanceOhmmeter || { name: '', ampId: '' }), serialNumber: e.target.value } as any
                  }
                }))}
                readOnly={!isEditing}
                placeholder="Enter Serial Number"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({
                  ...
                  testEquipment: {
                    ...prev.testEquipment,
                    lowResistanceOhmmeter: { ...((prev.testEquipment as any).lowResistanceOhmmeter || { name: '', serialNumber: '' }), ampId: e.target.value } as any
                  }
                }))}
                readOnly={!isEditing}
                placeholder="Enter AMP ID"
