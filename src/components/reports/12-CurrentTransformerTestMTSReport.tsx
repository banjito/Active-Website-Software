            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="form-input bg-gray-50 dark:bg-dark-150"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-white">
                ...
                <thead className="bg-gray-50 dark:bg-dark-150">
                  <tr>
                    {[
                      ...
                      <th
                        key={header}
                        className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider"
                      >
                        {header === "Test Current" ||
                        header === "Test Voltage" ? (
          ...
          <div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-300 dark:border-gray-600">
                  ...
                  <tr>
                    ...
                    {["Phase 1", "Phase 2", "Phase 3", "Neutral"].map(
                      (header) => (
                        <th
                          key={header}
                          className="px-4 py-2 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider"
                        >
                          {header}
                        </th>
                      ),
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-700 dark:text-white">
                      Reading
                    </td>
                    {[
                      "readingPhase1",
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                <EquipmentAutocomplete
                  ...
                  onChange={(value) =>
                    handleChange("testEquipmentUsed.ctRatioTestSetName", value)
                  }
                  onSelect={(equipment) => {
                    const formatDate = (dateString: string | null): string => {
                      if (!dateString) return "";
            ...
            <table className="w-full table-fixed border-collapse border border-gray-200 dark:border-gray-700">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {formData.testEquipmentUsed.ctRatioTestSetCalDate || ""}
                  </td>
                </tr>
              </tbody>
            </table>
