            ...
            {job && (
              <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{maskJobTitle(job.title)}</dd>
                </div>
                <div className="sm:col-span-1">
            ...
            {customer ? (
              <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{maskCustomerName(customer.company_name) || 'Not specified'}</dd>
                </div>
                <div className="sm:col-span-1">
                ...
                <div className="sm:col-span-2">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{maskCustomerAddress(customer.address) || 'Not specified'}</dd>
                </div>
              </dl>
            ) : (
