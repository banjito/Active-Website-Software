    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="p-6 flex justify-center">
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600 dark:text-white ml-4">TCF</span>
                  <input
                    type="number"
        ...
        <section className="mb-6">
          ...
          <div className="mb-4">
            <div className="flex items-center mb-2">
              <span className="text-sm font-medium text-gray-700 dark:text-white mr-2">INSULATION RESISTANCE TEST VOLTAGE:</span>
              <input 
                type="text" 
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600" style={{ tableLayout: 'fixed' }}>
              ...
              <thead>
                <tr>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">WAY SECTION</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A-G</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B-G</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C-G</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A-B</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B-C</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C-A</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">UNITS</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="mb-4">
            <div className="flex items-center mb-2">
              <span className="text-sm font-medium text-gray-700 dark:text-white mr-2">INSULATION RESISTANCE TEST VOLTAGE: {formData.s1_insulationResistance.testVoltage}</span>
                      </div>
                    </div>
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600" style={{ tableLayout: 'fixed' }}>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600" style={{ tableLayout: 'fixed' }}>
              ...
              <thead>
                <tr>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">WAY SECTION</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A-PHASE</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A-GROUND</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B-PHASE</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B-GROUND</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C-PHASE</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C-GROUND</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">UNITS</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="mb-6">
          ...
          <div className="mb-4">
            <div className="flex items-center mb-2">
              <span className="text-sm font-medium text-gray-700 dark:text-white mr-2">DIELECTRIC WITHSTAND TEST VOLTAGE:</span>
              <input 
                type="text" 
            ...
            <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600" style={{ tableLayout: 'fixed' }}>
              ...
              <thead>
                <tr>
                  ...
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                  <th colSpan={2} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">Counter</th>
                  <th colSpan={3} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">Vacuum Integrity (VFI Open)</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                </tr>
                <tr>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">VFI</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">Serial Number</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">As-Found</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">As-Left</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">A</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">B</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">C</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">Units</th>
                ...
                <tr>
                  ...
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                  <th colSpan={3} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150">Test Voltage: 30 KVAC</th>
                  <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-sm font-medium bg-gray-100 dark:bg-dark-150"></th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 mb-4 print:hidden test-eqpt-onscreen">
            <div>
              ...
              <EquipmentAutocomplete
                ...
                onChange={(value) => handleChange('testEquipment_megohmmeter_megger', value)}
                onSelect={(equipment) => {
                  ...
                  handleChange('testEquipment_megohmmeter_megger', equipment.equipment_name);
                  handleChange('testEquipment_megohmmeter_serialNo', equipment.serial_number || '');
                  handleChange('testEquipment_megohmmeter_ampId', equipment.amp_id || '');
                  handleChange('testEquipment_megohmmeter_calDate', formatLocalDateShort(equipment.calibration_date));
                }}
                readOnly={!isEditMode}
                className="w-full"
              />
            ...
            <div>
              ...
              <input type="text" value={formData.testEquipment_megohmmeter_calDate} onChange={(e) => handleChange('testEquipment_megohmmeter_calDate', e.target.value)} readOnly={!isEditMode} className="form-input" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 mb-4 print:hidden test-eqpt-onscreen">
            <div>
              ...
              <EquipmentAutocomplete
                ...
                onChange={(value) => handleChange('testEquipment_lowResistance_model', value)}
                onSelect={(equipment) => {
                  const formatDate = (dateString: string | null): string => {
                    if (!dateString) return '';
                    try {
                  ...
                  handleChange('testEquipment_lowResistance_model', equipment.equipment_name);
                  handleChange('testEquipment_lowResistance_serialNo', equipment.serial_number || '');
                  handleChange('testEquipment_lowResistance_ampId', equipment.amp_id || '');
                  handleChange('testEquipment_lowResistance_calDate', formatLocalDateShort(equipment.calibration_date));
                }}
                readOnly={!isEditMode}
                className="w-full"
              />
            ...
            <div>
              <label className="form-label">Cal Date</label>
              <input type="text" value={formData.testEquipment_lowResistance_calDate} onChange={(e) => handleChange('testEquipment_lowResistance_calDate', e.target.value)} readOnly={!isEditMode} className="form-input" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4 print:hidden test-eqpt-onscreen">
            <div>
              ...
              <EquipmentAutocomplete
                ...
                onChange={(value) => handleChange('testEquipment_hipot_model', value)}
                onSelect={(equipment) => {
                  const formatDate = (dateString: string | null): string => {
                    if (!dateString) return '';
                    try {
                  ...
                  handleChange('testEquipment_hipot_model', equipment.equipment_name);
                  handleChange('testEquipment_hipot_serialNo', equipment.serial_number || '');
                  handleChange('testEquipment_hipot_ampId', equipment.amp_id || '');
                  handleChange('testEquipment_hipot_calDate', formatLocalDateShort(equipment.calibration_date));
                }}
                readOnly={!isEditMode}
                className="w-full"
              />
            ...
            <div>
              <label className="form-label">Cal Date</label>
              <input type="text" value={formData.testEquipment_hipot_calDate} onChange={(e) => handleChange('testEquipment_hipot_calDate', e.target.value)} readOnly={!isEditMode} className="form-input" />
            </div>
          </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="p-2 border border-gray-300 print:border-black">
                    ...
                    <div className="text-xs">{formData.testEquipment_megohmmeter_calDate || ''}</div>
                  </td>
                </tr>
                <tr>
                  <td className="p-2 border border-gray-300 print:border-black">
                  ...
                  <td className="p-2 border border-gray-300 print:border-black">
                    <div className="font-semibold text-xs">Cal Date:</div>
                    <div className="text-xs">{formData.testEquipment_lowResistance_calDate || ''}</div>
                  </td>
                </tr>
                <tr>
                  <td className="p-2 border border-gray-300 print:border-black">
                  ...
                  <td className="p-2 border border-gray-300 print:border-black">
                    <div className="font-semibold text-xs">Cal Date:</div>
                    <div className="text-xs">{formData.testEquipment_hipot_calDate || ''}</div>
                  </td>
                </tr>
              </tbody>
            </table>
