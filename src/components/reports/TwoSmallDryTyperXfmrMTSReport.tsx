...
const TwoSmallDryTyperXfmrMTSReport: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const nextTests = formData.insulationResistance.tests.map(test => {
      const corrected0_5Min = calculateCorrectedIRValue(test.measured0_5Min, tcf);
              ...
              <tbody>
                <tr>
                  <td className="p-2 border border-black">
                    ...
                    <div className="text-xs">{formData.testEquipment.megohmmeter.name || ''}</div>
                    ...
                    {formData.testEquipment.megohmmeter.calDate && <div className="text-xs">Cal Date: {formData.testEquipment.megohmmeter.calDate}</div>}
                  </td>
                  <td className="p-2 border border-black">
                    <div className="font-semibold text-xs">TTR Test Set:</div>
                    <div className="text-xs">{formData.testEquipment.ttrTestSet.name || ''}</div>
                    <div className="text-xs">S/N: {formData.testEquipment.ttrTestSet.serialNumber || ''}</div>
                    <div className="text-xs">AMP ID: {formData.testEquipment.ttrTestSet.ampId || ''}</div>
                    {formData.testEquipment.ttrTestSet.calDate && <div className="text-xs">Cal Date: {formData.testEquipment.ttrTestSet.calDate}</div>}
                  </td>
                </tr>
              </tbody>
            </table>
