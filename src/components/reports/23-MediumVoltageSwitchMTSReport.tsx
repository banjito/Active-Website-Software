...
const initialVisualRows: VisualRow[] = [
  ...
  },
  {
    neta: "7.5.1.2.A.7",
    description:
      "Verify that expulsion-limiting devices are in place on all fuses having expulsion-type elements.",
    result: "",
  },
  {
    neta: "7.5.1.2.A.8",
  ...
  {
    neta: "7.5.1.2.A.11",
    description: "Verify that phase-barrier mounting is intact.",
    result: "",
  },
  {
    neta: "7.5.1.2.A.12",
...
const MediumVoltageSwitchMTSReport: React.FC = () => {
  ...
  useAssetFormPrefill(openReportId, setForm);
    ...
    setForm((prev) => {
      ...
      const corrected = prev.insulation.rows.map((r) => {
        const parse = (v: string) => {
          ...
          const [int, dec] = (n * tcf).toFixed(2).split(".");
          return int.replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "." + dec;
        };
        return {
          label: r.label,
          readings: {
            p1: parse(r.readings.p1),
            p2: parse(r.readings.p2),
            p3: parse(r.readings.p3),
          },
        };
      });
      ...
      if (jobData?.customer_id) {
        ...
        setForm((prev) => ({
          ...
          customer: maskCustomerName(
            (customerData as any)?.company_name ||
              (customerData as any)?.name ||
              "",
          ),
  ...
  const reportDataRef = React.useRef({ form, status });
  useEffect(() => {
    reportDataRef.current = { form, status };
  }, [form, status]);
  ...
  const persistReport = React.useCallback(async () => {
    ...
    const { form, status } = reportDataRef.current;
    ...
    if (!assetLinkedRef.current) {
      await ensureReportAssetLink(
        jobId,
        {
          name: getAssetName(
            reportSlug,
            form.identifier || form.eqptLocation || "",
          ),
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                ...
                onChange={(e) => setJobInfo("customer", e.target.value)}
                readOnly={!isEditMode}
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                type="text"
                value={form.user}
                onChange={(e) => setJobInfo("user", e.target.value)}
                readOnly={!isEditMode}
                className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
              />
            </div>
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                ...
                onChange={(e) => setJobInfo("identifier", e.target.value)}
                readOnly={!isEditMode}
                className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
              />
            </div>
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                ...
                onChange={(e) => setJobInfo("technicians", e.target.value)}
                readOnly={!isEditMode}
                className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
              />
            </div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setForm((prev) => ({
                      ...
                      temperature: {
                        ...prev.temperature,
                        fahrenheit: isNaN(f) ? ("" as any) : f,
                        celsius: isNaN(c) ? ("" as any) : c,
                        tcf: t,
                      },
                    }));
                  }}
            ...
            <div className="flex items-center flex-1">
              <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
                <input
                  ...
                  onChange={(e) => setTemp("humidity", Number(e.target.value))}
                  readOnly={!isEditMode}
                  className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
                />
              </div>
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                ...
                onChange={(e) => setJobInfo("substation", e.target.value)}
                readOnly={!isEditMode}
                className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
              />
            </div>
          ...
          <div className="mb-4 flex">
            ...
            <div className="flex-1 border-b border-neutral-300 dark:border-neutral-600">
              <input
                ...
                onChange={(e) => setJobInfo("eqptLocation", e.target.value)}
                readOnly={!isEditMode}
                className={`w-full bg-transparent border-none focus:ring-0 ${!isEditMode ? "cursor-default" : ""}`}
              />
            </div>
  ...
  const nameplate = (
    <section className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:hidden">
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            ...
            value={form.nameplate.manufacturer}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, manufacturer: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.icRatingKa}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, icRatingKa: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.catalogNumber}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, catalogNumber: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.ratedVoltageKv}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, ratedVoltageKv: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.serialNumber}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, serialNumber: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.operatingVoltageKv}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: {
                  ...p.nameplate,
                  operatingVoltageKv: e.target.value,
                },
              }))
            }
          />
        ...
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.ampacity}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, ampacity: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.mfgDate}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, mfgDate: e.target.value },
              }))
            }
          />
        </div>
        <div className="grid grid-cols-3 items-center gap-2">
          ...
          <input
            className="form-input col-span-2"
            value={form.nameplate.impulseBil}
            readOnly={!isEditMode}
            onChange={(e) =>
              setForm((p) => ({
                ...p,
                nameplate: { ...p.nameplate, impulseBil: e.target.value },
              }))
            }
          />
        </div>
      ...
      <div className="hidden print:block">
        <table className="w-full table-fixed border-collapse border border-neutral-300 print:border-black print:border text-[0.85rem] mv-center-table">
          <colgroup>
            <col style={{ width: "20%" }} />
            <col style={{ width: "20%" }} />
            <col style={{ width: "20%" }} />
          ...
          <tbody>
            <tr>
              <td className="p-2 align-middle text-center border border-neutral-300 print:border-black">
  ...
  const visual = (
    <section className="mb-6">
      ...
      <table
        className="hidden print:table w-full border-collapse"
        style={{ fontSize: "9px" }}
      >
        <colgroup>
          <col style={{ width: "10%" }} />
        ...
        <thead>
          <tr>
            <th
              className="border border-black p-1 text-left bg-neutral-100"
            ...
            <th
              className="border border-black p-1 text-center bg-neutral-100"
              style={{ backgroundColor: "#f0f0f0" }}
            >
              Results
            </th>
  ...
  const fuseData = (
    <section className="mb-6">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border border-neutral-300 dark:border-neutral-700 mv-center-table">
          <colgroup>
              ...
              <td className="p-2 align-top border border-neutral-300 dark:border-neutral-700 print:text-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      fuseData: { ...p.fuseData, manufacturer: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
              ...
              <td className="p-2 align-top border border-neutral-300 dark:border-neutral-700 print:text-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      fuseData: { ...p.fuseData, className: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                  className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
              ...
              <td className="p-2 align-top border border-neutral-300 dark:border-neutral-700 print:text-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      fuseData: { ...p.fuseData, ampacityA: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                  className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
              ...
              <td className="p-2 align-top border border-neutral-300 dark:border-neutral-700 print:text-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      fuseData: { ...p.fuseData, icRatingKa: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                  className={`mt-1 block w-full rounded-none border-neutral-300 dark:border-neutral-700 shadow-sm focus:border-brand focus:ring-brand ${!isEditMode ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
  ...
  const contactTable = (
    ...
    <div className="border border-neutral-300 dark:border-neutral-700 p-3">
          ...
          {(["switch", "fuse", "switchFuse"] as const).map((row) => (
            <tr key={row}>
              <td className="border p-2 capitalize">
                {row === "switchFuse" ? "Switch + Fuse" : row}
              </td>
              {(["p1", "p2", "p3"] as const).map((ph) => (
                <td key={ph} className="border p-1">
                  <input
                    className="form-input"
                    value={(form as any)[key][row][ph]}
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        [key]: {
              ...
              <td className="border p-1">
                <select
                  className="form-select"
                  value={(form as any)[key].units}
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      [key]: { ...(p as any)[key], units: e.target.value },
                    }))
                  }
                  disabled={!isEditMode}
                >
    ...
    <section className="mb-6">
          ...
          <div className="mb-2 flex items-center gap-2 text-sm">
            ...
            <select
              ...
              onChange={(e) =>
                setForm((p) => ({
                  ...p,
                  insulation: { ...p.insulation, testVoltage: e.target.value },
                }))
              }
              disabled={!isEditMode}
            >
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm((p) => ({
                            ...
                            insulation: {
                              ...p.insulation,
                              rows: p.insulation.rows.map((rr, i) =>
                                i === idx
                                  ? {
                                      ...rr,
                                      readings: {
      ...
      <div className="hidden print:grid grid-cols-2 gap-2 mt-2">
        ...
        <table className="w-full border border-neutral-300 print:border-black">
          <thead>
            <tr>
              <th colSpan={5} className="border p-2 text-left bg-neutral-50">
                Contact Resistance (As Found)
              </th>
            </tr>
            <tr>
        ...
        <table className="w-full border border-neutral-300 print:border-black">
          ...
          <thead>
            <tr>
              <th colSpan={4} className="border p-2 text-left bg-neutral-50">
                Insulation Resistance
              </th>
            </tr>
            <tr>
              <th className="border p-1 text-left">
                Test Voltage {form.insulation.testVoltage}
              </th>
        ...
        <table className="w-full border border-neutral-300 print:border-black">
          <thead>
            <tr>
              <th colSpan={3} className="border p-2 text-left bg-neutral-50">
                Temperature Corrected
              </th>
            </tr>
            <tr>
        ...
        <table className="w-full border-collapse border border-neutral-300 dark:border-neutral-700">
          <thead>
            <tr>
              <th
                colSpan={6}
                className="border border-neutral-300 dark:border-neutral-700 px-2 py-1 text-center"
              >
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1 text-center font-semibold">
                P1
              </td>
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1 text-center font-semibold">
                P2
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1 font-semibold">
                Units
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1">
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      dielectric: { ...p.dielectric, duration: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                />
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1">
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      dielectric: { ...p.dielectric, p1: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                />
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1">
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      dielectric: { ...p.dielectric, p2: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                />
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1">
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      dielectric: { ...p.dielectric, p3: e.target.value },
                    }))
                  }
                  readOnly={!isEditMode}
                />
              ...
              <td className="border border-neutral-300 dark:border-neutral-700 px-2 py-1">
                <select
                  ...
                  onChange={(e) =>
                    setForm((p) => ({
                      ...p,
                      dielectric: { ...p.dielectric, units: e.target.value },
                    }))
                  }
                  disabled={!isEditMode}
                >
  ...
  const equipment = (
    <section className="mb-6">
      ...
      <div className="print:hidden">
        {(
          ...
          <div key={key} className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-2">
            <div className="grid grid-cols-3 items-center gap-2">
              <label className="form-label text-center w-full">{label}:</label>
              <input
                className="form-input col-span-2"
                value={(form.equipmentUsed as any)[key].name}
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    equipmentUsed: {
            ...
            <div className="grid grid-cols-3 items-center gap-2">
              <label className="form-label text-center w-full">
                Serial Number:
              </label>
              <input
                className="form-input col-span-2"
                value={(form.equipmentUsed as any)[key].serialNumber}
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    equipmentUsed: {
            ...
            <div className="grid grid-cols-3 items-center gap-2">
              <label className="form-label text-center w-full">AMP ID:</label>
              <input
                className="form-input col-span-2"
                value={(form.equipmentUsed as any)[key].ampId}
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    equipmentUsed: {
            ...
            <div className="grid grid-cols-3 items-center gap-2">
              <label className="form-label text-center w-full">Cal Date:</label>
              <input
                className="form-input col-span-2"
                value={(form.equipmentUsed as any)[key].calDate}
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    equipmentUsed: {
      ...
      <div className="hidden print:block">
        <table className="w-full table-fixed border-collapse border border-neutral-300 print:border-black print:border text-[0.85rem] mv-center-table test-eqpt-print">
          <colgroup>
            <col style={{ width: "33.33%" }} />
            <col style={{ width: "33.33%" }} />
            <col style={{ width: "33.33%" }} />
