...
const tableStyles = {
  ...
  headerCell:
    "px-2 py-1 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase tracking-wider whitespace-normal",
  cell: "px-2 py-1 text-sm text-neutral-900 dark:text-white whitespace-normal",
  input:
    "w-full text-sm py-1 rounded-none border-neutral-300 shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white",
  select:
    "w-full text-sm py-1 rounded-none border-neutral-300 shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white",
};
  ...
  if (readOnly) {
    return (
      <input
        ...
        value={searchTerm}
        readOnly
        className={`form-input bg-neutral-100 dark:bg-dark-150 ${className}`}
      />
    );
  }
  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      ...
      {isOpen && filteredOptions.length > 0 && (
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-dark-150 border border-neutral-300 dark:border-neutral-600 rounded-none shadow-lg max-h-60 overflow-auto">
          {filteredOptions.map((option, index) => (
            <div
              key={index}
              onClick={() => handleSelect(option)}
              className="px-3 py-2 cursor-pointer hover:bg-neutral-100 dark:hover:bg-dark-100 text-sm"
            >
...
const LowVoltageCircuitBreakerElectronicTripMTSReport: React.FC = () => {
  ...
  const [isEditing, setIsEditing] = useState<boolean>(!openReportId);
   ...
   * button -- goes through here, and they all write to one row of the shared
   * JSONB store, tagged with `reportType`.
   *
   ...
   * another copy of the same breaker on the job. The upsert also replaces the
   * old "update returned no rows, try an upsert" RLS fallback, which is now
   * simply how every save is written.
   */
        ...
        <div className="max-w-7xl w-full space-y-6">
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed border-collapse border border-neutral-300 dark:border-neutral-600 visual-mechanical-table">
                <colgroup>
                  <col style={{ width: "15%" }} />
                  <col style={{ width: "65%" }} />
                  <col style={{ width: "20%" }} />
          ...
          {!formData.irDlroOnly && (
            <section className="mb-6 primary-injection-section">
                        ...
                        <div className="flex gap-3">
                          <div className="flex-1 min-w-[100px]">
                            ...
                            <input
                              ...
                              readOnly={!isEditing}
                              className="w-full px-4 py-2 text-base border border-neutral-300 dark:border-neutral-600 rounded-none shadow-sm focus:outline-none focus:ring-brand focus:border-brand dark:bg-dark-150 dark:text-white text-left"
                              placeholder="Min"
              ...
              <div className="relative overflow-x-auto shadow-md sm:rounded-none primary-injection-container print:hidden">
              ...
              <div className="hidden print:block primary-injection-pdf-layout">
                <table className="w-full table-fixed border-collapse border border-neutral-300 print:border-black primary-injection-main-pdf-table">
                  <colgroup>
                    <col style={{ width: "16%" }} />
                    <col style={{ width: "12%" }} />
                    <col style={{ width: "14%" }} />
                ...
                <table className="w-full table-fixed border-collapse border border-neutral-300 print:border-black primary-injection-poles-pdf-table">
                  <colgroup>
                    <col style={{ width: "18%" }} />
                    <col style={{ width: "16%" }} />
                    <col style={{ width: "22%" }} />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <input
                    ...
                    readOnly={!isEditing}
                    className={`form-input w-full text-neutral-900 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                  />
                </div>
                <div className="min-w-0">
                  <label className="block text-sm font-medium text-neutral-900 dark:text-white mb-1">
          ...
          <div className="mb-6 print:hidden">
            ...
            <div className="mb-4">
              <textarea
                ...
                readOnly={!isEditing}
                className={`w-full p-2 rounded-none border-neutral-300 shadow-sm focus:border-brand focus:ring-brand dark:bg-dark-150 dark:text-white ${!isEditing ? "bg-neutral-100 dark:bg-dark-150" : ""}`}
                rows={4}
              />
            </div>
          </div>
