...
export const GoalPerformanceTable: React.FC<GoalPerformanceTableProps> = ({ 
  ...
  const getStatusBadgeVariant = (status: string): "success" | "warning" | "danger" | undefined => {
    switch (status) {
      case 'on-track':
        return 'success';
      case 'at-risk':
                ...
                <TableRow key={team.teamId}>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      <Badge variant="success">{team.goalsOnTrack} on track</Badge>
                      <Badge variant="warning">{team.goalsAtRisk} at risk</Badge>
                      <Badge variant="danger">{team.goalsBehind} behind</Badge>
                    </div>
                  </TableCell>
                </TableRow>
              ))}
