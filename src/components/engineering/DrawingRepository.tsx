...
const mockDrawings = [
  {
    ...
    revision: "Rev. 2",
    description:
      "Layout design for the main pump station including dimensions and equipment placement.",
  },
  {
    id: "DWG-2023-002",
    ...
    revision: "Rev. 1",
    description:
      "Detailed electrical schematic for control panel including wiring diagrams.",
  },
  {
    id: "DWG-2023-003",
    ...
    revision: "Rev. 1",
    description:
      "Foundation structural details and reinforcement specifications.",
  },
  {
    id: "DWG-2023-004",
    title: "HVAC Ductwork",
    ...
    revision: "Rev. 3",
    description:
      "Ductwork layout and ventilation system design for the second floor.",
  },
  {
    id: "DWG-2023-005",
    title: "Site Plan",
    ...
    revision: "Rev. 1",
    description:
      "Overall site plan showing building footprint, access roads, and utilities.",
  },
];
            ...
            <Card className="w-full max-w-3xl max-h-[90vh] overflow-y-auto">
              <CardHeader>
                ...
                <CardDescription>
                  <div className="flex justify-between">
                    <span>
                      {selectedDrawing.id} - {selectedDrawing.revision}
                    </span>
              ...
              <form onSubmit={handleAddDrawing} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={newDrawing.id}
                      onChange={(e) =>
                        setNewDrawing({ ...newDrawing, id: e.target.value })
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewDrawing({ ...newDrawing, author: e.target.value })
                      }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDrawing({ ...newDrawing, date: e.target.value })
                    }
                    required
                  />
                </div>
