          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-white">Technicians</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-white">Scheduled Jobs</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-white">Skills Tracked</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-white">Jobs This Week</p>
