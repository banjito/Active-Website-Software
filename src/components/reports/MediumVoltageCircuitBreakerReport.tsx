    ...
    try {
      ...
      if (reportId) {
        ...
        if (result.data) {
          ...
          if (equipmentAssetId) {
            await setReportAssetEquipmentLink(newAsset.id, equipmentAssetId);
          }
            ...
            <div className="grid grid-cols-4 gap-4 mt-4 print:hidden job-info-onscreen">
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="mt-1 block w-20 rounded-none border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-dark-150 shadow-sm dark:text-white"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-white">
