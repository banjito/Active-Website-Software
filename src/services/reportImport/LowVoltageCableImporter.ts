...
export class LowVoltageCableImporter extends BaseImporter implements ReportImporter {
  protected tableName = 'low_voltage_cable_test_3sets'; // Use the 3-sets table
  ...
  protected getReportType(): string {
    return 'low-voltage-cable-test-3sets'; // Route to the 3-sets MTS component
  }
}
