...
const LiquidFilledXfmrATS25Report: React.FC = () => {
    ...
    try {
      ...
      if (data) {
        ...
        setFormData((prev) => ({
          ...
          indicatorGaugeValues:
            info.indicatorGaugeValues || prev.indicatorGaugeValues,
          visualInspectionItems: vmItems.length
            ? vmItems
            : prev.visualInspectionItems,
          visualMechanicalComments:
            vm.comments || prev.visualMechanicalComments,
          insulationTemperature:
          ...
          dielectricAbsorption:
            ir.dielectricAbsorption || prev.dielectricAbsorption,
  ...
  useEffect(() => {
    ...
    const daValues = [daPrimary, daSecondary, daPriToSec]
      .map((v) => parseFloat(v))
      .filter((n) => isFinite(n));
    const daAcceptable: "Pass" | "Fail" | "" =
      daValues.length > 0
        ? daValues.every((v) => v >= 1.0)
          ? "Pass"
          : "Fail"
        : "";

    const piValues = [piPrimary, piSecondary, piPriToSec]
      .map((v) => parseFloat(v))
      .filter((n) => isFinite(n));
    const piAcceptable: "Pass" | "Fail" | "" =
      piValues.length > 0
        ? piValues.every((v) => v >= 1.0)
          ? "Pass"
          : "Fail"
        : "";
  ...
  const autoSave = React.useCallback(async () => {
    ...
    const payload = {
      ...
      visual_mechanical: {
        ...
        comments: formData.visualMechanicalComments,
      },
      ...
      <div className="print:flex hidden items-center justify-between border-b-2 border-neutral-800 pb-4 mb-6">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-2xl font-bold text-black mb-1">
            7.2.2 Liquid Filled Xfmr. Visual, Mechanical,
            <br />
      ...
      <div className="p-6 flex justify-center print:p-0 print:block">
        <div className="max-w-7xl w-full space-y-6 print:max-w-none print:space-y-2">
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700 table-fixed visual-mechanical-table">
                <colgroup>
                  <col style={{ width: "12%" }} />
                  <col style={{ width: "68%" }} />
                  <col style={{ width: "20%" }} />
          ...
          <div className="mb-6">
            ...
            <textarea
              value={formData.visualMechanicalComments || ""}
              onChange={(e) =>
                setFormData((p) => ({
                  ...p,
                  visualMechanicalComments: e.target.value,
                }))
              }
              rows={4}
              readOnly={!isEditing}
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700 border border-neutral-200 dark:border-neutral-700 table-fixed w-full">
                <colgroup>
                ...
                <thead>
                  <tr>
                    <th
                      className="px-1 py-2 bg-neutral-50 dark:bg-dark-150 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase border border-neutral-200 dark:border-neutral-700 print:text-[7px]"
                      rowSpan={2}
                    >
                  ...
                  <tr>
                    <th className="px-1 py-2 bg-neutral-50 dark:bg-dark-150 text-center text-xs font-medium text-neutral-500 dark:text-white border border-neutral-200 dark:border-neutral-700">
                      0.5 Min.
                    </th>
                    <th className="px-1 py-2 bg-neutral-50 dark:bg-dark-150 text-center text-xs font-medium text-neutral-500 dark:text-white border border-neutral-200 dark:border-neutral-700">
                      1 Min.
                ...
                <tbody className="bg-white dark:bg-dark-150 divide-y divide-neutral-200 dark:divide-neutral-700">
                  {formData.insulationRows.map((row, idx) => (
                    <tr key={idx}>
                      <td
                        className="px-1 py-2 text-xs text-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-700"
                        style={{ whiteSpace: "normal", wordWrap: "break-word" }}
                      >
                        {row.windingUnderTest}
                      </td>
                      <td className="px-1 py-2 border border-neutral-200 dark:border-neutral-700 align-middle">
                        <div className="print:hidden">
                          <select
                            value={row.testVoltage}
                            onChange={(e) => {
                              const rows = [...formData.insulationRows];
                              rows[idx].testVoltage = e.target.value;
                              setFormData((p) => ({
                                ...p,
                                insulationRows: rows,
                              }));
                        ...
                        <div className="hidden print:block text-center text-sm text-neutral-900 dark:text-white font-medium">
                          {row.testVoltage}
                        </div>
                      </td>
                      <td className="px-1 py-2 border border-neutral-200 dark:border-neutral-700">
                        <input
                      ...
                      <td className="px-1 py-2 border border-neutral-200 dark:border-neutral-700">
                        <input
                          ...
                          onChange={(e) => {
                            const rows = [...formData.insulationRows];
                            rows[idx].measured10Min = e.target.value;
                            setFormData((p) => ({
                              ...p,
                              insulationRows: rows,
                            }));
                      ...
                      <td className="px-2 py-2 border border-neutral-200 dark:border-neutral-700 align-middle">
                        <select
                      ...
                      <td className="px-1 py-2 text-center text-sm text-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-700">
                        {row.corrected05Min || ""}
                      </td>
                      <td className="px-1 py-2 text-center text-sm text-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-700">
                        {row.corrected1Min || ""}
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700 border border-neutral-200 dark:border-neutral-700 table-fixed w-full">
                ...
                <thead>
                  <tr>
                    <th className="px-2 py-2 bg-neutral-50 dark:bg-dark-150 text-left text-xs font-medium text-neutral-500 dark:text-white uppercase border border-neutral-200 dark:border-neutral-700 print:text-[7px]"></th>
                    <th className="px-2 py-2 bg-neutral-50 dark:bg-dark-150 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase border border-neutral-200 dark:border-neutral-700 print:text-[7px]"></th>
                    <th className="px-2 py-2 bg-neutral-50 dark:bg-dark-150 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase border border-neutral-200 dark:border-neutral-700 print:text-[7px]">
                      Primary
                    </th>
                    <th className="px-2 py-2 bg-neutral-50 dark:bg-dark-150 text-center text-xs font-medium text-neutral-500 dark:text-white uppercase border border-neutral-200 dark:border-neutral-700 print:text-[7px]">
                      Secondary
                ...
                <tbody className="bg-white dark:bg-dark-150">
                  <tr>
                    <td className="px-2 py-2 text-xs font-medium text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
                      Dielectric Absorption
                    </td>
                    <td className="px-2 py-2 text-xs text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
                      : (Ratio of 1 Minute to 0.5 Minute Result)
                    </td>
                    <td className="px-2 py-2 text-center text-sm border border-neutral-200 dark:border-neutral-700">
                    ...
                    <td
                      className={`px-2 py-2 text-center text-sm font-semibold border border-neutral-200 dark:border-neutral-700 ${formData.dielectricAbsorption.acceptable === "Pass" ? "text-green-600 bg-green-100 dark:bg-green-900 print:bg-green-100" : formData.dielectricAbsorption.acceptable === "Fail" ? "text-red-600 bg-red-100 dark:bg-red-900 print:bg-red-100" : ""}`}
                    >
                  ...
                  <tr>
                    ...
                    <td
                      className={`px-2 py-2 text-center text-sm font-semibold border border-neutral-200 dark:border-neutral-700 ${formData.polarizationIndex.acceptable === "Pass" ? "text-green-600 bg-green-100 dark:bg-green-900 print:bg-green-100" : formData.polarizationIndex.acceptable === "Fail" ? "text-red-600 bg-red-100 dark:bg-red-900 print:bg-red-100" : ""}`}
                    >
