          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                <li 
                  className={`p-2 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-between ${selectedFolder === null ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
                ...
                {folders.map((folder) => (
                  <li 
                    key={folder.id} 
                    className={`p-2 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-between ${selectedFolder === folder.id ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
