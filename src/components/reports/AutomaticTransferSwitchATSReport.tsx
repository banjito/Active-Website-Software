...
const AutomaticTransferSwitchATSReport: React.FC = () => {
  ...
  const renderInsulationRow = (stateKey: keyof FormData['insulationResistance'], title: string, hasNeutral: boolean = false) => {
    ...
    return (
      <tr>
        <td className="px-6 py-4 text-sm text-gray-700 dark:text-white whitespace-nowrap">{title}</td>
        {(['p1', 'p2', 'p3'] as const).map(pole => (
          <React.Fragment key={pole}>
            <td className="px-3 py-4">
              <input type="text" value={rowData[pole + 'Reading'] || ''} onChange={(e) => handleInsulationResistanceChange(stateKey, pole + 'Reading', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </td>
            <td className="px-3 py-4">
              <input type="text" value={rowData[pole + 'Corrected'] || ''} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" />
            </td>
          </React.Fragment>
        ))}
        {hasNeutral ? (
           <React.Fragment>
            <td className="px-3 py-4">
              <input type="text" value={rowData.neutralReading || ''} onChange={(e) => handleInsulationResistanceChange(stateKey, 'neutralReading', e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
            </td>
            <td className="px-3 py-4">
              <input type="text" value={rowData.neutralCorrected || ''} readOnly className="form-input w-full text-center bg-gray-100 dark:bg-dark-150" />
            </td>
          </React.Fragment>
        ) : (
          <><td className="px-3 py-4 bg-gray-50 dark:bg-dark-150"></td><td className="px-3 py-4 bg-gray-50 dark:bg-dark-150"></td></>
        )}
        <td className="px-6 py-4">
          <select value={rowData.units || 'MΩ'} onChange={(e) => handleInsulationResistanceChange(stateKey, 'units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
    ...
    <ReportWrapper isPrintMode={isPrintMode}>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden">
            ...
            <div className="md:col-span-2 lg:col-span-3"><label className="form-label">Address:</label><input type="text" value={maskCustomerAddress(formData.customerLocation)} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-full" /></div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-x-4 gap-y-2 print:hidden nameplate-grid">
            <div><label htmlFor="nameplateManufacturer" className="form-label">Manufacturer:</label><input id="nameplateManufacturer" type="text" value={formData.nameplateManufacturer} onChange={(e) => handleChange('nameplateManufacturer', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateModelType" className="form-label">Model / Type:</label><input id="nameplateModelType" type="text" value={formData.nameplateModelType} onChange={(e) => handleChange('nameplateModelType', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateCatalogNo" className="form-label">Catalog No.:</label><input id="nameplateCatalogNo" type="text" value={formData.nameplateCatalogNo} onChange={(e) => handleChange('nameplateCatalogNo', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateSerialNumber" className="form-label">Serial Number:</label><input id="nameplateSerialNumber" type="text" value={formData.nameplateSerialNumber} onChange={(e) => handleChange('nameplateSerialNumber', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateSystemVoltage" className="form-label">System Voltage (V):</label><input id="nameplateSystemVoltage" type="text" value={formData.nameplateSystemVoltage} onChange={(e) => handleChange('nameplateSystemVoltage', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateRatedVoltage" className="form-label">Rated Voltage (V):</label><input id="nameplateRatedVoltage" type="text" value={formData.nameplateRatedVoltage} onChange={(e) => handleChange('nameplateRatedVoltage', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateRatedCurrent" className="form-label">Rated Current (A):</label><input id="nameplateRatedCurrent" type="text" value={formData.nameplateRatedCurrent} onChange={(e) => handleChange('nameplateRatedCurrent', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
            <div><label htmlFor="nameplateSCCR" className="form-label">SCCR (kA):</label><input id="nameplateSCCR" type="text" value={formData.nameplateSCCR} onChange={(e) => handleChange('nameplateSCCR', e.target.value)} readOnly={!isEditing} className={`form-input ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
        </div>
              ...
              {formData.visualInspectionItems.map((item, index) => (
                <tr key={item.netaSection}>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center">
                    <select value={item.result} onChange={(e) => handleVisualInspectionChange(index, 'result', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center mb-4">
          ...
          <select 
            ...
            disabled={!isEditing} 
            className={`form-select w-32 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
          >
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                <th rowSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Test Points</th>
                <th colSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P1</th>
                <th colSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P2</th>
                <th colSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P3</th>
                <th colSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Neutral</th>
                <th rowSpan={2} className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Units</th>
              </tr>
              <tr>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">Reading</th>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">@20°C</th>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">Reading</th>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">@20°C</th>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">Reading</th>
                <th className="px-3 py-2 text-center text-xs font-medium text-gray-500 dark:text-white">@20°C</th>
      ...
      <div className="mb-6">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-dark-150">
              <tr>
                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">State</th>
                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P1</th>
                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P2</th>
                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">P3</th>
                <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Neutral</th>
            ...
            <tbody className="bg-white dark:bg-dark-150 divide-y divide-gray-200 dark:divide-gray-700">
              {(['normal', 'emergency'] as const).map(state => {
                ...
                return (
                  <tr key={state}>
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-white whitespace-nowrap">{state.charAt(0).toUpperCase() + state.slice(1)}</td>
                    {(['p1', 'p2', 'p3', 'neutral'] as const).map(pole => (
                      <td key={pole} className="px-6 py-4">
                        <input type="text" value={stateObj[pole] || ''} onChange={(e) => handleContactResistanceChange(state, pole, e.target.value)} readOnly={!isEditing} className={`form-input w-full text-center ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                      </td>
                    ))}
                    <td className="px-6 py-4">
                      <select value={stateObj.units || 'µΩ'} onChange={(e) => handleContactResistanceChange(state, 'units', e.target.value)} disabled={!isEditing} className={`form-select w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}>
