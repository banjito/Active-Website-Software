          ...
          <div className="space-y-8">
            ...
            <section className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
                ...
                <div className="md:col-span-2"><label className="form-label">Address:</label><input type="text" value={maskCustomerAddress(formData.address)} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-full" /></div>
                <div><label className="form-label">Technicians:</label><input type="text" value={formData.technicians} onChange={(e) => handleChange(null, 'technicians', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label className="form-label">Date:</label><input type="date" value={formData.date} onChange={(e) => handleChange(null, 'date', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label className="form-label">Identifier:</label><input type="text" value={formData.identifier} onChange={(e) => handleChange(null, 'identifier', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div className="flex items-center space-x-1">
                  <div>
                    <label className="form-label">Temp:</label>
                    <input type="number" value={formData.temperature.fahrenheit} onChange={(e) => handleTemperatureChange(Number(e.target.value))} readOnly={!isEditing} className={`form-input w-16 ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} />
                ...
                <div><label className="form-label">TCF:</label><input type="number" value={formData.temperature.correctionFactor} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-16" /></div>
                <div>
                ...
                <div><label className="form-label">Substation:</label><input type="text" value={formData.substation} onChange={(e) => handleChange(null, 'substation', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div><label className="form-label">Eqpt. Location:</label><input type="text" value={formData.eqptLocation} onChange={(e) => handleChange(null, 'eqptLocation', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
                <div className="md:col-span-2"><label className="form-label">User:</label><input type="text" value={formData.userName} onChange={(e) => handleChange(null, 'userName', e.target.value)} readOnly={!isEditing} className={`form-input w-full ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`} /></div>
              </div>
            ...
            <section className="mb-6 nameplate-section">
              ...
              <div className="grid grid-cols-4 gap-4 print:hidden nameplate-onscreen">
              ...
              <div className="grid grid-cols-4 gap-4 mt-4 print:hidden nameplate-onscreen">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.nameplateData.fluidType}
                    onChange={(e) => handleNestedChange('nameplateData', 'fluidType', e.target.value)}
                    readOnly={!isEditing}
                    className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
                  />
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.nameplateData.fluidVolume}
                    onChange={(e) => handleNestedChange('nameplateData', 'fluidVolume', e.target.value)}
                    readOnly={!isEditing}
                    className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : ''}`}
                  />
                </div>
                ...
                <div className="grid grid-cols-[100px_1fr_1fr_1fr] gap-4 items-center">
                  ...
                  <div className="flex justify-center items-center space-x-2">
                    <input
                      ...
                      readOnly={!isEditing}
                      className={`w-24 text-center rounded-md border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-dark-150 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${!isEditing ? 'bg-gray-100' : ''}`}
                    />
                    <span className="text-gray-500 dark:text-white">/</span>
                    <input
                      type="text"
                  ...
                  <tbody>
                    <tr>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        ...
                        <div className="mt-0">{formData.nameplateData.manufacturer || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Catalog Number</div>
                        <div className="mt-0">{formData.nameplateData.catalogNumber || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Serial Number</div>
                        <div className="mt-0">{formData.nameplateData.serialNumber || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">KVA</div>
                        <div className="mt-0">{formData.nameplateData.kva || ''}</div>
                      </td>
                    </tr>
                    <tr>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Temp. Rise (°C)</div>
                        <div className="mt-0">{formData.nameplateData.tempRise || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Impedance (%)</div>
                        <div className="mt-0">{formData.nameplateData.impedance || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Fluid Type</div>
                        <div className="mt-0">{formData.nameplateData.fluidType || ''}</div>
                      </td>
                      <td className="p-2 align-top border border-gray-300 print:border-black">
                        <div className="font-semibold">Fluid Volume (gal)</div>
                        <div className="mt-0">{formData.nameplateData.fluidVolume || ''}</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 print:hidden indicator-gauges-onscreen">
                  <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.oilLevel || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter oil level" />
                  </div>
                  <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.oilTemperature || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter oil temperature" />
                  </div>
                   <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.oilTempRange || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter oil temp range" />
                  </div>
                  <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.tankPressure || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter tank pressure" />
                  </div>
                  <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.windingTemperature || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter winding temperature" />
                  </div>
                  <div>
                      ...
                      <input type="text" value={formData.nameplateData?.indicatorGauges?.windingTempRange || ''} onChange={(e) => {
                        ...
                        handleNestedChange('nameplateData', 'indicatorGauges', ig);
                      }} readOnly={!isEditing} className={`mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-[#f26722] focus:ring-[#f26722] text-gray-900 dark:text-white ${!isEditing ? 'bg-gray-100 dark:bg-dark-150' : 'bg-white dark:bg-dark-150'}`} placeholder="Enter winding temp range" />
                  </div>
                </div>
