          ...
          <div className="space-y-8">
            ...
            <section className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 print:hidden job-info-onscreen">
                ...
                <div className="md:col-span-2"><label className="form-label">Address:</label><input type="text" value={formData.address} readOnly className="form-input bg-gray-100 dark:bg-dark-150 w-full" /></div>
