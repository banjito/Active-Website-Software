        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-2 print:hidden">
            ...
            <div>
              ...
              <input className={`form-input text-sm ${!isEditMode ? 'bg-gray-100 dark:bg-dark-150' : ''}`} value={formData.address} readOnly={!isEditMode} onChange={(e) => handleChange('address', e.target.value)} />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-x-2">
              ...
              <div>
                ...
                <input type="number" className={`form-input text-sm ${!isEditMode ? 'bg-gray-100 dark:bg-dark-150' : ''}`} value={formData.humidity || ''} readOnly={!isEditMode} onChange={(e) => handleChange('humidity', e.target.value === '' ? null : Number(e.target.value))} />
              </div>
            </div>
